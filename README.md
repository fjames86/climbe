...
* The CIMOM MUST understand Association classes. [ DONE ]
* The server MUST be able to return associated classes as well as instances of associated classes. [ DONE ]
