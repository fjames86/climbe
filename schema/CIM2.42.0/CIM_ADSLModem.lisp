...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ADSLModem.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ADSLMODEM (CIM_DSLMODEM)
              ((NOISEMARGIN UINT32 :CIM-NAME "NoiseMargin" :QUALIFIERS
                ((:DESCRIPTION
                  "Noise Margin of this Modem with respect to its received signal, in tenths of dB.")
                 (NIL "Tenths of Decibels") (:P-UNIT "decibel * 10^-1"))
                :INITFORM NIL)
               (LINEATTENUATION UINT32 :CIM-NAME "LineAttenuation" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Tenths of Decibels") :GAUGE (:P-UNIT "decibel * 10^-1"))
                :INITFORM NIL)
               (LINESTATE UINT32 :CIM-NAME "LineState" :QUALIFIERS
                ((:DESCRIPTION
...
32) Loss Of Signal Quality - Loss of Signal Quality is declared when the NoiseMargin falls below the minimum NoiseMargin, or the bit-error-rate exceeds 10^-7.")
                 (:VALUE-MAP ("1" "2" "4" "8" "32"))
                 (:VALUES
                  ("No Defect" "Loss Of Framing" "Loss Of Signal"
               ...
               (TOTALOUTPUTPOWER UINT32 :CIM-NAME "TotalOutputPower"
                ...
                ((:DESCRIPTION
                 ...
                 (NIL "Tenths of Decibels") :GAUGE (:P-UNIT "decibel * 10^-1"))
                :INITFORM NIL)
               (MAXDATARATE UINT32 :CIM-NAME "MaxDataRate" :QUALIFIERS
                ((:DESCRIPTION
