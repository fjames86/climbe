...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AFService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_AFSERVICE (CIM_DIFFSERVSERVICE)
              ((CLASSNUMBER UINT8 :CIM-NAME "ClassNumber" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DROPPERNUMBER UINT8 :CIM-NAME "DropperNumber" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DSCP UINT8 :CIM-NAME "DSCP" :QUALIFIERS
                ...
                :INITFORM NIL)
               (PHBID UINT16 :CIM-NAME "PHBID" :QUALIFIERS
                ((:DESCRIPTION
