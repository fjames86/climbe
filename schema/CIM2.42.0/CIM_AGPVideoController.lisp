...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AGPVideoController.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_AGPVIDEOCONTROLLER (CIM_VIDEOCONTROLLER)
              ((NONLOCALVIDEOMEMORYSIZE UINT32 :CIM-NAME
                "NonlocalVideoMemorySize" :QUALIFIERS
                ((:DESCRIPTION "Size of the non-local video memory in KB.")
                 (NIL "KiloBytes"))
                :INITFORM NIL)
               (LOCALBUSWIDTH UINT32 :CIM-NAME "LocalBusWidth" :QUALIFIERS
                ((:DESCRIPTION
                  "Width of the internal bus in the graphics Controller, in bits.")
                 (NIL "Bits"))
                :INITFORM NIL)
               (USAGEMODEL UINT16 :CIM-NAME "UsageModel" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DATATRANSFERRATE UINT16 :CIM-NAME "DataTransferRate"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ADDRESSINGMODE UINT16 :CIM-NAME "AddressingMode" :QUALIFIERS
                ((:DESCRIPTION
                  "An integer enumeration indicating the addressing mode of the graphics Controller.")
                 (:VALUE-MAP ("0" "1" "2" "3"))
                 (:VALUES ("Unknown" "Other" "Sideband" "Pipeline")))
                :INITFORM NIL)
               (MAXIMUMAGPCOMMANDQUEUEPATH UINT32 :CIM-NAME
                "MaximumAGPCommandQueuePath" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MAXNUMBEROFPIPELINEDAGPTRANSACTIONS UINT32 :CIM-NAME
                "MaxNumberOfPipelinedAGPTransactions" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (GRAPHICSAPERTURESIZE UINT32 :CIM-NAME "GraphicsApertureSize"
                :QUALIFIERS
                ((:DESCRIPTION "Size of the graphics aperture in KB.")
                 (NIL "KiloBytes"))
                :INITFORM NIL)
               (AGPSPECIFICATIONVERSIONCONFORMANCE STRING :CIM-NAME
                "AGPSpecificationVersionConformance" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ((:DEPRECATED ("No value")) (:OVERRIDE "Description")
                 (:MAPPING-STRINGS ("MIF.DMTF|Video|004.18"))
                 (:DESCRIPTION
                  "The Description property provides a textual description of the object."))
                :INITFORM NIL)
               (VIDEOPROCESSOR STRING :CIM-NAME "VideoProcessor" :QUALIFIERS
                ((:DEPRECATED ("CIM_DisplayController.VideoProcessor"))
                 (:DESCRIPTION
                  "A free-form string that describes the video processor or Controller."))
                :INITFORM NIL)
               (VIDEOMEMORYTYPE UINT16 :CIM-NAME "VideoMemoryType" :QUALIFIERS
                ((:DEPRECATED ("CIM_DisplayController.VideoMemoryType"))
                 ...
                 (:VALUES
                  ("Other" "Unknown" "VRAM" "DRAM" "SRAM" "WRAM" "EDO RAM"
                   "Burst Synchronous DRAM" "Pipelined Burst SRAM" "CDRAM"
                   "3DRAM" "SDRAM" "SGRAM"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Video|004.6")))
                :INITFORM NIL)
               (NUMBEROFVIDEOPAGES UINT32 :CIM-NAME "NumberOfVideoPages"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_DisplayController.NumberOfVideoPages"))
                 (:DESCRIPTION
                  "Number of video pages that are supported given the current resolutions and available memory."))
                :INITFORM NIL)
               (MAXMEMORYSUPPORTED UINT32 :CIM-NAME "MaxMemorySupported"
                :QUALIFIERS
                ...
                :INITFORM NIL)
               (CURRENTBITSPERPIXEL UINT32 :CIM-NAME "CurrentBitsPerPixel"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentBitsPerPixel"))
                 (:DESCRIPTION
                  "The number of bits used to display each pixel.")
                 (NIL "Bits") (:MAPPING-STRINGS ("MIF.DMTF|Video|004.12"))
                 (:P-UNIT "bit"))
                :INITFORM NIL)
               (CURRENTHORIZONTALRESOLUTION UINT32 :CIM-NAME
                "CurrentHorizontalResolution" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentHorizontalResolution"))
                 (:DESCRIPTION "Current number of horizontal pixels.")
                 (NIL "Pixels") (:MAPPING-STRINGS ("MIF.DMTF|Video|004.11"))
                 (:P-UNIT "pixel"))
                :INITFORM NIL)
               (CURRENTVERTICALRESOLUTION UINT32 :CIM-NAME
                "CurrentVerticalResolution" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentVerticalResolution"))
                 (:DESCRIPTION "Current number of vertical pixels.")
                 (NIL "Pixels") (:MAPPING-STRINGS ("MIF.DMTF|Video|004.10"))
                 (:P-UNIT "pixel"))
                :INITFORM NIL)
               (MAXREFRESHRATE UINT32 :CIM-NAME "MaxRefreshRate" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.MaxRefreshRate"))
                 ...
                 (NIL "Hertz") (:MAPPING-STRINGS ("MIF.DMTF|Video|004.5"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (MINREFRESHRATE UINT32 :CIM-NAME "MinRefreshRate" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.MinRefreshRate"))
                 ...
                 (NIL "Hertz") (:MAPPING-STRINGS ("MIF.DMTF|Video|004.4"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (CURRENTREFRESHRATE UINT32 :CIM-NAME "CurrentRefreshRate"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentRefreshRate"))
                 (:DESCRIPTION "Current refresh rate in hertz.") (NIL "Hertz")
                 (:MAPPING-STRINGS ("MIF.DMTF|Video|004.15"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (CURRENTSCANMODE UINT16 :CIM-NAME "CurrentScanMode" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentScanMode"))
                 (:DESCRIPTION
                  "Current scan mode. \"Interlaced\" (value=3) or \"Non Interlaced\" (value=4) can be defined using this property.")
                 (:VALUE-MAP ("1" "2" "3" "4"))
                 (:VALUES ("Other" "Unknown" "Interlaced" "Non Interlaced"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Video|004.8")))
                :INITFORM NIL)
               (CURRENTNUMBEROFROWS UINT32 :CIM-NAME "CurrentNumberOfRows"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentNumberOfRows"))
                 (:DESCRIPTION
                  "If in character mode, the number of rows for this Video Controller. Otherwise, enter 0.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Video|004.13")))
                :INITFORM NIL)
               (CURRENTNUMBEROFCOLUMNS UINT32 :CIM-NAME
                "CurrentNumberOfColumns" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentNumberOfColumns"))
                 (:DESCRIPTION
                  "If in character mode, the number of columns for this VideoController. Otherwise, enter 0.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Video|004.14")))
                :INITFORM NIL)
               (CURRENTNUMBEROFCOLORS UINT64 :CIM-NAME "CurrentNumberOfColors"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHead.CurrentNumberOfColors"))
                 (:DESCRIPTION
                  "The number of colors that are supported at the current resolutions."))
                :INITFORM NIL)
               (TIMEOFLASTRESET DATETIME :CIM-NAME "TimeOfLastReset"
                :QUALIFIERS
                ((:DESCRIPTION "Time of last reset of the Controller."))
                :INITFORM NIL)
               (PROTOCOLSUPPORTED UINT16 :CIM-NAME "ProtocolSupported"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Other" "Unknown" "EISA" "ISA" "PCI" "ATA/ATAPI"
                   ...
                   "Diagnostic" "I2C" "Power" "HIPPI" "MultiBus" "VME" "IPI"
                   "IEEE-488" "RS232" "IEEE 802.3 10BASE5" "IEEE 802.3 10BASE2"
                   "IEEE 802.3 1BASE5" "IEEE 802.3 10BROAD36"
                   "IEEE 802.3 100BASEVG" "IEEE 802.5 Token-Ring"
                   "ANSI X3T9.5 FDDI" "MCA" "ESDI" "IDE" "CMD" "ST506" "DSSI"
                   "QIC2" "Enhanced ATA/IDE" "AGP" "TWIRP (two-way infrared)"
                   "FIR (fast infrared)" "SIR (serial infrared)" "IrBus"
                   "Serial ATA"))
                 (:MAPPING-STRINGS
                  ("MIF.DMTF|Bus Port|004.2" "MIF.DMTF|Disks|003.3"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_Controller.ProtocolDescription")))
                :INITFORM NIL)
               (MAXNUMBERCONTROLLED UINT32 :CIM-NAME "MaxNumberControlled"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Bus Port|004.9")))
                :INITFORM NIL)
               (PROTOCOLDESCRIPTION STRING :CIM-NAME "ProtocolDescription"
                :QUALIFIERS
                ((:DESCRIPTION
                  "A free-form string that provides more information that is related to the ProtocolSupported by the Controller.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Bus Port|004.3"))
                 (:MODEL-CORRESPONDENCE ("CIM_Controller.ProtocolSupported")))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (CAPABILITIES (ARRAY UINT16) :CIM-NAME "Capabilities"
                ...
                ((:DEPRECATED ("CIM_VideoController.AcceleratorCapabilities"))
                 ...
                 (:VALUES
                  ("Unknown" "Other" "PCI Fast Write" "MultiMonitor Support"
                ...
                :INITFORM NIL)
               (ACCELERATORCAPABILITIES (ARRAY UINT16) :CIM-NAME
                "AcceleratorCapabilities" :QUALIFIERS
                ((:DEPRECATED
                  ("CIM_DisplayController.AcceleratorCapabilities"))
                 (:DESCRIPTION
                  "An array of integers that indicates the graphics and 3D capabilities of the VideoController.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6" "7" "8"))
                 (:VALUES
                  ("Unknown" "Other" "Graphics Accelerator" "3D Accelerator"
                   "PCI Fast Write" "MultiMonitor Support" "PCI Mastering"
               ...
               (CAPABILITYDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                ((:DEPRECATED ("CIM_DisplayController.CapabilityDescriptions"))
                 (:DESCRIPTION
                  "An array of free-form strings that provides more detailed explanations for any of the video Accelerator features that are indicated in the Capabilities array. Note, each entry of this array is related to the entry in the Capabilities array that is located at the same index.")
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_AGPVideoController")
...
(DEFCIM-METHOD SETPOWERSTATE
    ((INSTANCE CIM_AGPVIDEOCONTROLLER)
