...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AHTransform.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_AHTRANSFORM (CIM_SATRANSFORM)
              ((AHTRANSFORMID UINT16 :CIM-NAME "AHTransformId" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("IPSP Model.IETF|AHTransform.AHTransformID"
                   "RFC2407.IETF|Section 4.4.3"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_AHTransform.OtherAHTransformId")))
                :INITFORM NIL)
               (OTHERAHTRANSFORMID STRING :CIM-NAME "OtherAHTransformId"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Description of the hash algorithm when the value 1 (\"Other\") is specified for the property, AHTransformId.")
                 (:MODEL-CORRESPONDENCE ("CIM_AHTransform.AHTransformId")))
                :INITFORM NIL)
...
For DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
              ...
              (:QUALIFIERS (:VERSION "2.8.0")
               ...
               (:MAPPING-STRINGS ("IPSP Model.IETF|AHTransform"))))