...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Account.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ACCOUNT (CIM_ENABLEDLOGICALELEMENT)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
               ...
               (USERID STRING :CIM-NAME "UserID" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (USERPASSWORDENCRYPTIONALGORITHM UINT16 :CIM-NAME
                "UserPasswordEncryptionAlgorithm" :QUALIFIERS
                ((:DESCRIPTION
...
- 2 (\"HTTP Digest MD5(A1)\"): The MD5 hash algorithm, applied to the string A1 defined in RFC2617 as the concatenation username-value \":\" realm-value \":\" passwd, where username-value is provided by the client as the value of the UserID property. passwd is the underlying user password. realm-value is the HTTP digest realm value, and is provided by the server. The semantics of the HTTP digest realm are specified in RFC 2617. The server may surface the realm-value in the UserPasswordEncryptionSalt property of CIM_AccountManagementCapabilities.")
                ...
                :INITFORM NIL)
               (OTHERUSERPASSWORDENCRYPTIONALGORITHM STRING :CIM-NAME
                "OtherUserPasswordEncryptionAlgorithm" :QUALIFIERS
                ((:DESCRIPTION
...
A value of NULL shall indicate that the Account will not be disabled due to inactivity."))
                :INITFORM NIL)
               (LASTLOGIN DATETIME :CIM-NAME "LastLogin" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (MAXIMUMSUCCESSIVELOGINFAILURES UINT16 :CIM-NAME
                ...
                :INITFORM NIL)
               (PASSWORDEXPIRATION DATETIME :CIM-NAME "PasswordExpiration"
                :QUALIFIERS
                ((:DESCRIPTION
...
A value of NULL shall indicate the password never expires."))
               ...
               (PASSWORDHISTORYDEPTH UINT16 :CIM-NAME "PasswordHistoryDepth"
                ...
                :INITFORM NIL)
               (USERPASSWORDENCODING UINT32 :CIM-NAME "UserPasswordEncoding"
                :QUALIFIERS
                ((:DESCRIPTION
...
\"UCS-2BE\" denotes that the UserPassword is a Unicode string that is encoded using UCS-2 character set in big endian byte order.")
                 ...
                 (:VALUES
                  ("ascii" "kbd" "pin" "UTF-8" "UTF-16" "UTF-16LE" "UTF-16BE"
                   "UCS-2" "USC-2LE" "UCS-2BE" "DMTF Reserved"
                   "Vendor Reserved")))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (DESCRIPTIONS (ARRAY STRING) :CIM-NAME "Descriptions"
                ...
                ((:DESCRIPTION
                 ...
                 (:MAX-LEN "1024"))
                :INITFORM NIL)
               (HOST (ARRAY STRING) :CIM-NAME "Host" :QUALIFIERS
                ((:DESCRIPTION
