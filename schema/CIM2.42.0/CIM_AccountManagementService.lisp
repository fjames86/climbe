...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AccountManagementService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ACCOUNTMANAGEMENTSERVICE (CIM_SECURITYSERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_AccountManagementService")
...
(DEFCIM-METHOD CREATEACCOUNT
    ((INSTANCE CIM_ACCOUNTMANAGEMENTSERVICE)
     (ACCOUNTTEMPLATE STRING "AccountTemplate" :REQUIRED
      (:DESCRIPTION
       "AccountTemplate is a template for the desired Account to be created.")
      (:EMBEDDED-INSTANCE "CIM_Account"))
     (SYSTEM "CIM_ComputerSystem" "System" :REQUIRED
      (:DESCRIPTION
       "The scoping ComputerSystem in which to create the Account."))
     (ACCOUNT "CIM_Account" "Account" :IN :OUT
      (:DESCRIPTION
       "Reference to the instance of CIM_Account created when the method returns a value of 0."))
     (IDENTITIES "CIM_Identity" "Identities" :IN :OUT
      (:DESCRIPTION
...
Instances of CIM_Identity may be created by the method and associated with the instance of CIM_Account through CIM_AssignedIdentity. If one or more instances of CIM_Identity are created, a reference to each shall be returned in the Identities parameter, otherwise the Identities parameter shall be NULL upon method completion.")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Method Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD CREATEUSERCONTACT
    ((INSTANCE CIM_ACCOUNTMANAGEMENTSERVICE)
     (USERCONTACTTEMPLATE STRING "UserContactTemplate" :REQUIRED
      (:DESCRIPTION
       "UserContactTemplate is a template for the desired UserContact to be created")
      (:EMBEDDED-INSTANCE "CIM_UserContact"))
     (SYSTEM "CIM_ComputerSystem" "System" :REQUIRED
      (:DESCRIPTION
       "The scoping ComputerSystem in which to create the Account."))
     (USERCONTACT "CIM_UserContact" "UserContact" :IN :OUT
      (:DESCRIPTION
       "Reference to the instance of CIM_UserContact created when the method returns a value of 0"))
     (IDENTITIES "CIM_Identity" "Identities" :IN :OUT
      (:DESCRIPTION
       "Reference to the instances of CIM_Identity when the method returns a value of 0. These instances may not be created as a part of the execution of this method. These instances may already exist prior to the invocation of this method.")))
    ((:CIM-NAME "CreateUserContact")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP ("0" "1" "2" ".."))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed"
        "Method Reserved")))))
(DEFCIM-METHOD CREATEUSERCONTACTBYIDENTITY
    ((INSTANCE CIM_ACCOUNTMANAGEMENTSERVICE)
     (USERCONTACTTEMPLATE STRING "UserContactTemplate" :REQUIRED
      (:DESCRIPTION
       "UserContactTemplate is a template for the desired UserContact to be created.")
     ...
     (SYSTEM "CIM_ComputerSystem" "System" :REQUIRED
      (:DESCRIPTION
       "The scoping ComputerSystem in which to create the Account."))
     (IDENTITY "CIM_Identity" "Identity" :REQUIRED
               (:DESCRIPTION
                "A Reference to a existing CIM_Identity instance to be associated to the newly created CIM_UserContact instance."))
     (USERCONTACT "CIM_UserContact" "UserContact" :IN :OUT
      (:DESCRIPTION
       "Reference to the instance of CIM_UserContact created when the method returns a value of 0. This value shall be NULL if the method returns a value other than 0.")))
    ((:CIM-NAME "CreateUserContactByIdentity")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed"
        "Method Reserved")))))
(DEFCIM-METHOD GETACCOUNTS
    ((INSTANCE CIM_ACCOUNTMANAGEMENTSERVICE)
     (USERID STRING "UserID"
      (:DESCRIPTION
       "The UserID for the CIM_Account instances to be retrieved."))
     (ACCOUNTS "CIM_Account" "Accounts" :IN :OUT
      (:DESCRIPTION
       "An array of references to the instances of CIM_Account that have the supplied UserID.")))
    ((:CIM-NAME "GetAccounts")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed"
        "Method Reserved")))))
(DEFCIM-METHOD GETUSERCONTACTS
    ((INSTANCE CIM_ACCOUNTMANAGEMENTSERVICE)
     (USERID STRING "UserID"
      (:DESCRIPTION
       "The UserID for the CIM_UserContact instances to be retrieved."))
     (USERCONTACTS "CIM_UserContact" "UserContacts" :IN :OUT
      (:DESCRIPTION
       "An array of references to the UserContact instances that have the supplied UserID.")))
    ((:CIM-NAME "GetUserContacts")
     (:QUALIFIERS
      (:DESCRIPTION
