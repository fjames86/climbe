...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AggregatePExtent.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_AGGREGATEPEXTENT (CIM_STORAGEEXTENT)
              ((NUMBEROFBLOCKS UINT64 :CIM-NAME "NumberOfBlocks" :QUALIFIERS
                ...
                :INITFORM NIL)
               (BLOCKSOFCHECKDATA UINT64 :CIM-NAME "BlocksOfCheckData"
                :QUALIFIERS
