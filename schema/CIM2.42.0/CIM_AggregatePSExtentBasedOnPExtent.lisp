...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AggregatePSExtentBasedOnPExtent.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_AGGREGATEPSEXTENTBASEDONPEXTENT (CIM_BASEDON)
              ((STARTINGADDRESS UINT64 :CIM-NAME "StartingAddress" :QUALIFIERS
               ...
               (ANTECEDENT NIL :CIM-NAME "Antecedent" :QUALIFIERS
                ((:DEPRECATED ("CIM_ProtectedExtentBasedOn.Antecedent"))
                 ...
                 (:DESCRIPTION "The PhysicalExtent.") :KEY)
              ...
              (:CIM-NAME "CIM_AggregatePSExtentBasedOnPExtent")
