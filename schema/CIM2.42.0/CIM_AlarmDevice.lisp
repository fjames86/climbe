...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AlarmDevice.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ALARMDEVICE (CIM_LOGICALDEVICE)
              ((AUDIBLEALARM BOOLEAN :CIM-NAME "AudibleAlarm" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating that the Alarm is audible."))
                :INITFORM NIL)
               (VISIBLEALARM BOOLEAN :CIM-NAME "VisibleAlarm" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating that the Alarm is visible."))
                :INITFORM NIL)
               (MOTIONALARM BOOLEAN :CIM-NAME "MotionAlarm" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating that the Alarm causes motion of the Device."))
                :INITFORM NIL)
               (URGENCY UINT16 :CIM-NAME "Urgency" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Not Supported" "Informational"
                   "Non-Critical" "Critical" "Unrecoverable")))
                :INITFORM NIL)
               (ALARMSTATE UINT16 :CIM-NAME "AlarmState" :QUALIFIERS
                ((:DESCRIPTION "The current state of the alarm.")
                 (:VALUE-MAP ("0" "1" "2" "3"))
                 (:VALUES ("Unknown" "Off" "Steady" "Alternating")))
                :INITFORM NIL)
               (AUDIOINDICATORISDISABLED BOOLEAN :CIM-NAME
                "AudioIndicatorIsDisabled" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (VISUALINDICATORISDISABLED BOOLEAN :CIM-NAME
                "VisualIndicatorIsDisabled" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MOTIONINDICATORISDISABLED BOOLEAN :CIM-NAME
                "MotionIndicatorIsDisabled" :QUALIFIERS
                ((:DESCRIPTION
...
(DEFCIM-METHOD SETALARMSTATE
    ((INSTANCE CIM_ALARMDEVICE)
     (REQUESTEDALARMSTATE UINT16 "RequestedAlarmState" :IN
      (:DESCRIPTION "The desired state for the alarm.")
      (:VALUE-MAP ("0" "1" "2" "3"))
      (:VALUES ("Unknown" "Off" "Steady" "Alternating"))))
    ((:CIM-NAME "SetAlarmState")
     (:QUALIFIERS
      (:DESCRIPTION
...
(DEFCIM-METHOD SETALARMINDICATOR
    ((INSTANCE CIM_ALARMDEVICE)
     (AUDIOINDICATOR UINT16 "AudioIndicator" :IN
      (:DESCRIPTION "The state for the audio indicator.")
      (:VALUE-MAP ("0" "1" "2")) (:VALUES ("No Change" "Disable" "Enable")))
     (VISUALINDICATOR UINT16 "VisualIndicator" :IN
      (:DESCRIPTION "The state for the visual indicator.")
      (:VALUE-MAP ("0" "1" "2")) (:VALUES ("No Change" "Disable" "Enable")))
     (MOTIONINDICATOR UINT16 "MotionIndicator" :IN
      (:DESCRIPTION "The state for the motion indicator.")
      (:VALUE-MAP ("0" "1" "2")) (:VALUES ("No Change" "Disable" "Enable"))))
    ((:CIM-NAME "SetAlarmIndicator")
     (:QUALIFIERS
      (:DESCRIPTION
...
(DEFCIM-METHOD SETURGENCY
    ((INSTANCE CIM_ALARMDEVICE)
     (REQUESTEDURGENCY UINT16 "RequestedUrgency" :IN
      (:DESCRIPTION "Desired urgency for the alarm.")
      (:VALUE-MAP ("1" "3" "4" "5" "6"))
      (:VALUES
       ("Other" "Informational" "Non-Critical" "Critical" "Unrecoverable"))))
    ((:CIM-NAME "SetUrgency")
     (:QUALIFIERS
      (:DESCRIPTION
