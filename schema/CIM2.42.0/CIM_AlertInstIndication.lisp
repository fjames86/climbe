...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AlertInstIndication.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ALERTINSTINDICATION (CIM_ALERTINDICATION)
              ((ALERTTYPE UINT16 :CIM-NAME "AlertType" :QUALIFIERS
                ((:OVERRIDE "AlertType")
                 ...
                 :REQUIRED (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7" "8"))
                 (:VALUES
                ...
                :INITFORM "7")
               (INDOBJECT STRING :CIM-NAME "IndObject" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
...
When retrying the delivery of an indication, this property shall have the same value as in the original delivery.")
               ...
               (CORRELATEDINDICATIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_AlertInstIndication")
