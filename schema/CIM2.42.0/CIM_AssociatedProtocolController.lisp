...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AssociatedProtocolController.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ASSOCIATEDPROTOCOLCONTROLLER
...
Mapping Inconsistency (5) indicates the instrumentation has detected that this path is inactive due to an inconsistency in the DeviceNumber/DeviceAccess configuration.")
               ...
               (DEPENDENT NIL :CIM-NAME "Dependent" :QUALIFIERS
                ((:OVERRIDE "Dependent")
                 ...
                 :KEY)
                :INITFORM "CIM_ProtocolController"))
              (:CIM-NAME "CIM_AssociatedProtocolController")
