...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_AutonomousSystem.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_AUTONOMOUSSYSTEM (CIM_ADMINDOMAIN)
              ((ASNUMBER UINT16 :CIM-NAME "ASNumber" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ISSINGLEHOMED BOOLEAN :CIM-NAME "IsSingleHomed" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ISTRANSIT BOOLEAN :CIM-NAME "IsTransit" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (REQUIREIGPSYNC BOOLEAN :CIM-NAME "RequireIGPSync" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ROUTINGUPDATESOURCE UINT16 :CIM-NAME "RoutingUpdateSource"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (AGGREGATIONTYPE UINT16 :CIM-NAME "AggregationType" :QUALIFIERS
                ((:DESCRIPTION
...
\"FC\" has been deprecated and replaced by \"WWN\" to be consistent with the other ValueMaps.")
                 (:VALUE-MAP
                  ("Other" "AS" "NAP" "NOC" "POP" "RNP" "IP" "IPX" "SNA" "Dial"
                   "WAN" "LAN" "ISDN" "Frame Relay" "ATM" "E.164" "IB" "FC"
                   "Policy Repository" "WWN"))
                 (:VALUES
                  ("Other" "Autonomous System" "Network Access Provider"
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_AdminDomain.Name"))
                 (:MAX-LEN "64"))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_AutonomousSystem")
              (:QUALIFIERS (:VERSION "2.6.0")
               (:UML-PACKAGE-PATH "CIM::Network::Systems")
               (:DESCRIPTION
