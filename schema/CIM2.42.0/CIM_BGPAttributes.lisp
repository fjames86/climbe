...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPAttributes.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPATTRIBUTES (CIM_LOGICALELEMENT)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
               ...
               (VERSION STRING :CIM-NAME "Version" :QUALIFIERS
                ...
                :INITFORM NIL)
               (LOCALPREFERENCE UINT16 :CIM-NAME "LocalPreference" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ASPATH STRING :CIM-NAME "ASPath" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgp4PathAttrASPath")))
                :INITFORM NIL)
               (ASSET STRING :CIM-NAME "AsSet" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (NEXTHOP STRING :CIM-NAME "NextHop" :QUALIFIERS
                ...
                :INITFORM NIL)
               (NEXTHOPSELF STRING :CIM-NAME "NextHopSelf" :QUALIFIERS
                ((:DESCRIPTION
                  "This defines the next hop to be the IP address of the border IBGP neighbor."))
                :INITFORM NIL)
               (MED UINT32 :CIM-NAME "MED" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (BGPCOMMUNITYVALUE UINT32 :CIM-NAME "BGPCommunityValue"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ATOMICAGGREGATE BOOLEAN :CIM-NAME "AtomicAggregate" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (AGGREGATOR STRING :CIM-NAME "Aggregator" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ORIGIN UINT16 :CIM-NAME "Origin" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ORIGINATORID STRING :CIM-NAME "OriginatorID" :QUALIFIERS
                ((:DESCRIPTION
