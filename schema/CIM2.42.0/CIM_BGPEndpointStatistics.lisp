...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPEndpointStatistics.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPENDPOINTSTATISTICS (CIM_STATISTICALDATA)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (LASTERROR (ARRAY UINT8) :CIM-NAME "LastError" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_BGPEndpointStatistics")
...
(DEFCIM-METHOD RESETSELECTEDSTATS
    ((INSTANCE CIM_BGPENDPOINTSTATISTICS)
