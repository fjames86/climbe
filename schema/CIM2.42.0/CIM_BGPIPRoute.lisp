...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPIPRoute.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPIPROUTE (CIM_IPROUTE)
              ((ISBACKDOORROUTE BOOLEAN :CIM-NAME "IsBackDoorRoute" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (USESLOOPBACKPEERING BOOLEAN :CIM-NAME "UsesLoopbackPeering"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
                ...
                ((:DEPRECATED ("No value")) :KEY
                 ...
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_ForwardingService.SystemCreationClassName"))
                :INITFORM NIL)
               (SYSTEMNAME STRING :CIM-NAME "SystemName" :QUALIFIERS
                ((:DEPRECATED ("No value")) :KEY
                 (:DESCRIPTION "The scoping ForwardingService's SystemName.")
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_ForwardingService.SystemName"))
                :INITFORM NIL)
               (SERVICECREATIONCLASSNAME STRING :CIM-NAME
                ...
                ((:DEPRECATED ("No value")) :KEY
                 ...
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_ForwardingService.CreationClassName"))
                :INITFORM NIL)
               (SERVICENAME STRING :CIM-NAME "ServiceName" :QUALIFIERS
                ((:DEPRECATED ("No value")) :KEY
                 (:DESCRIPTION "The scoping ForwardingService's Name.")
                 (:MAX-LEN "256") (:PROPOGATED "CIM_ForwardingService.Name"))
                :INITFORM NIL)
               (CREATIONCLASSNAME STRING :CIM-NAME "CreationClassName"
                ...
                ((:DEPRECATED ("No value")) :KEY
                 ...
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (IPDESTINATIONADDRESS STRING :CIM-NAME "IPDestinationAddress"
                :QUALIFIERS
...
This property has the same semantics as DestinationAddress inherited from the NextHopRouting superclass, but a different property name. This is because this property and class were defined before NextHopRouting and are Key properties. They cannot be removed. ModelCorrespondence indicates that they should be set to equivalent values for consistency and ease of query.")
                 (:MODEL-CORRESPONDENCE ("CIM_IPRoute.DestinationAddress")))
                :INITFORM NIL)
               (IPDESTINATIONMASK STRING :CIM-NAME "IPDestinationMask"
                :QUALIFIERS
...
This property has the same semantics as DestinationMask inherited from the NextHopRouting superclass, but a different property name. This is because this property and class were defined before NextHopRouting and are Key properties. They cannot be removed. ModelCorrespondence indicates that they should be set to equivalent values for consistency and ease of query.")
                 (:MODEL-CORRESPONDENCE ("CIM_IPRoute.DestinationMask")))
                :INITFORM NIL)
...
AddressType is part of the key so that an IPv4 and an IPv6 route to IP subnets with the same network number but different IP versions (v4/v6) can coexist.")
               ...
               (DESTINATIONADDRESS STRING :CIM-NAME "DestinationAddress"
                ...
                ((:DEPRECATED ("No value")) (:OVERRIDE "DestinationAddress")
                 (:MODEL-CORRESPONDENCE ("CIM_IPRoute.IPDestinationAddress"))
                 (:DESCRIPTION
               ...
               (DESTINATIONMASK STRING :CIM-NAME "DestinationMask" :QUALIFIERS
                ((:DEPRECATED ("No value")) (:OVERRIDE "DestinationMask")
                 (:MODEL-CORRESPONDENCE ("CIM_IPRoute.IPDestinationMask"))
                 (:DESCRIPTION "The mask for the DestinationAddress."))
                :INITFORM NIL)
               (NEXTHOP STRING :CIM-NAME "NextHop" :QUALIFIERS
                ((:DEPRECATED
                  ("CIM_AssociatedNextHop.Antecedent"
