...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPPathAttributes.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPPATHATTRIBUTES (CIM_LOGICALELEMENT)
              ((ASNUMBERS STRING :CIM-NAME "ASNumbers" :QUALIFIERS
                (:KEY
                 (:DESCRIPTION
                 ...
                 (:MAX-LEN "512"))
                :INITFORM NIL)
               (PATHATTRNEXTHOP STRING :CIM-NAME "PathAttrNextHop" :QUALIFIERS
                (:KEY
                 (:DESCRIPTION
                  "This is the address of the border router that should be used for the destination network.")
                 (:MAX-LEN "32")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgp4PathAttrNextHop")))
                :INITFORM NIL)
               (PATHATTRORIGIN UINT16 :CIM-NAME "PathAttrOrigin" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgp4PathAttrOrigin")))
                :INITFORM NIL)
               (PATHATTRMULTIEXITDISC SINT32 :CIM-NAME "PathAttrMultiExitDisc"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|BGP4-MIB.bgp4PathAttrMultiExitDisc")))
                :INITFORM NIL)
               (PATHATTRLOCALPREF SINT32 :CIM-NAME "PathAttrLocalPref"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|BGP4-MIB.bgp4PathAttrLocalPref")))
                :INITFORM NIL)
               (PATHATTRATOMICAGGREGATE UINT32 :CIM-NAME
                "PathAttrAtomicAggregate" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2"))
                 (:VALUES
                  ("Unknown" "Less Specific Not Selected"
                   "Less Specific Selected"))
                 (:MAPPING-STRINGS
                  ("MIB.IETF|BGP4-MIB.bgp4PathAttrAtomicAggregate")))
                :INITFORM NIL)
               (PATHATTRAGGREGATORAS UINT16 :CIM-NAME "PathAttrAggregatorAS"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|BGP4-MIB.bgp4PathAttrAggregatorAS")))
                :INITFORM NIL)
               (PATHATTRAGGREGATORADDR STRING :CIM-NAME
                "PathAttrAggregatorAddr" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PATHATTRCALCLOCALPREF SINT16 :CIM-NAME "PathAttrCalcLocalPref"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|BGP4-MIB.bgp4PathAttrCalcLocalPref")))
                :INITFORM NIL)
               (PATHATTRBEST UINT16 :CIM-NAME "PathAttrBest" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgp4PathAttrBest")))
                :INITFORM NIL)
               (PATHATTRUNKNOWNNUMBER UINT16 :CIM-NAME "PathAttrUnknownNumber"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The number of unknown attributes in the array, PathAttrUnknown.")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgp4PathAttrUnknown"))
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (PATHATTRASPATHSEGMENT (ARRAY UINT8) :CIM-NAME
                "PathAttrASPathSegment" :QUALIFIERS
                ((:DESCRIPTION
...
This property is mapped from the bgp4PathAttrASPathSegment MIB variable, which is an OctetString. Its length is defined as a minimum of 2 and a maximum of 255 octets.")
                ...
                :INITFORM NIL)
               (PATHATTRUNKNOWN (ARRAY STRING) :CIM-NAME "PathAttrUnknown"
                :QUALIFIERS
                ((:DESCRIPTION
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_BGPPathAttributes")
