...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPProtocolEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPPROTOCOLENDPOINT (CIM_PROTOCOLENDPOINT)
              ((ISEBGP BOOLEAN :CIM-NAME "IsEBGP" :QUALIFIERS
                ((:DESCRIPTION
                  "A boolean that, when TRUE, signifies that this is an instance of the external version of BGP (FALSE is the internal version)."))
                :INITFORM NIL)
               (ISEBGPMULTIHOP BOOLEAN :CIM-NAME "IsEBGPMultihop" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (LOCALIDENTIFIER STRING :CIM-NAME "LocalIdentifier" :QUALIFIERS
                ((:DESCRIPTION
                  "This is the unique identifier of the local BGP router. This is often the router ID (e.g., an IP address).")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpIdentifier")))
                :INITFORM NIL)
               (PEERIDENTIFIER STRING :CIM-NAME "PeerIdentifier" :QUALIFIERS
                ((:DESCRIPTION
                  "This is the unique identifier of the peer BGP router. This is often the router ID (e.g., an IP address).")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerIdentifier")))
                :INITFORM NIL)
               (STATE UINT16 :CIM-NAME "State" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Idle" "Connect" "Active" "OpenSet" "OpenConfirm"
                   "Established"))
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerState")))
                :INITFORM NIL)
               (ADMINSTATUS UINT16 :CIM-NAME "AdminStatus" :QUALIFIERS
                ((:DEPRECATED ("CIM_EnabledLogicalElement.RequestedState"))
                 ...
                 (:VALUE-MAP ("1" "2")) (:VALUES ("Stop" "Start"))
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerAdminStatus")))
                :INITFORM NIL)
               (NEGOTIATEDVERSION STRING :CIM-NAME "NegotiatedVersion"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (LOCALADDRESS STRING :CIM-NAME "LocalAddress" :QUALIFIERS
                ((:DEPRECATED ("CIM_BindsTo" "CIM_IPProtocolEndpoint"))
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerLocalAddr")))
                :INITFORM NIL)
               (LOCALPORT UINT16 :CIM-NAME "LocalPort" :QUALIFIERS
                ((:DEPRECATED ("CIM_BindsTo" "CIM_TCPProtocolEndpoint"))
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerLocalPort")))
                :INITFORM NIL)
               (REMOTEADDRESS STRING :CIM-NAME "RemoteAddress" :QUALIFIERS
                ((:DEPRECATED ("CIM_BindsTo" "CIM_RemoteServiceAccessPoint"))
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerRemoteAddr")))
                :INITFORM NIL)
               (REMOTEPORT UINT16 :CIM-NAME "RemotePort" :QUALIFIERS
                ((:DEPRECATED ("CIM_BindsTo" "CIM_RemotePort"))
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerRemotePort")))
                :INITFORM NIL)
               (REMOTEAS UINT16 :CIM-NAME "RemoteAS" :QUALIFIERS
                ((:DESCRIPTION
                  "This is the remote AS number for this router's BGP connection.")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerRemoteAs")))
                :INITFORM NIL)
               ...
               (MINROUTEADVERTISEMENTINTERVAL UINT16 :CIM-NAME
                ...
                :INITFORM "30")
               (HOLDTIME UINT16 :CIM-NAME "HoldTime" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Seconds")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerHoldTime")))
                :INITFORM NIL)
               (KEEPALIVE UINT16 :CIM-NAME "KeepAlive" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Seconds")
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpPeerKeepAlive")))
                :INITFORM NIL)
               (PROTOCOLIFTYPE UINT16 :CIM-NAME "ProtocolIFType" :QUALIFIERS
                ((:OVERRIDE "ProtocolIFType")
                 ...
                 (:VALUE-MAP ("1" "225..4095" "4108" "4301..32767" "32768.."))
                 (:VALUES
                  ("Other" "IANA Reserved" "BGP" "DMTF Reserved"
                   "Vendor Reserved"))
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_BGPProtocolEndpoint")
...
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_BGPPROTOCOLENDPOINT)
