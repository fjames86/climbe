...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPRouteMap.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPROUTEMAP (CIM_LOGICALELEMENT)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
               ...
               (OTHERMATCHCONDITIONTYPE STRING :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_BGPRouteMap.MatchConditionType")))
                :INITFORM NIL)
               (SETMETRICTYPE UINT16 :CIM-NAME "SetMetricType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Origin" "AS_Path" "NEXT_HOP" "Multi_Exit_Disc" "Local_Pref"
                   ...
                   "Originator_ID"))
                 (:MODEL-CORRESPONDENCE ("CIM_BGPRouteMap.SetMetricValue")))
                :INITFORM NIL)
               (SETMETRICVALUE STRING :CIM-NAME "SetMetricValue" :QUALIFIERS
                ((:DESCRIPTION
