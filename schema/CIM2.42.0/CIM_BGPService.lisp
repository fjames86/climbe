...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BGPService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BGPSERVICE (CIM_ROUTECALCULATIONSERVICE)
              ((BGPVERSION UINT8 :CIM-NAME "BGPVersion" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|BGP4-MIB.bgpVersion")))
                :INITFORM NIL)
               (LASTERRORCODE UINT16 :CIM-NAME "LastErrorCode" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("None" "Message Header Error" "OPEN Message Error"
                   "UPDATE Message Error" "Hold Timer Expired"
                   "Finite State Machine Error" "Cease")))
                :INITFORM NIL)
               (LASTMESSAGEERRORSUBCODE UINT16 :CIM-NAME
                "LastMessageErrorSubCode" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3"))
                 (:VALUES
                  ("None" "Connection Not Synchronized" "Bad Message Length"
                   "Bad Message Type")))
                :INITFORM NIL)
               (LASTOPENERRORSUBCODE UINT16 :CIM-NAME "LastOpenErrorSubCode"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6"))
                 (:VALUES
                  ("None" "Unsupported Version Number" "Bad Peer AS"
                   "Bad BGP Identifier" "Unsupported Optional Parameter"
                   "Authentication Failure" "Unacceptable Hold Time")))
                :INITFORM NIL)
               (LASTUPDATEERRORSUBCODE UINT16 :CIM-NAME
                "LastUpdateErrorSubCode" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("None" "Malformed Attribute List"
                   ...
                   "Malformed AS_path")))
                :INITFORM NIL)
               (ROUTERID STRING :CIM-NAME "RouterID" :QUALIFIERS
                ((:DESCRIPTION
