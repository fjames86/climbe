...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BIOSElement.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BIOSELEMENT (CIM_SOFTWAREELEMENT)
              ((VERSION STRING :CIM-NAME "Version" :QUALIFIERS
                ((:OVERRIDE "Version")
                 (:MAPPING-STRINGS ("MIF.DMTF|System BIOS|001.3")) :KEY
                 (:DESCRIPTION
               ...
               (MANUFACTURER STRING :CIM-NAME "Manufacturer" :QUALIFIERS
                ((:OVERRIDE "Manufacturer")
                 (:MAPPING-STRINGS ("MIF.DMTF|System BIOS|001.2"))
                 (:DESCRIPTION "Manufacturer of this SoftwareElement.")
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (PRIMARYBIOS BOOLEAN :CIM-NAME "PrimaryBIOS" :QUALIFIERS
                ((:DESCRIPTION
                  "If true, this is the primary BIOS of the ComputerSystem.")
                 (:MAPPING-STRINGS ("MIF.DMTF|System BIOS|001.9")))
                :INITFORM NIL)
               (CURRENTLANGUAGE STRING :CIM-NAME "CurrentLanguage" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_BIOSElement.ListOfLanguages")))
                :INITFORM NIL)
               (LOADEDSTARTINGADDRESS UINT64 :CIM-NAME "LoadedStartingAddress"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The starting address of the memory which this BIOS occupies.")
                 (:MAPPING-STRINGS ("MIF.DMTF|System BIOS|001.5")))
                :INITFORM NIL)
               (LOADEDENDINGADDRESS UINT64 :CIM-NAME "LoadedEndingAddress"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The ending address of the memory which this BIOS occupies.")
                 (:MAPPING-STRINGS ("MIF.DMTF|System BIOS|001.6")))
                :INITFORM NIL)
               (LOADUTILITYINFORMATION STRING :CIM-NAME
                "LoadUtilityInformation" :QUALIFIERS
                ((:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (LISTOFLANGUAGES (ARRAY STRING) :CIM-NAME "ListOfLanguages"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (REGISTRYURIS (ARRAY STRING) :CIM-NAME "RegistryURIs"
                :QUALIFIERS
                ((:DESCRIPTION
