...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BIOSService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BIOSSERVICE (CIM_SERVICE)
...
(DEFCIM-METHOD SETBIOSATTRIBUTE
    ((INSTANCE CIM_BIOSSERVICE)
     (ATTRIBUTENAME STRING "AttributeName" :REQUIRED :IN
      (:DESCRIPTION
       "A reference to a BIOSAttribute specified by AttributeName of the BIOSAttribute to be modified."))
     (AUTHORIZATIONTOKEN STRING "AuthorizationToken" :IN
      (:DESCRIPTION
       "When required, a token to modify BIOSAttribute values for this computer system. This is usually the BIOS administrator password. If this is a password, the PasswordEncoding parameter shall be used to denote the format of the password string. For example: the CIM_SharedCredential subclass may be utilized. In that case, the CIM_SharedCredential.Secret might be required and if is not specified this method would return 6 Invalid Parameter. The CIM_SharedCredential.Algorithm property might also be specified based on the property CIM_BIOSServiceCapabilities.SupportedPasswordAlgorithms.")
      (:EMBEDDED-INSTANCE "CIM_Credential"))
     (PASSWORDENCODING UINT32 "PasswordEncoding" :IN
      (:DESCRIPTION
      ...
      (:VALUES
       ("ascii" "kbd" "pin" "UTF16" "DMTF Reserved" "Vendor Reserved")))
     (SETRESULT UINT32 "SetResult" :IN :OUT
      (:DESCRIPTION
       "Invoking the SetBIOSAttribute may result in a set to CurrentValue property or the PendingValue property. SetResult returns the result of invoking the SetBIOSAttribute method when the method return code is 0 completed with no error.")
      (:VALUE-MAP ("2" "3" ".." "32768..65535"))
      (:VALUES
       ("Set CurrentValue property" "Set PendingValue property" "DMTF Reserved"
        "Vendor Reserved")))
     (TARGETBIOS "CIM_BIOSElement" "TargetBIOS" :IN
      (:DESCRIPTION
       "If supplied, TargetBIOS references the scoping instance of CIM_BIOSElement in which the operation is targeted. If TargetBIOS is not supplied, the target of the operation shall be the current instance of CIM_BIOSElement associated to the CIM_ComputerSystem hosting the service."))
     (ATTRIBUTEVALUE (ARRAY STRING) "AttributeValue" :REQUIRED :IN
      (:DESCRIPTION
    ...
    ((:CIM-NAME "SetBIOSAttribute")
     (:QUALIFIERS
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Error" "DMTF Reserved"
        "Vendor Reserved")))))
(DEFCIM-METHOD SETBIOSATTRIBUTEEMBEDDEDINSTANCE
    ((INSTANCE CIM_BIOSSERVICE)
     (ATTRIBUTECONFIG STRING "AttributeConfig" :REQUIRED :IN
      (:DESCRIPTION
       "AttributeConfig is the input required to modify the value of a BIOSAttribute. The CIM_BIOSAttribute.AttributeName and the CIM_BIOSAttribute.CurrentValue properties are Required for this operation. If both properties are not specified the service shall return 6 Invalid Parameter.")
      (:EMBEDDED-INSTANCE "CIM_BIOSAttribute"))
     (AUTHORIZATIONTOKEN STRING "AuthorizationToken" :IN
      (:DESCRIPTION
       "When required, a token to modify BIOSAttribute values for this computer system. This is usually the BIOS administrator password. If this is a password, the PasswordEncoding parameter shall be used to denote the format of the password string. For example: the CIM_SharedCredential subclass may be utilized. In that case, the CIM_SharedCredential.Secret might be required and if is not specified this method would return 6 Invalid Parameter. The CIM_SharedCredential.Algorithm property might also be specified based on the property CIM_BIOSServiceCapabilities.SupportedPasswordAlgorithms.")
      (:EMBEDDED-INSTANCE "CIM_Credential"))
     (PASSWORDENCODING UINT32 "PasswordEncoding" :IN
      (:DESCRIPTION
       "PasswordEncoding specifies encoding tag used to denote the format the password string is being passed into the BIOS. This property is applicable if the AuthorizationToken parameter includes a password.
\"kbd\" denotes a string in hexadecimal format containing keyboard scan code input. An example of a password structured in this format would be \"321539191E1F1F11181320\", which is the representation of \"my password\" in US English keyboard scan codes. \"ascii\" denotes clear text that shall comply with the ASCII character set. Character encodings from \" \" (decimal 32) to \"~\" (decimal 126) are supported. An example would be \"my password\".\"pin\" denotes that only numeric input in ASCII text is allowed for the password instance. An example would be \"1234\".")
     ...
     (SETRESULT UINT32 "SetResult" :IN :OUT
      (:DESCRIPTION
       "Invoking the SetBIOSAttributeEmbeddedInstance may result in a set to CurrentValue property or the PendingValue property. SetResult returns the result of invoking the SetBIOSAttributeEmbeddedInstance method when the method return code is 0 completed with no error.")
      (:VALUE-MAP ("2" "3" ".." "32768..65535"))
      (:VALUES
       ("Set CurrentValue property" "Set PendingValue property" "DMTF Reserved"
        "Vendor Reserved")))
     (TARGETBIOS "CIM_BIOSElement" "TargetBIOS" :IN
      (:DESCRIPTION
       "If supplied, TargetBIOS references the scoping instance of CIM_BIOSElement in which the operation is targeted. If TargetBIOS is not supplied, the target of the operation shall be the current instance of CIM_BIOSElement associated to the CIM_ComputerSystem hosting the service.")))
    ((:CIM-NAME "SetBIOSAttributeEmbeddedInstance")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Error" "DMTF Reserved"
        "Vendor Reserved")))))
(DEFCIM-METHOD READRAWBIOSDATA
    ((INSTANCE CIM_BIOSSERVICE)
     (OFFSET UINT32 "Offset" :REQUIRED :IN
      (:DESCRIPTION "Specifies initial offset to start reading from."))
     (NUMBEROFBYTES UINT32 "NumberOfBytes" :REQUIRED :IN :OUT
      (:DESCRIPTION
       "On input, specifies the number of bytes to read. On output, specifies the number of bytes read."))
     (TARGETBIOS "CIM_BIOSElement" "TargetBIOS" :IN
      (:DESCRIPTION
       "If supplied, TargetBIOS references the scoping instance of CIM_BIOSElement in which the operation is targeted. If TargetBIOS is not supplied, the target of the operation shall be the current instance of CIM_BIOSElement associated to the CIM_ComputerSystem hosting the service."))
     (DATA (ARRAY UINT8) "Data" :IN :OUT
      (:DESCRIPTION "Buffer to contain read data.") :OCTET-STRING))
    ((:CIM-NAME "ReadRawBIOSData")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP ("0" "1" "2" ".." "65536..4294967295"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
        "DMTF Reserved" "Vendor Reserved")))))
(DEFCIM-METHOD WRITERAWBIOSDATA
    ((INSTANCE CIM_BIOSSERVICE)
     (OFFSET UINT32 "Offset" :REQUIRED :IN
      (:DESCRIPTION "Specifies initial offset to start reading from."))
     (NUMBEROFBYTES UINT32 "NumberOfBytes" :REQUIRED :IN :OUT
      (:DESCRIPTION
       "On input, specifies the number of bytes of data to write. On output, specifies the number of bytes written."))
     (AUTHORIZATIONTOKEN STRING "AuthorizationToken" :IN
      (:DESCRIPTION
       "A token required to modify BIOSAttribute values for this computer system. This is usually the BIOS administrator password. For example: the CIM_SharedCredential subclass may be utilized. In that case, the CIM_SharedCredential.Secret might be required and if is not specified this method would return 6 Invalid Parameter. The CIM_SharedCredential.Algorithm property might also be specified based on the propertyCIM_BIOSServiceCapabilities.SupportedPasswordAlgorithms.")
      (:EMBEDDED-INSTANCE "CIM_Credential"))
     (PASSWORDENCODING UINT32 "PasswordEncoding" :IN
      (:DESCRIPTION
       "PasswordEncoding specifies encoding tag used to denote the format the password string is being passed into the BIOS. This property is applicable if the AuthorizationToken parameter includes a password. 
\"kbd\" denotes a string in hexadecimal format containing keyboard scan code input. An example of a password structured in this format would be \"321539191E1F1F11181320\", which is the representation of \"my password\" in US English keyboard scan codes. \"ascii\" denotes clear text that shall comply with the ASCII character set. Character encodings from \" \" (decimal 32) to \"~\" (decimal 126) are supported. An example would be \"my password\".\"pin\" denotes that only numeric input in ASCII text is allowed for the password instance. An example would be \"1234\".")
     ...
     (TARGETBIOS "CIM_BIOSElement" "TargetBIOS" :IN
      (:DESCRIPTION
       "If supplied, TargetBIOS references the scoping instance of CIM_BIOSElement in which the operation is targeted. If TargetBIOS is not supplied, the target of the operation shall be the current instance of CIM_BIOSElement associated to the CIM_ComputerSystem hosting the service."))
     (DATA (ARRAY UINT8) "Data" :IN
      (:DESCRIPTION "Buffer containing data to write.") :OCTET-STRING))
    ((:CIM-NAME "WriteRawBIOSData")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with  No Error" "Not Supported" "Unknown/Unspecified Error"
        "DMTF Reserved" "Vendor Reserved")))))
(DEFCIM-METHOD SETBIOSATTRIBUTES
    ((INSTANCE CIM_BIOSSERVICE)
     (COLLECTIONELEMENTNAME STRING "CollectionElementName" :IN
      (:DESCRIPTION
       "If supplied, the ConcreteCollection containing the BIOS Attributes to be modified, as specified by the ConcreteCollection.ElementName property. The value of ConcreteCollection.ElementName supplied for this parameter must be unique within the scope of the instantiating Namespace; if the value is not unique, this parameter shall not be supplied. If BIOS Attributes represented by the AttributeName[] parameter are not members of this collection, the SetResult parameter that corresponds to these BIOS Attributes shall return 5 (No Attempt to Set Value due to Error). If CollectionElementName is not specified, the BIOS Attributes represented by the AttributeName[] parameter can be members of any collection or associated with no collection at all."))
     (AUTHORIZATIONTOKEN STRING "AuthorizationToken" :IN
      (:DESCRIPTION
       "When required, a token to modify BIOSAttribute values for this computer system. This is usually the BIOS administrator password. If this is a password, the PasswordEncoding parameter shall be used to denote the format of the password string. For example: the CIM_SharedCredential subclass may be utilized. In that case, the CIM_SharedCredential.Secret might be required and if is not specified this method would return 6 Invalid Parameter. The CIM_SharedCredential.Algorithm property might also be specified based on the propertyCIM_BIOSServiceCapabilities.SupportedPasswordAlgorithms.")
      (:EMBEDDED-INSTANCE "CIM_Credential"))
     ...
     (TARGETBIOS "CIM_BIOSElement" "TargetBIOS" :IN
      (:DESCRIPTION
       "If supplied, TargetBIOS references the scoping instance of CIM_BIOSElement in which the operation is targeted. If TargetBIOS is not supplied, the target of the operation shall be the current instance of CIM_BIOSElement associated to the CIM_ComputerSystem hosting the service."))
     (ATTRIBUTENAME (ARRAY STRING) "AttributeName" :REQUIRED :IN
      (:DESCRIPTION
       "The BIOS Attribute names representing the BIOS Attributes to be modified, as specified by BIOSAttribute.AttributeName properties. The specified BIOS Attributes must already exist. The values of BIOSAttribute.AttributeName supplied for this parameter must be unique within the scope of the instantiating Namespace. The BIOS Attribute name members of this array must correspond with array members of the values represented by the AttributeValue[] parameter. If more than one value is specified for a particular BIOS Attribute, this parameter shall contain multiple identical array entries describing the BIOS Attribute name that corresponds with each respective BIOS Attribute value specified by the AttributeValue[] parameter.")
      (:ARRAYTYPE "Indexed")
      (:MODEL-CORRESPONDENCE
