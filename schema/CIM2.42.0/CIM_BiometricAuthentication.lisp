...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BiometricAuthentication.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BIOMETRICAUTHENTICATION (CIM_AUTHENTICATIONCONDITION)
              ((TYPEOFBIOMETRIC UINT16 :CIM-NAME "TypeOfBiometric" :QUALIFIERS
                ((:DESCRIPTION
                  "Integer enumeration identifying the biometric data that should be authenticated.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7" "8"))
                 (:VALUES
                  ("Other" "Facial" "Retina" "Mark" "Finger" "Voice" "DNA-RNA"
                   "EEG"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_BiometricAuthentication.OtherBiometric")))
                :INITFORM NIL)
               (OTHERBIOMETRIC STRING :CIM-NAME "OtherBiometric" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PERSONALIDENTIFIER STRING :CIM-NAME "PersonalIdentifier"
                :QUALIFIERS
                ((:DESCRIPTION
...
This MOF defines the following keywords: 'UNKNOWN', 'CONFIGURATION', 'USAGE', 'SECURITY', 'SERVICE', 'MOTIVATIONAL', 'INSTALLATION', and 'EVENT'. These concepts are self-explanatory and are further discussed in the SLA/Policy White Paper. One additional keyword is defined: 'POLICY'. The role of this keyword is to identify policy-related instances that may not be otherwise identifiable, in some implementations. The keyword 'POLICY' is NOT mutually exclusive of the other keywords specified above."))
                :INITFORM NIL))
              (:CIM-NAME "CIM_BiometricAuthentication")
