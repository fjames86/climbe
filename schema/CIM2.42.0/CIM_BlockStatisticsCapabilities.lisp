...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (SYNCHRONOUSMETHODSSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                ((:OVERRIDE "SynchronousMethodsSupported")
                 ...
                 (:VALUE-MAP ("2" "3" "4" "5" "6" "7" "8" ".." "0x8000.."))
                 (:VALUES
                  ("Execute Query" "Query Collection" "GetStatisticsCollection"
                   "Manifest Creation" "Manifest Modification"
                   "Manifest Removal" "GetRateStatisticsCollection"
                   "DMTF Reserved" "Vendor Specific")))
                :INITFORM NIL)
               (ASYNCHRONOUSMETHODSSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                ((:OVERRIDE "AsynchronousMethodsSupported")
                 ...
                 (:VALUE-MAP ("2" "3" "8" ".." "0x8000.."))
                 (:VALUES
                  ("GetStatisticsCollection" "Indications"
                   "GetRateStatisticsCollection" "DMTF Reserved"
                   "Vendor Specific")))
                :INITFORM NIL))
              (:CIM-NAME "CIM_BlockStatisticsCapabilities")
