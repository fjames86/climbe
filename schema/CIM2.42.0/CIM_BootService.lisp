...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_BootService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_BOOTSERVICE (CIM_SERVICE)
...
(DEFCIM-METHOD CREATEBOOTCONFIGSETTING
    ((INSTANCE CIM_BOOTSERVICE)
     (STARTINGBOOTCONFIG "CIM_BootConfigSetting" "StartingBootConfig" :REQUIRED
      :IN
      (:DESCRIPTION
       "An existing BootConfigSetting instance used as a template to replicate. factory default configuration."))
     (SCOPINGCOMPUTERSYSTEM "CIM_ComputerSystem" "ScopingComputerSystem" :IN
      (:DESCRIPTION
       "directly or indirectly associated. If ScopingComputerSystem has a non-NULL value, the scoping system for NewBootConfig is explicitly identified. If ScopingComputerSystem has a value of NULL, the new BootConfigSetting shall be related to the same set of ComputerSystems as is the template configuration."))
     (NEWBOOTCONFIG "CIM_BootConfigSetting" "NewBootConfig" :IN :OUT
      (:DESCRIPTION
       "The BootConfigSetting instance created by the method. This parameter is not returned if the method is run as a Job."))
...
(DEFCIM-METHOD SETBOOTCONFIGROLE
    ((INSTANCE CIM_BOOTSERVICE)
     (ROLE UINT16 "Role" :REQUIRED :IN
      (:DESCRIPTION "The desired Role of the BootConfigSetting. 
...
\"IsDefault\" updates the ElementSettingData.IsDefault property to indicate that the BootConfigSetting is identified as the default boot configuration for any of its related ComputerSystems")
      ...
      (:VALUES
       ("IsNext" "IsNextSingleUse" "IsDefault" "DMTF Reserved"
        "Vendor Specified")))
     (BOOTCONFIGSETTING "CIM_BootConfigSetting" "BootConfigSetting" :REQUIRED
      :IN
      (:DESCRIPTION
...
The method shall update the IsNext or IsDefault property of every ElementSettingData that directly or indirectly associates BootConfigSetting to a ComputerSystem. The method may also update the IsNext or IsDefault property of other ElementSettingDatas that reference the same ComputerSystems to satisfy cardinality constraints.")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
        ...
        "DMTF Reserved" "Method Parameters Checked - Job Started"
        "Method Reserved" "Vendor Specified")))))
(DEFCIM-METHOD SETBOOTCONFIGUSAGE
    ((INSTANCE CIM_BOOTSERVICE)
     (ROLE UINT16 "Role" :REQUIRED :IN
      (:DESCRIPTION "The desired Role of the BootConfigSetting.
...
\"IsDefault\" removes the IsDefault designation.")
      ...
      (:VALUES
       ("IsNext" "IsNextSingleUse" "IsDefault" "IsNotNext" "IsNotDefault"
     ...
     (SCOPINGCOMPUTERSYSTEM "CIM_ComputerSystem" "ScopingComputerSystem" :IN
      (:DESCRIPTION
       "The ComputerSystem to which the new Role applies. A value of NULL indicates that the Role is to be applied to each ComputerSystem that is directly or indirectly associated to BootConfigSetting."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "Reference to the job spawned if the operation continues after the method returns. (May be null if the task is completed).")))
    ((:CIM-NAME "SetBootConfigUsage")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
        ...
        "DMTF Reserved" "Method Parameters Checked - Job Started"
        "Method Reserved" "Vendor Specified")))))
(DEFCIM-METHOD APPLYBOOTCONFIGSETTING
    ((INSTANCE CIM_BOOTSERVICE)
     (SCOPINGCOMPUTERSYSTEM "CIM_ComputerSystem" "ScopingComputerSystem"
      :REQUIRED :IN
      (:DESCRIPTION
       "Reference to an instance of ComputerSystem which will apply the BootConfigSetting referenced by the ApplyBootConfig parameter. A value of NULL indicates that the ApplyBootConfig is to be applied to each related ComputerSystem."))
     (APPLYBOOTCONFIG "CIM_BootConfigSetting" "ApplyBootConfig" :REQUIRED :IN
      (:DESCRIPTION
       "Reference to an instance of BootConfigSetting which will be applied to the instance of ComputerSystem referenced by the ComputerSystem parameter."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "Reference to the job spawned if the operation continues after the method returns. (May be null if the task is completed).")))
    ((:CIM-NAME "ApplyBootConfigSetting")
     (:QUALIFIERS
      (:DESCRIPTION
       "This method is called to indicate to the referenced ComputerSystem to apply the referenced BootConfigSetting. This shall cause the referenced ComputerSystem's boot process to start and apply the referenced BootConfigSetting.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" ".." "4096" "4097..32767" "32768..65535"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
