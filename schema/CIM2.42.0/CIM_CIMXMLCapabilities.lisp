...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CIMXMLCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CIMXMLCAPABILITIES (CIM_WBEMPROTOCOLSERVICECAPABILITIES)
              ((MULTIPLEOPERATIONSSUPPORTED BOOLEAN :CIM-NAME
                "MultipleOperationsSupported" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
                  "Multiple operations conveniently allow multiple method invocations to be batched into a single HTTP message. This value shall be true if multiple operations are supported; false otherwise."))
                :INITFORM NIL)
               (VALIDATED BOOLEAN :CIM-NAME "Validated" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_CIMXMLCapabilities")
