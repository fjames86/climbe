...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CIMXMLCommunicationMechanism.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CIMXMLCOMMUNICATIONMECHANISM
              (CIM_OBJECTMANAGERCOMMUNICATIONMECHANISM)
              ((COMMUNICATIONMECHANISM UINT16 :CIM-NAME
                "CommunicationMechanism" :QUALIFIERS
                ((:DEPRECATED ("CIM_ProtocolService.Protocol")) :REQUIRED
                 (:OVERRIDE "CommunicationMechanism")
                 (:DESCRIPTION
                  "The only valid CommunicationMechanism for this subclass is CIM-XML.")
                 (:VALUE-MAP ("2")) (:VALUES ("CIM-XML"))
               ...
               (VERSION STRING :CIM-NAME "Version" :QUALIFIERS
                ((:DEPRECATED
                 ...
                 (:VALUE-MAP ("1.0" "1.1" "1.2")))
                :INITFORM NIL)
               (CIMXMLPROTOCOLVERSION UINT16 :CIM-NAME "CIMXMLProtocolVersion"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_CIMXMLCommunicationMechanism.Version"))
                 ...
                 (:VALUE-MAP ("0" "1")) (:VALUES ("Unknown" "1.0")))
                :INITFORM NIL)
               (CIMVALIDATED BOOLEAN :CIM-NAME "CIMValidated" :QUALIFIERS
                ((:DEPRECATED ("No value")) :REQUIRED
                 (:DESCRIPTION
                ...
                :INITFORM NIL)
               (OTHERCOMMUNICATIONMECHANISMDESCRIPTION STRING :CIM-NAME
                "OtherCommunicationMechanismDescription" :QUALIFIERS
                ((:DEPRECATED ("CIM_ProtocolService.OtherProtocol"))
                 (:DESCRIPTION
                ...
                :INITFORM NIL)
               (MULTIPLEOPERATIONSSUPPORTED BOOLEAN :CIM-NAME
                "MultipleOperationsSupported" :QUALIFIERS
                ((:DEPRECATED ("No value")) :REQUIRED
                 (:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (FUNCTIONALPROFILESSUPPORTED (ARRAY UINT16) :CIM-NAME
                "FunctionalProfilesSupported" :QUALIFIERS
                ((:DEPRECATED ("No value")) :REQUIRED
                 (:DESCRIPTION
                ...
                :INITFORM NIL)
               (FUNCTIONALPROFILEDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                "FunctionalProfileDescriptions" :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION
                ...
                :INITFORM NIL)
               (AUTHENTICATIONMECHANISMSSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL)
               (AUTHENTICATIONMECHANISMDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                "AuthenticationMechanismDescriptions" :QUALIFIERS
                ((:DEPRECATED
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_CIMXMLCommunicationMechanism")
              (:QUALIFIERS (:DEPRECATED ("CIM_CIMXMLCapabilities"))
...
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_CIMXMLCOMMUNICATIONMECHANISM)
