...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CacheMemory.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CACHEMEMORY (CIM_MEMORY)
              ((LEVEL UINT16 :CIM-NAME "Level" :QUALIFIERS
                ((:DEPRECATED ("CIM_AssociatedCacheMemory.Level"))
                 ...
                 (:VALUES
                  ("Other" "Unknown" "Primary" "Secondary" "Tertiary"
                   "Not Applicable"))
               ...
               (WRITEPOLICY UINT16 :CIM-NAME "WritePolicy" :QUALIFIERS
                ((:DEPRECATED ("CIM_AssociatedCacheMemory.WritePolicy"))
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6"))
                 (:VALUES
                  ("Other" "Unknown" "Write Back" "Write Through"
               ...
               (REPLACEMENTPOLICY UINT16 :CIM-NAME "ReplacementPolicy"
                ...
                ((:DEPRECATED ("CIM_AssociatedCacheMemory.ReplacementPolicy"))
                 ...
                 (:VALUES
                  ("Other" "Unknown" "Least Recently Used (LRU)"
               ...
               (READPOLICY UINT16 :CIM-NAME "ReadPolicy" :QUALIFIERS
                ((:DEPRECATED ("CIM_AssociatedCacheMemory.ReadPolicy"))
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6"))
                 (:VALUES
                  ("Other" "Unknown" "Read" "Read-Ahead" "Read and Read-Ahead"
               ...
               (ASSOCIATIVITY UINT16 :CIM-NAME "Associativity" :QUALIFIERS
                ((:DEPRECATED ("CIM_AssociatedCacheMemory.Associativity"))
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7" "8"))
                 (:VALUES
                  ("Other" "Unknown" "Direct Mapped" "2-way Set-Associative"
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_CacheMemory")
              (:QUALIFIERS (:DEPRECATED ("CIM_AssociatedCacheMemory"))
               (:VERSION "2.8.0") (:UML-PACKAGE-PATH "CIM::Device::Memory")
               (:DESCRIPTION
