...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ChangerDevice.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CHANGERDEVICE (CIM_MEDIATRANSFERDEVICE)
              ((MAXTRANSITTIME UINT32 :CIM-NAME "MaxTransitTime" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MEDIAFLIPSUPPORTED BOOLEAN :CIM-NAME "MediaFlipSupported"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (AUDITINPROGRESS BOOLEAN :CIM-NAME "AuditInProgress" :QUALIFIERS
                ...
                :INITFORM NIL)
               (AUDITSPERFORMED UINT64 :CIM-NAME "AuditsPerformed" :QUALIFIERS
                ((:DESCRIPTION
