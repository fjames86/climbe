...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ClassIndication.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CLASSINDICATION (CIM_INDICATION)
...
When retrying the delivery of an indication, this property shall have the same value as in the original delivery.")
               ...
               (CORRELATEDINDICATIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ClassIndication")
              (:QUALIFIERS :INDICATION :ABSTRACT (:VERSION "2.6.0")
