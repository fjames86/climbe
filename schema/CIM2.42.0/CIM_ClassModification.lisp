...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ClassModification.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CLASSMODIFICATION (CIM_CLASSINDICATION)
              ((PREVIOUSCLASSDEFINITION STRING :CIM-NAME
                "PreviousClassDefinition" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
                 ...
                 :EMBEDDED-OBJECT)
                :INITFORM NIL)
               (CLASSDEFINITION STRING :CIM-NAME "ClassDefinition" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
...
When retrying the delivery of an indication, this property shall have the same value as in the original delivery.")
               ...
               (CORRELATEDINDICATIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ClassModification")
