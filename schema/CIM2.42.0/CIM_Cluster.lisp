...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Cluster.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CLUSTER (CIM_COMPUTERSYSTEM)
              ((INTERCONNECT STRING :CIM-NAME "Interconnect" :QUALIFIERS
                ((:DESCRIPTION
                  "Interconnect is a free form string that describes the interconnection mechanism for the Cluster."))
                :INITFORM NIL)
               (INTERCONNECTADDRESS STRING :CIM-NAME "InterconnectAddress"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MAXNUMBEROFNODES UINT32 :CIM-NAME "MaxNumberOfNodes"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates the maximum number of nodes that may participate in the Cluster. If unlimited, enter 0."))
                :INITFORM NIL)
               (CLUSTERSTATE UINT16 :CIM-NAME "ClusterState" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "On-line" "Off-line" "Degraded"
                   "Unavailable")))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (TYPES (ARRAY UINT16) :CIM-NAME "Types" :QUALIFIERS
                ((:DESCRIPTION
