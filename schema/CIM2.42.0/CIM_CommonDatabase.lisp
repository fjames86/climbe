...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CommonDatabase.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_COMMONDATABASE (CIM_ENABLEDLOGICALELEMENT)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (LASTBACKUP DATETIME :CIM-NAME "LastBackup" :QUALIFIERS
                ...
                :INITFORM NIL)
               (SIZEALLOCATED UINT32 :CIM-NAME "SizeAllocated" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (SIZEUNITS UINT16 :CIM-NAME "SizeUnits" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Bytes" "Kilobyes" "Megabytes" "Gigabytes" "Terabytes"))
                 (:MAPPING-STRINGS
