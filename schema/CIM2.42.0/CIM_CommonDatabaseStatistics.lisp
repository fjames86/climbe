...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CommonDatabaseStatistics.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_COMMONDATABASESTATISTICS (CIM_STATISTICALDATA)
              ((SIZEUSED UINT32 :CIM-NAME "SizeUsed" :QUALIFIERS
                ((:DESCRIPTION
                  "The estimated amount of disk space (in units) that is currently used by the database.")
                 (:MAPPING-STRINGS ("MIB.IETF|RDBMS-MIB.rdbmsDbInfoSizeUsed")))
                :INITFORM NIL)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_CommonDatabaseStatistics")
...
(DEFCIM-METHOD RESETSELECTEDSTATS
    ((INSTANCE CIM_COMMONDATABASESTATISTICS)
