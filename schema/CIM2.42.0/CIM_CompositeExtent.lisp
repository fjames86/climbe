...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CompositeExtent.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_COMPOSITEEXTENT (CIM_STORAGEEXTENT)
              ((NUMBEROFBLOCKS UINT64 :CIM-NAME "NumberOfBlocks" :QUALIFIERS
                ...
                :INITFORM NIL)
               (EXTENTSTRIPELENGTH UINT64 :CIM-NAME "ExtentStripeLength"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (EXTENTINTERLEAVEDEPTH UINT64 :CIM-NAME "ExtentInterleaveDepth"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ISCONCATENATED BOOLEAN :CIM-NAME "IsConcatenated" :QUALIFIERS
                ((:DESCRIPTION
