...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ConfigurationReportingService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CONFIGURATIONREPORTINGSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ConfigurationReportingService")
...
(DEFCIM-METHOD GETCLASSTYPES
    ((INSTANCE CIM_CONFIGURATIONREPORTINGSERVICE)
     (INQUIRYTYPE UINT16 "InquiryType" :IN
      (:DESCRIPTION "The type of inquiry to be performed.")
      (:VALUE-MAP ("2" "3")) (:VALUES ("Supports" "Installed")))
     (RECURSIVE BOOLEAN "Recursive" :IN
      (:DESCRIPTION
       "False : Only report on elements directly contained in/attached to the given ManagedElement. 
True : Report on all objects contained in/attached to the given ManagedElement."))
     (TARGET "CIM_ManagedElement" "Target" :IN
      (:DESCRIPTION "The target of query, for example a rack or a chassis."))
     (CLASSTYPES (ARRAY STRING) "ClassTypes" :IN :OUT
      (:DESCRIPTION
       "Array containing the class names (typically the leaf classes) that the given ManagedElement can support or has installed.")))
    ((:CIM-NAME "GetClassTypes")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Success" "Not Supported" "Unknown" "Timeout" "Failed" "DMTF Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD GETUNITTYPES
    ((INSTANCE CIM_CONFIGURATIONREPORTINGSERVICE)
     (INQUIRYTYPE UINT16 "InquiryType" :IN
      (:DESCRIPTION "The type of inquiry to be performed.")
      (:VALUE-MAP ("2" "3")) (:VALUES ("Supported" "Installed")))
     (RECURSIVE BOOLEAN "Recursive" :IN
      (:DESCRIPTION
       "False : Only report on elements directly contained in/attached to the given ManagedElement. 
True : Report on all objects contained in/attached to the given ManagedElement."))
     (CLASSTYPE STRING "ClassType" :IN
      (:DESCRIPTION
       "The ClassType for the query. This should be a entry returned in the GetClassTypes.ClassTypes property."))
     (TARGET "CIM_ManagedElement" "Target" :IN
      (:DESCRIPTION "The target of query, for example a rack or a chassis."))
     (UNITTYPES (ARRAY UINT16) "UnitTypes" :IN :OUT
      (:DESCRIPTION "A list of supported UnitTypes.")
      (:VALUE-MAP ("2" "3" "4" "5" "6" "7" "8" "9" "10" ".." "32768..65535"))
      (:VALUES
       ("None" "Front Side" "Back Side" "Contained" "Connected" "I/O" "Memory"
        "StorageMediaLocation" "Megabytes" "DMTF Reserved" "Vendor Specific"))
      (:MODEL-CORRESPONDENCE
       ("CIM_ConfigurationReportingService.ReportCapacity(UnitType)"))))
    ((:CIM-NAME "GetUnitTypes")
     (:QUALIFIERS
      (:DESCRIPTION
...
True : Report on all objects contained in/attached to the given ManagedElement."))
     (CLASSTYPE STRING "ClassType" :IN
      (:DESCRIPTION
       "The ClassType for the query. This should be a entry returned in the GetClassTypes.ClassTypes property."))
     (UNITTYPE UINT16 "UnitType" :IN
      (:DESCRIPTION "The UnitType for the query.")
      (:VALUE-MAP ("2" "3" "4" "5" "6" "7" "8" "9" "10" ".." "32768..65535"))
      (:VALUES
       ("None" "Front Side" "Back Side" "Contained" "Connected" "I/O" "Memory"
        "StorageMediaLocation" "Megabytes" "DMTF Reserved" "Vendor Specific"))
     ...
     (NUMBEROFUNITS UINT64 "NumberOfUnits" :IN :OUT
      (:DESCRIPTION
       "The maximum number of supported or the number of currently installed units."))
     (TARGET "CIM_ManagedElement" "Target" :IN
      (:DESCRIPTION "The target of query, for example a rack or a chassis.")))
    ((:CIM-NAME "ReportCapacity")
     (:QUALIFIERS
      (:DESCRIPTION
