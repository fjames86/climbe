...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ControlledBy.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CONTROLLEDBY (CIM_DEVICECONNECTION)
              ((ACCESSSTATE UINT16 :CIM-NAME "AccessState" :QUALIFIERS
               ...
               (ANTECEDENT NIL :CIM-NAME "Antecedent" :QUALIFIERS
                ((:OVERRIDE "Antecedent") (:DESCRIPTION "The Controller.")
                 :KEY)
                :INITFORM "CIM_Controller")
               (DEPENDENT NIL :CIM-NAME "Dependent" :QUALIFIERS
                ((:OVERRIDE "Dependent")
                 (:DESCRIPTION "The controlled Device.") :KEY)
                :INITFORM "CIM_LogicalDevice"))
              (:CIM-NAME "CIM_ControlledBy")
