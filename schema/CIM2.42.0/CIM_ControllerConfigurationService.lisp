...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ControllerConfigurationService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_CONTROLLERCONFIGURATIONSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ControllerConfigurationService")
...
(DEFCIM-METHOD CREATEPROTOCOLCONTROLLERWITHPORTS
    ((INSTANCE CIM_CONTROLLERCONFIGURATIONSERVICE)
     (ELEMENTNAME STRING "ElementName" :IN
      (:DESCRIPTION
       "The string to be used in the ElementName of the new ProtocolController.")
      (:MODEL-CORRESPONDENCE ("CIM_ProtocolController.ElementName")))
     (PROTOCOL UINT16 "Protocol" :IN
      (:DESCRIPTION "The protocol type for the new ProtocolController.")
      (:VALUE-MAP ("0" "1" "2")) (:VALUES ("Unknown" "Other" "SCSI"))
      (:MODEL-CORRESPONDENCE ("CIM_SCSIProtocolController")))
     (PRIVILEGE "CIM_Privilege" "Privilege" :IN
      (:DESCRIPTION
...
Note: if ProtocolControllerRequiresAuthorizedIdentity is true, then the Identity/Privilege pair MUST be specified. If false, then the Identity/Privilege pair MUST NOT be specified.")
     ...
     (IDENTITY "CIM_ManagedElement" "Identity" :IN
               (:DESCRIPTION
...
Note: if ProtocolControllerRequiresAuthorizedIdentity is true, then at least the Identity/Privilege pair MUST be specified.")
     ...
     (PROTOCOLCONTROLLER "CIM_ProtocolController" "ProtocolController" :IN :OUT
      (:DESCRIPTION
       "A reference to the new ProtocolController that is created."))
     (PORTS (ARRAY STRING) "Ports" :IN
      (:DESCRIPTION
    ...
    ((:CIM-NAME "CreateProtocolControllerWithPorts")
     (:QUALIFIERS
      (:DESCRIPTION
...
If multiple target ports are specified in the Ports input parameter, all expose the same view (i.e., have the same unit numbers and permissions). This method does not create the port instances, but does create ProtocolControllerForPort associations between the specified ports and the new ProtocolController. The new ProtocolController is defined to be weak to the same System as the ControllerConfigurationService.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..4095" "4096" "4097" "4098" "4099..32767"
        "32768..65535"))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved"
        "ID Parameter Missing or Not Unique"
        "Hardware Implementation Requires Null Ports Parameter" "Busy"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD DELETEPROTOCOLCONTROLLER
    ((INSTANCE CIM_CONTROLLERCONFIGURATIONSERVICE)
     ...
     (DELETEUNITS BOOLEAN "DeleteUnits" :IN
      (:DESCRIPTION
...
(DEFCIM-METHOD ATTACHDEVICE
    ((INSTANCE CIM_CONTROLLERCONFIGURATIONSERVICE)
     (DEVICENUMBER STRING "DeviceNumber" :IN :OUT
      (:DESCRIPTION
      ...
      (:MODEL-CORRESPONDENCE ("CIM_ProtocolControllerForUnit.DeviceNumber")))
     (PROTOCOLCONTROLLER "CIM_ProtocolController" "ProtocolController" :IN
      (:DESCRIPTION "The ProtocolController instance."))
     (DEVICE "CIM_LogicalDevice" "Device" :IN
      (:DESCRIPTION "The LogicalDevice instance to attach.")))
    ((:CIM-NAME "AttachDevice")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..4095" "4096" "4097" "4098" "4099" "4100"
        "4101..32767" "32768..65535"))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Invalid LogicalDevice Instance"
        "Device Number Conflict" "DeviceNumber Parameter Must Be Provided"
        "Hardware Implementation Requires Null DeviceNumber" "Busy"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD DETACHDEVICE
    ((INSTANCE CIM_CONTROLLERCONFIGURATIONSERVICE)
     (PROTOCOLCONTROLLER "CIM_ProtocolController" "ProtocolController" :IN
      (:DESCRIPTION "The ProtocolController instance."))
     (DEVICE "CIM_LogicalDevice" "Device" :IN
      (:DESCRIPTION "The LogicalDevice instance to detach.")))
    ((:CIM-NAME "DetachDevice")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved"
        "LogicalDevice Instance not Associated with Controller" "Busy"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD EXPOSEPATHS
    ((INSTANCE CIM_CONTROLLERCONFIGURATIONSERVICE)
     ...
     (LUNAMES (ARRAY STRING) "LUNames" :REQUIRED :IN
      (:DESCRIPTION
     ...
     (INITIATORPORTIDS (ARRAY STRING) "InitiatorPortIDs" :IN
      (:DESCRIPTION
     ...
     (TARGETPORTIDS (ARRAY STRING) "TargetPortIDs" :IN
      (:DESCRIPTION
       "IDs of target ports. See the method description for conditions where this MAY be null.")
      (:MODEL-CORRESPONDENCE ("CIM_SCSIProtocolEndpoint.Name")))
     (DEVICENUMBERS (ARRAY STRING) "DeviceNumbers" :IN
      (:DESCRIPTION
      ...
      (:MODEL-CORRESPONDENCE
       ("CIM_ProtocolControllerForUnit.DeviceNumberCIM_ControllerConfigurationService.ExposePaths.LUNames"
        "CIM_ControllerConfigurationService.ExposePaths.DeviceAccesses")))
     (DEVICEACCESSES (ARRAY UINT16) "DeviceAccesses" :IN
      (:DESCRIPTION
      ...
      (:VALUES
       ("Unknown" "Read Write" "Read-Only" "No Access" "DMTF Reserved"
        "Vendor Reserved"))
      (:ARRAYTYPE "Indexed")
      (:MODEL-CORRESPONDENCE
     ...
     (PROTOCOLCONTROLLERS "CIM_SCSIProtocolController" "ProtocolControllers"
      :IN :OUT
      (:DESCRIPTION
...
If the instrumentation provides PrivilegeManagementService, the results of setting DeviceAccesses MUST be synchronized with PrivilegeManagementService as described in the ProtocolControllerForUnit DeviceAccess description.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..4095" "4096" "4097" "4098" "4099" "4100"
        "4101" "4102" "4103" "4104..32767" "32768..65535"))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved"
        "Method Parameters Checked - Job Started" "Invalid logical unit ID"
        "Invalid initiator port ID" "Invalid target port ID"
        "Invalid permission" "Target/initiator combination already exposed"
        "Requested logical unit number in use" "Maximum Map Count Exceeded"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD HIDEPATHS
    ((INSTANCE CIM_CONTROLLERCONFIGURATIONSERVICE)
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "Reference to the job if 'Method Parameters Checked - Job Started' is returned (MAY be null if job completed)."))
     (LUNAMES (ARRAY STRING) "LUNames" :REQUIRED :IN
      ...
      (:MODEL-CORRESPONDENCE ("CIM_LogicalDevice.Name")))
     (INITIATORPORTIDS (ARRAY STRING) "InitiatorPortIDs" :IN
      (:DESCRIPTION
...
The disposition of the SPC when the last logical unit, initiator ID, or target port ID is removed depends upon the CIM_ProtocolControllerMaskingCapabilites SPCAllowsNo* properties. If SPCAllowsNoLUs is false, then the SPC is automatically deleted when the last logical unit is removed. If SPCAllowsNoTargets is false, then the SPC is automatically deleted when the last target port ID is removed. If SPCAllowsNoInitiators is false, then the SPC is automatically deleted when the last initiator port ID is removed. In all other cases, the SPC MUST be explicitly deleted via the DeleteInstance intrinsic function.")
      ...
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        ...
        "Method Parameters Checked - Job Started" "Invalid logical unit ID"
        "Invalid initiator port ID" "Invalid target port ID"
        "Target/initiator combination not exposed" "Method Reserved"
        "Vendor Specific")))))
