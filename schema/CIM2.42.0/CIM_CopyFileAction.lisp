...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_CopyFileAction.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_COPYFILEACTION (CIM_FILEACTION)
              ((SOURCE STRING :CIM-NAME "Source" :QUALIFIERS
                ((:DESCRIPTION "The source directory.") (:MAX-LEN "1024"))
                :INITFORM NIL)
               (DESTINATION STRING :CIM-NAME "Destination" :QUALIFIERS
                ((:DESCRIPTION "The destination directory.") (:MAX-LEN "1024"))
                :INITFORM NIL)
               (DELETEAFTERCOPY BOOLEAN :CIM-NAME "DeleteAfterCopy" :QUALIFIERS
                ((:DESCRIPTION
