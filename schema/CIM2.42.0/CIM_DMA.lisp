...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DMA.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DMA (CIM_SYSTEMRESOURCE)
              ((CSCREATIONCLASSNAME STRING :CIM-NAME "CSCreationClassName"
               ...
               (TYPECTIMING UINT16 :CIM-NAME "TypeCTiming" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Other" "Unknown" "ISA Compatible" "Not Supported"
                   "Supported"))
                 (:MAPPING-STRINGS
                  ("MIF.DMTF|System Resource DMA Info|001.10")))
                :INITFORM NIL)
               (SHAREABLE BOOLEAN :CIM-NAME "Shareable" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating whether the Resource can be shared."))
                :INITFORM NIL)
               (IMPLEMENTATIONINFO UINT16 :CIM-NAME "ImplementationInfo"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates whether the Resource is implemented in hardware, software or both.")
                 (:VALUE-MAP ("0" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "Hardware Only" "Software Only"
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (TRANSFERWIDTHS (ARRAY UINT16) :CIM-NAME "TransferWidths"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Bits") (:VALUE-MAP ("0" "8" "16" "32" "64" "128"))
                 (:MAPPING-STRINGS ("MIF.DMTF|System Resource DMA Info|001.2"))
                 (:P-UNIT "bit"))
                :INITFORM NIL)
