...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DatabaseResourceStatistics.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DATABASERESOURCESTATISTICS (CIM_STATISTICALDATA)
              ((CURRENT UINT64 :CIM-NAME "Current" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (LIMIT UINT64 :CIM-NAME "Limit" :QUALIFIERS
                ...
                :INITFORM NIL)
               (HIGHWATER UINT64 :CIM-NAME "Highwater" :QUALIFIERS
                ((:DESCRIPTION
...
Other external factors, such as an explicit reset of the statistics might cause this measurement to begin at a later point in time.")
                ...
                :INITFORM NIL)
               (FAILURES UINT32 :CIM-NAME "Failures" :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_DatabaseResourceStatistics")
...
(DEFCIM-METHOD RESETSELECTEDSTATS
    ((INSTANCE CIM_DATABASERESOURCESTATISTICS)
