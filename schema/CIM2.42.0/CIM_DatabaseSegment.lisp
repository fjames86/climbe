...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DatabaseSegment.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DATABASESEGMENT (CIM_STORAGEEXTENT)
              ((PURPOSE STRING :CIM-NAME "Purpose" :QUALIFIERS
                ((:OVERRIDE "Purpose")
                 ...
                 (:VALUES
                  ("Other" "Data" "Data Partition" "Data Cluster" "Index"
                   "Index Partition" "LOB" "LOB Index" "Undo" "Snapshot"
                   "Temp"))
                 (:MODEL-CORRESPONDENCE ("CIM_DatabaseSegment.OtherPurpose"))
                 (:MAPPING-STRINGS
                  ("MIB.IETF|HOST-RESOURCES-MIB.hrStorageDescr")))
                :INITFORM NIL)
               (OTHERPURPOSE STRING :CIM-NAME "OtherPurpose" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_DatabaseSegment.Purpose")))
                :INITFORM NIL)
