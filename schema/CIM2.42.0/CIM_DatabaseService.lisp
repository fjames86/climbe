...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DatabaseService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DATABASESERVICE (CIM_SERVICE)
              ((STARTUPTIME DATETIME :CIM-NAME "StartupTime" :QUALIFIERS
                ...
                :INITFORM NIL)
               (LASTSTATUSCHANGETIME DATETIME :CIM-NAME "LastStatusChangeTime"
                :QUALIFIERS
                ((:DEPRECATED
...
Deprecated description: The date and time when the status of the database service last changed.")
               ...
               (TIMEOFLASTSTATECHANGE DATETIME :CIM-NAME
                ...
                :INITFORM NIL)
               (CONNECTIONLIMIT UINT32 :CIM-NAME "ConnectionLimit" :QUALIFIERS
                ((:DESCRIPTION
