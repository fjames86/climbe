...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DesktopMonitor.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DESKTOPMONITOR (CIM_DISPLAY)
              ((DISPLAYTYPE UINT16 :CIM-NAME "DisplayType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Multiscan Color" "Multiscan Monochrome"
                   "Fixed Frequency Color" "Fixed Frequency Monochrome")))
                :INITFORM NIL)
               (BANDWIDTH UINT32 :CIM-NAME "Bandwidth" :QUALIFIERS
                ((:DESCRIPTION
                  "Monitor's bandwidth in MHertz. If unknown, enter 0.")
                 (NIL "MegaHertz") (:P-UNIT "hertz * 10^6"))
                :INITFORM NIL)
               (SCREENHEIGHT UINT32 :CIM-NAME "ScreenHeight" :QUALIFIERS
                ((:DESCRIPTION
                  "The logical height of the Display in screen coordinates."))
                :INITFORM NIL)
               (SCREENWIDTH UINT32 :CIM-NAME "ScreenWidth" :QUALIFIERS
                ((:DESCRIPTION
