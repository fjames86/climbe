...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DiskSpaceCheck.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DISKSPACECHECK (CIM_CHECK)
              ((AVAILABLEDISKSPACE UINT64 :CIM-NAME "AvailableDiskSpace"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "KiloBytes")
                 (:MODEL-CORRESPONDENCE ("CIM_FileSystem.AvailableSpace"))
                 (:P-UNIT "byte * 10^3"))
                :INITFORM NIL)
