...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_DocumentAuthentication.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_DOCUMENTAUTHENTICATION (CIM_AUTHENTICATIONCONDITION)
              ((TYPEOFDOCUMENT UINT16 :CIM-NAME "TypeOfDocument" :QUALIFIERS
                ((:DESCRIPTION
                  "Integer enumeration identifying the document that should be authenticated.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7"))
                 (:VALUES
                  ("Other" "Passport" "Birth Certificate" "Credit Card"
                   "Drivers License" "Membership Card" "Social Security Card"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_DocumentAuthentication.OtherDocument")))
                :INITFORM NIL)
               (OTHERDOCUMENT STRING :CIM-NAME "OtherDocument" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DOCUMENTIDENTIFIER STRING :CIM-NAME "DocumentIdentifier"
                :QUALIFIERS
                ((:DESCRIPTION
...
This MOF defines the following keywords: 'UNKNOWN', 'CONFIGURATION', 'USAGE', 'SECURITY', 'SERVICE', 'MOTIVATIONAL', 'INSTALLATION', and 'EVENT'. These concepts are self-explanatory and are further discussed in the SLA/Policy White Paper. One additional keyword is defined: 'POLICY'. The role of this keyword is to identify policy-related instances that may not be otherwise identifiable, in some implementations. The keyword 'POLICY' is NOT mutually exclusive of the other keywords specified above."))
                :INITFORM NIL))
              (:CIM-NAME "CIM_DocumentAuthentication")
