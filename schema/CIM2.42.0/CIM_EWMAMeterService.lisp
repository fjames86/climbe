...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_EWMAMeterService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_EWMAMETERSERVICE (CIM_METERSERVICE)
              ((AVERAGERATE UINT32 :CIM-NAME "AverageRate" :QUALIFIERS
                ...
                :INITFORM NIL)
               (DELTAINTERVAL UINT64 :CIM-NAME "DeltaInterval" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "MicroSeconds"))
                :INITFORM NIL)
               (GAIN UINT32 :CIM-NAME "Gain" :QUALIFIERS
                ((:DESCRIPTION
