...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_EnabledLogicalElementCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ENABLEDLOGICALELEMENTCAPABILITIES (CIM_CAPABILITIES)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_EnabledLogicalElementCapabilities")
