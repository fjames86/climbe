...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_FCPort.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_FCPORT (CIM_NETWORKPORT)
              ((PORTTYPE UINT16 :CIM-NAME "PortType" :QUALIFIERS
                ((:OVERRIDE "PortType")
                 (:DESCRIPTION
                  "The specific mode currently enabled for the Port. If the port is logged in, this will be the negotiated port type, otherwise the configured port type will be reported. 
...
PortTypes are defined in the ANSI X3 standards. When set to 1 (\"Other\"), the related property OtherPortType contains a string description of the type of port.")
                 (:VALUE-MAP
                  ("0" "1" "10" "11" "12" "13" "14" "15" "16" "17" "18"
                   "16000..65535"))
                 (:VALUES
                  ("Unknown" "Other" "N" "NL" "F/NL" "Nx" "E" "F" "FL" "B" "G"
                   "Vendor Reserved"))
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (SUPPORTEDCOS (ARRAY UINT16) :CIM-NAME "SupportedCOS"
                ...
                :INITFORM NIL)
               (ACTIVECOS (ARRAY UINT16) :CIM-NAME "ActiveCOS" :QUALIFIERS
                ((:DESCRIPTION
                  "An array of integers that indicates the Classes of Service that are active. The Active COS is indicated in ActiveCOS.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6" "7"))
                 (:VALUES ("Unknown" "1" "2" "3" "4" "5" "6" "F"))
                 (:MODEL-CORRESPONDENCE ("CIM_FCPort.SupportedCOS")))
                :INITFORM NIL)
               (SUPPORTEDFC4TYPES (ARRAY UINT16) :CIM-NAME "SupportedFC4Types"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "ISO/IEC 8802 - 2 LLC" "IP over FC"
                   ...
                   "Vendor Unique")))
                :INITFORM NIL)
               (ACTIVEFC4TYPES (ARRAY UINT16) :CIM-NAME "ActiveFC4Types"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "ISO/IEC 8802 - 2 LLC" "IP over FC"
                   ...
                   "BBL 802.3 Encapsulated LAN PDU" "FC - VI" "FC - AV"
                   "Vendor Unique"))
                 (:MODEL-CORRESPONDENCE ("CIM_FCPort.SupportedFC4Types")))
                :INITFORM NIL)
