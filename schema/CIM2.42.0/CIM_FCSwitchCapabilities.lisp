...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_FCSwitchCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_FCSWITCHCAPABILITIES (CIM_ENABLEDLOGICALELEMENTCAPABILITIES)
              ((DOMAINIDCONFIGUREABLE BOOLEAN :CIM-NAME "DomainIDConfigureable"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MINDOMAINID UINT8 :CIM-NAME "MinDomainID" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_FCSwitchSettings.PreferredDomainID")))
                :INITFORM NIL)
               (MAXDOMAINID UINT8 :CIM-NAME "MaxDomainID" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_FCSwitchSettings.PreferredDomainID")))
                :INITFORM NIL)
               (DOMAINIDLOCKEDSUPPORTED BOOLEAN :CIM-NAME
                "DomainIDLockedSupported" :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL)
               (PRINCIPALPRIORITIESSUPPORTED (ARRAY UINT16) :CIM-NAME
                "PrincipalPrioritiesSupported" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_FCSwitchSettings.PrincipalPriority")))
                :INITFORM NIL)
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_FCSwitchCapabilities")
