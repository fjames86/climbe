...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Fan.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_FAN (CIM_COOLINGDEVICE)
              ((VARIABLESPEED BOOLEAN :CIM-NAME "VariableSpeed" :QUALIFIERS
                ((:DESCRIPTION
                  "Indication of whether the fan supports variable speeds."))
                :INITFORM NIL)
               (DESIREDSPEED UINT64 :CIM-NAME "DesiredSpeed" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Revolutions per Minute"))
                :INITFORM NIL)
               (ACTIVECOOLING BOOLEAN :CIM-NAME "ActiveCooling" :QUALIFIERS
                ((:DESCRIPTION
...
(DEFCIM-METHOD SETSPEED
    ((INSTANCE CIM_FAN)
     (DESIREDSPEED UINT64 "DesiredSpeed" :IN
