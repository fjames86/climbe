...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_FilterEntry.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_FILTERENTRY (CIM_FILTERENTRYBASE)
              ((TRAFFICTYPE UINT16 :CIM-NAME "TrafficType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_FilterEntry.OtherTrafficType")))
                :INITFORM NIL)
               (OTHERTRAFFICTYPE STRING :CIM-NAME "OtherTrafficType"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_FilterEntry.TrafficType")))
                :INITFORM NIL)
               (MATCHCONDITIONTYPE UINT16 :CIM-NAME "MatchConditionType"
                ...
                :INITFORM NIL)
               (OTHERMATCHCONDITIONTYPE STRING :CIM-NAME
                "OtherMatchConditionType" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MATCHCONDITIONVALUE STRING :CIM-NAME "MatchConditionValue"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (ACTION UINT16 :CIM-NAME "Action" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2")) (:VALUES ("Permit" "Deny")))
                :INITFORM NIL)
               (DEFAULTFILTER BOOLEAN :CIM-NAME "DefaultFilter" :QUALIFIERS
                ((:DESCRIPTION
                  "This defines whether this FilterEntry is the default entry to use by its FilterList."))
                :INITFORM NIL)
               (TRAFFICCLASS STRING :CIM-NAME "TrafficClass" :QUALIFIERS
                ((:DESCRIPTION
