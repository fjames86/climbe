...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_FlatPanel.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_FLATPANEL (CIM_DISPLAY)
              ((HORIZONTALRESOLUTION UINT32 :CIM-NAME "HorizontalResolution"
                :QUALIFIERS
                ((:DESCRIPTION "FlatPanel's horizontal resolution in Pixels.")
                 (NIL "Pixels") (:P-UNIT "pixel"))
                :INITFORM NIL)
               ...
               (DISPLAYTYPE UINT16 :CIM-NAME "DisplayType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Passive Matrix LCD" "Active Matrix LCD"
                   "Cholesteric LCD" "Field Emission Display"
                   "Electro Luminescent Display" "Gas Plasma" "LED")))
                :INITFORM NIL)
               (LIGHTSOURCE UINT16 :CIM-NAME "LightSource" :QUALIFIERS
                ((:DESCRIPTION
                  "A description of the display illumination type. For example, backlit (value=2) or reflective (4) can be specified.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "Other" "Backlit" "Edgelit" "Reflective")))
                :INITFORM NIL)
               (SUPPORTSCOLOR BOOLEAN :CIM-NAME "SupportsColor" :QUALIFIERS
                ((:DESCRIPTION
