...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_HardwareThread.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_HARDWARETHREAD (CIM_ENABLEDLOGICALELEMENT)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (LOADPERCENTAGE UINT16 :CIM-NAME "LoadPercentage" :QUALIFIERS
                ((:DESCRIPTION
                  "Loading of this processor hardware thread, averaged over the last minute, in Percent.")
