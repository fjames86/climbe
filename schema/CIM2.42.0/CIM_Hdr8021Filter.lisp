...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Hdr8021Filter.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_HDR8021FILTER (CIM_FILTERENTRYBASE)
              ((HDRPROTOCOLID8021 UINT16 :CIM-NAME "HdrProtocolID8021"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (HDRPRIORITYVALUE8021 UINT8 :CIM-NAME "HdrPriorityValue8021"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (HDRVLANID8021 UINT32 :CIM-NAME "HdrVLANID8021" :QUALIFIERS
                ((:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (HDRSRCMACADDR8021 (ARRAY UINT8) :CIM-NAME "HdrSrcMACAddr8021"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 :OCTET-STRING)
                :INITFORM NIL)
               (HDRSRCMACMASK8021 (ARRAY UINT8) :CIM-NAME "HdrSrcMACMask8021"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 :OCTET-STRING)
                :INITFORM NIL)
               (HDRDESTMACADDR8021 (ARRAY UINT8) :CIM-NAME "HdrDestMACAddr8021"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 :OCTET-STRING)
                :INITFORM NIL)
               (HDRDESTMACMASK8021 (ARRAY UINT8) :CIM-NAME "HdrDestMACMask8021"
                :QUALIFIERS
                ((:DESCRIPTION
