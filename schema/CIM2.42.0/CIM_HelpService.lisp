...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_HelpService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_HELPSERVICE (CIM_SERVICE)
              ((OTHERDELIVERYOPTIONDESCRIPTION STRING :CIM-NAME
                "OtherDeliveryOptionDescription" :QUALIFIERS
                ((:DESCRIPTION
                  "Describes the nature of the delivery method when DeliveryOptions = \"Other\" is specified.")
                 (:MODEL-CORRESPONDENCE ("CIM_HelpService.DeliveryOptions")))
                :INITFORM NIL)
               (OTHERDOCUMENTFORMATDESCRIPTION STRING :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_HelpService.DocumentFormat")))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (DELIVERYOPTIONS (ARRAY UINT16) :CIM-NAME "DeliveryOptions"
                :QUALIFIERS
                ((:DESCRIPTION
...
\"Program\" indicates that a Help program is launched (on the local system) by the GetHelp method.")
                 ...
                 (:VALUES
                  ("Other" "File Contents" "File Pointer" "Associated File"
                   "URL" "Program"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_HelpService.OtherDeliveryOptionDescription"
                   "CIM_HelpServiceAvailableToFile")))
                :INITFORM NIL)
               (DOCUMENTSAVAILABLE (ARRAY STRING) :CIM-NAME
                "DocumentsAvailable" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DOCUMENTDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                "DocumentDescriptions" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_HelpService.DocumentsAvailable"
                   "CIM_HelpService.DocumentFormat")))
                :INITFORM NIL)
               (DOCUMENTFORMAT (ARRAY UINT16) :CIM-NAME "DocumentFormat"
                :QUALIFIERS
                ((:DESCRIPTION
...
(DEFCIM-METHOD GETHELP
    ((INSTANCE CIM_HELPSERVICE)
     (REQUESTEDDOCUMENT STRING "RequestedDocument" :IN
      (:DESCRIPTION
       "The name/id of the requested document or the reference to the associated document.")
      (:MODEL-CORRESPONDENCE
       ("CIM_HelpService.DocumentsAvailable"
        "CIM_HelpServiceAvailableToFile.UserOfService")))
     (FORMAT UINT16 "Format" :IN :OUT
             (:DESCRIPTION
              "The requested document format is passed in. The actual document format is returned.")
             (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6"))
             (:VALUES
              ("Don't Care" "Other" "XML" "HTML" "Binary" "Executable" ".hlp"))
             (:MODEL-CORRESPONDENCE ("CIM_HelpService.DocumentFormat")))
     (REQUESTEDDELIVERY UINT16 "RequestedDelivery" :IN
      (:DESCRIPTION "The requested delivery mechanism.")
      (:VALUE-MAP ("1" "2" "3" "5" "6"))
      (:VALUES ("Other" "File Contents" "File Pointer" "URL" "Program"))
      (:MODEL-CORRESPONDENCE ("CIM_HelpService.DeliveryOptions")))
     (DOCUMENTINFO STRING "DocumentInfo" :IN :OUT
      (:DESCRIPTION "If RequestedDelivery = 
...
Program, then the string is empty; the program was launched.")))
    ((:CIM-NAME "GetHelp")
     (:QUALIFIERS
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" ".." "0x1000" "0x1001" "0x1002..0x7FFF"
        "0x8000..0xFFFF"))
      (:VALUES
       ("Document returned with no error" "Not Supported" "Unspecified Error"
        "Timeout" "Failed" "Invalid Parameter" "DMTF Reserved" "Busy"
        "Requested Document not found" "Method Reserved" "Vendor Reserved")))))
