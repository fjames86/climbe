...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IKESAEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IKESAENDPOINT (CIM_SECURITYASSOCIATIONENDPOINT)
              ((INITIATORCOOKIE UINT64 :CIM-NAME "InitiatorCookie" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (RESPONDERCOOKIE UINT64 :CIM-NAME "ResponderCookie" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (CIPHERALGORITHM UINT16 :CIM-NAME "CipherAlgorithm" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP
                  ("0" "1" "2" "3" "4" "5" "6" "7" "8..65000" "65001..65535"))
                 (:VALUES
                  ("Unknown" "Other" "DES" "IDEA" "Blowfish" "RC5" "3DES"
                   "CAST" "DMTF/IANA Reserved" "Vendor Reserved"))
                 (:MAPPING-STRINGS ("RFC2409.IETF|Appendix A"))
               ...
               (OTHERCIPHERALGORITHM STRING :CIM-NAME "OtherCipherAlgorithm"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_IKESAEndpoint.CipherAlgorithm")))
                :INITFORM NIL)
               (HASHALGORITHM UINT16 :CIM-NAME "HashAlgorithm" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5..65000" "65001..65535"))
                 (:VALUES
                  ("Unknown" "Other" "MD5" "SHA-1" "Tiger" "DMTF/IANA Reserved"
                   "Vendor Reserved"))
                 (:MAPPING-STRINGS ("RFC2409.IETF|Appendix A"))
                 (:MODEL-CORRESPONDENCE
               ...
               (OTHERHASHALGORITHM STRING :CIM-NAME "OtherHashAlgorithm"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_IKESAEndpoint.HashAlgorithm")))
                :INITFORM NIL)
               (AUTHENTICATIONMETHOD UINT16 :CIM-NAME "AuthenticationMethod"
                ...
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP
                  ("0" "1" "2" "3" "4" "5" "6" "7..65000" "65001..65535"))
                 (:VALUES
                  ("Unknown" "Other" "Pre-shared Key" "DSS Signatures"
               ...
               (GROUPID UINT16 :CIM-NAME "GroupId" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("RFC2412.IETF|Appendix E"))
                 (:MODEL-CORRESPONDENCE ("CIM_IKESAEndpoint.VendorID")))
                :INITFORM NIL)
               (VENDORID STRING :CIM-NAME "VendorID" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_IKESAEndpoint.GroupId")))
                :INITFORM NIL)
               ...
               (REFRESHTHRESHOLDKBYTESPERCENTAGE UINT8 :CIM-NAME
                ...
                (:WRITE
                 ...
                 (NIL "Percent") (:MIN-VALUE "0") (:MAX-VALUE "100"))
                :INITFORM NIL)
               (PACKETLOGGINGACTIVE BOOLEAN :CIM-NAME "PacketLoggingActive"
                :QUALIFIERS
                (:WRITE
                 (:DESCRIPTION
