...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IPAssignmentSettingData.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IPASSIGNMENTSETTINGDATA (CIM_SETTINGDATA)
...
For DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_IPAssignmentSettingData")
