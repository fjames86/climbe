...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IPConfigurationService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IPCONFIGURATIONSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_IPConfigurationService")
...
(DEFCIM-METHOD APPLYSETTINGTOIPPROTOCOLENDPOINT
    ((INSTANCE CIM_IPCONFIGURATIONSERVICE)
     (CONFIGURATION "CIM_IPAssignmentSettingData" "Configuration" :REQUIRED :IN
      (:DESCRIPTION "The IPAssignmentSettingData to apply."))
     (ENDPOINT "CIM_IPProtocolEndpoint" "Endpoint" :REQUIRED :IN
      (:DESCRIPTION
    ...
    ((:CIM-NAME "ApplySettingToIPProtocolEndpoint")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "4096" ".." "32768..65535"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
        "Failed" "Invalid Parameter" "Busy"
        "Method Parameters Checked - Job Started" "DMTF Reserved"
        "Vendor Reserved")))))
(DEFCIM-METHOD APPLYSETTINGTOCOMPUTERSYSTEM
    ((INSTANCE CIM_IPCONFIGURATIONSERVICE)
     (MODE UINT16 "Mode" :REQUIRED :IN
      (:DESCRIPTION
...
Mode 6 - Results in IsNext = 3 (Is Next For Single Use)for the CIM_ElementSettingData associating the setting with ComputerSystem. The value of IsCurrent will not be affected. To change the IsNext=3 (Is Next For Single Use) for a Setting, invoke the method with any of the other values for the mode.")
     ...
     (IPVERSIONSETTINGDATA "CIM_IPVersionSettingData" "IPVersionSettingData"
      :REQUIRED :IN (:DESCRIPTION "The IPVersionSettingData to be apply."))
     (COMPUTERSYSTEM "CIM_ComputerSystem" "ComputerSystem" :REQUIRED :IN
      (:DESCRIPTION "The ComputerSystem to which the setting will be applied"))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "Reference to the job spawned if the operation continues after the method returns. (may be null if task completed).")))
    ((:CIM-NAME "ApplySettingToComputerSystem")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Job Started"
        "DMTF Reserved" "Vendor Reserved")))))
(DEFCIM-METHOD APPLYSETTINGTOIPNETWORKCONNECTION
    ((INSTANCE CIM_IPCONFIGURATIONSERVICE)
     (MODE UINT16 "Mode" :REQUIRED :IN
      (:DESCRIPTION
...
Mode 6 - Results in IsNext = 3 (Is Next For Single Use)for the CIM_ElementSettingData associating the setting with IPNetworkConnection. The value of IsCurrent will not be affected. To change the IsNext=3 (Is Next For Single Use) for a Setting, invoke the method with any of the other values for the mode.")
      ...
      (:VALUES
       ("Mode 0" "Mode 1" "Mode 2" "Mode 3" "Mode 4" "Mode 5" "Mode 6"
        "DMTF Reserved" "Vendor Reserved")))
     (SETTINGDATA "CIM_IPAssignmentSettingData" "SettingData" :IN
      (:DESCRIPTION "The IPAssignmentSettingData to apply."))
     (IPVERSIONSETTINGDATA "CIM_IPVersionSettingData" "IPVersionSettingData"
      :IN (:DESCRIPTION "The IPVersionSettingData to be apply."))
     (IPNETWORKCONNECTION "CIM_IPNetworkConnection" "IPNetworkConnection"
      :REQUIRED :IN
      (:DESCRIPTION
     ...
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "Reference to the job spawned if the operation continues after the method returns. (may be null if task completed).")))
    ((:CIM-NAME "ApplySettingToIPNetworkConnection")
     (:QUALIFIERS
      (:DESCRIPTION
