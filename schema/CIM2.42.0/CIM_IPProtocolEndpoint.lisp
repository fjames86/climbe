...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IPProtocolEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IPPROTOCOLENDPOINT (CIM_PROTOCOLENDPOINT)
              ((IPV4ADDRESS STRING :CIM-NAME "IPv4Address" :QUALIFIERS
               ...
               (ADDRESSTYPE UINT16 :CIM-NAME "AddressType" :QUALIFIERS
                ...
                :INITFORM NIL)
               (IPVERSIONSUPPORT UINT16 :CIM-NAME "IPVersionSupport"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_ProtocolEndpoint.ProtocolIFType"))
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3"))
                 (:VALUES
                  ("Unknown" "IPv4 Only" "IPv6 Only" "Both IPv4 and IPv6")))
                :INITFORM NIL)
               (PROTOCOLIFTYPE UINT16 :CIM-NAME "ProtocolIFType" :QUALIFIERS
                ((:OVERRIDE "ProtocolIFType")
                 ...
                 (:VALUE-MAP
                  ("1" "225..4095" "4096" "4097" "4098" "4301..32767"
                   "32768.."))
                 (:VALUES
                  ("Other" "IANA Reserved" "IPv4" "IPv6" "IPv4/v6"
...
A value of 10 \"Link Local\" shall indicate Link Local values were assigned.")
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Not Applicable" "Static" "DHCP" "BOOTP"
                   ...
                   "Link Local" "DMTF Reserved" "Vendor Reserved")))
                :INITFORM "0")
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_IPProtocolEndpoint")
...
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_IPPROTOCOLENDPOINT)
