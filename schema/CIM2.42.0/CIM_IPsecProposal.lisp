...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IPsecProposal.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IPSECPROPOSAL (CIM_SAPROPOSAL)
...
For DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
              ...
              (:QUALIFIERS (:VERSION "2.8.0")
               ...
               (:MAPPING-STRINGS ("IPSP Policy Model.IETF|IPsecProposal"))))