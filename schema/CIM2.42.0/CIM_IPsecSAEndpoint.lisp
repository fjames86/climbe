...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IPsecSAEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IPSECSAENDPOINT (CIM_SECURITYASSOCIATIONENDPOINT)
              ((SPI UINT32 :CIM-NAME "SPI" :QUALIFIERS
               ...
               (INBOUNDDIRECTION BOOLEAN :CIM-NAME "InboundDirection"
                ...
                :INITFORM NIL)
               (ENCAPSULATIONMODE UINT16 :CIM-NAME "EncapsulationMode"
                :QUALIFIERS
                ((:DESCRIPTION
