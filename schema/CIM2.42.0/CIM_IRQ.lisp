...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_IRQ.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_IRQ (CIM_SYSTEMRESOURCE)
              ((CSCREATIONCLASSNAME STRING :CIM-NAME "CSCreationClassName"
               ...
               (CREATIONCLASSNAME STRING :CIM-NAME "CreationClassName"
                ...
                (:KEY
                 ...
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (IRQNUMBER UINT32 :CIM-NAME "IRQNumber" :QUALIFIERS
                (:KEY
                 (:DESCRIPTION "A part of the object's key value, IRQ Number.")
                 (:MAPPING-STRINGS ("MIF.DMTF|IRQ|002.1")))
                :INITFORM NIL)
               (AVAILABILITY UINT16 :CIM-NAME "Availability" :QUALIFIERS
                ((:DESCRIPTION "Availability of the IRQ.")
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|IRQ|002.2")))
                :INITFORM NIL)
               (TRIGGERTYPE UINT16 :CIM-NAME "TriggerType" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (TRIGGERLEVEL UINT16 :CIM-NAME "TriggerLevel" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (SHAREABLE BOOLEAN :CIM-NAME "Shareable" :QUALIFIERS
                ((:OVERRIDE "Shareable")
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|IRQ|002.4")))
                :INITFORM NIL)
               (HARDWARE BOOLEAN :CIM-NAME "Hardware" :QUALIFIERS
                ((:DESCRIPTION
