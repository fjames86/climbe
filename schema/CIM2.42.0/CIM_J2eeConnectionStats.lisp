...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeConnectionStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EECONNECTIONSTATS (CIM_J2EESTATISTIC)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeConnectionStats")
...
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EECONNECTIONSTATS))
