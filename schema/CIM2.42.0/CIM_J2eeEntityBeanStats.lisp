...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeEntityBeanStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEENTITYBEANSTATS (CIM_J2EEEJBSTATS)
              ((READYCOUNT UINT64 :CIM-NAME "ReadyCount" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (READYLOWWATERMARK UINT64 :CIM-NAME "ReadyLowWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (READYHIGHWATERMARK UINT64 :CIM-NAME "ReadyHighWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (POOLEDCOUNT UINT64 :CIM-NAME "PooledCount" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (POOLEDLOWWATERMARK UINT64 :CIM-NAME "PooledLowWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.7.1.2 getLowWaterMark|V1.0")))
                :INITFORM NIL)
               (POOLEDHIGHWATERMARK UINT64 :CIM-NAME "PooledHighWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeEntityBeanStats")
...
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEENTITYBEANSTATS))
