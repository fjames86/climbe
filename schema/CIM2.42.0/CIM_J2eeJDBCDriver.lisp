...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJDBCDriver.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJDBCDRIVER (CIM_ENABLEDLOGICALELEMENT)
              ((INSTANCEID STRING :CIM-NAME "InstanceID" :QUALIFIERS
                (:KEY (:OVERRIDE "InstanceID")
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_J2eeJDBCDriver.Name")))
                :INITFORM NIL)
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:OVERRIDE "Name")
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_J2eeJDBCDriver.InstanceID")))
                :INITFORM NIL)
