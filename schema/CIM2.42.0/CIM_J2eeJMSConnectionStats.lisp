...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJMSConnectionStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJMSCONNECTIONSTATS (CIM_J2EESTATISTIC)
              ((ISTRANSACTIONAL BOOLEAN :CIM-NAME "IsTransactional" :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJMSConnectionStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The CIM_J2eeJMSConnectionStats class defines the performance statistics that are provided by a JMS connection.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEJMSCONNECTIONSTATS))
