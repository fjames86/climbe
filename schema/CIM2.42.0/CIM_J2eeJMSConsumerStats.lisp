...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJMSConsumerStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJMSCONSUMERSTATS (CIM_J2EEJMSENDPOINTSTATS)
              ((ORIGIN STRING :CIM-NAME "Origin" :QUALIFIERS
                ((:DESCRIPTION
                  "A string that encapsulates the identity of the message origin.")
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.29.1.1 getOrigin|V1.0")))
                :INITFORM NIL)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJMSConsumerStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The CIM_J2eeJMSConsumerStats class defines the performance statistics that are provided by a JMS message consumer.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEJMSCONSUMERSTATS))
