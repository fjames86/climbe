...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJMSProducerStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJMSPRODUCERSTATS (CIM_J2EEJMSENDPOINTSTATS)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJMSProducerStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The CIM_J2eeJMSProducerStats class defines the performance statistics that are provided by a JMS message producer.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEJMSPRODUCERSTATS))
