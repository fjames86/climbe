...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJMSSessionStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJMSSESSIONSTATS (CIM_J2EESTATISTIC)
              ((DURABLESUBSCRIPTIONCOUNT UINT64 :CIM-NAME
                "DurableSubscriptionCount" :QUALIFIERS
                ((:DESCRIPTION "The number of durable subscriptions.") :COUNTER
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.26.1.3 getDurableSubscriptionCount|V1.0")))
                :INITFORM NIL)
               (EXPIREDMESSAGECOUNT UINT64 :CIM-NAME "ExpiredMessageCount"
                :QUALIFIERS
                ((:DESCRIPTION "The number of expired messages.") :COUNTER
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.26.1.4 getExpiredMessageCount|V1.0")))
                :INITFORM NIL)
               (MESSAGECOUNT UINT64 :CIM-NAME "MessageCount" :QUALIFIERS
                ((:DESCRIPTION "The number of messages exchanged.") :COUNTER
                 (:MAPPING-STRINGS
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJMSSessionStats")
...
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEJMSSESSIONSTATS))
