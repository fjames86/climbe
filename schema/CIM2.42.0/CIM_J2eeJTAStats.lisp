...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJTAStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJTASTATS (CIM_J2EESTATISTIC)
              ((ACTIVECOUNT UINT64 :CIM-NAME "ActiveCount" :QUALIFIERS
                ((:DESCRIPTION "The number of active transactions.") :COUNTER
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.30.1.1 getActiveCount|V1.0")))
                :INITFORM NIL)
               (COMMITTEDCOUNT UINT64 :CIM-NAME "CommittedCount" :QUALIFIERS
                ((:DESCRIPTION "The number of committed transactions.")
                 :COUNTER
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.30.1.2 getCommittedCount|V1.0")))
                :INITFORM NIL)
               (ROLLEDBACKCOUNT UINT64 :CIM-NAME "RolledbackCount" :QUALIFIERS
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJTAStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The CIM_J2eeJTAStats class defines the performance statistics that are provided by a JTA resource.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEJTASTATS))
