...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJVM.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJVM (CIM_ENABLEDLOGICALELEMENT)
              ((INSTANCEID STRING :CIM-NAME "InstanceID" :QUALIFIERS
                (:KEY (:OVERRIDE "InstanceID")
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_J2eeJVM.Name")))
                :INITFORM NIL)
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:OVERRIDE "Name")
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_J2eeJVM.InstanceID")))
                :INITFORM NIL)
               (JAVAVERSION STRING :CIM-NAME "JavaVersion" :QUALIFIERS
                ((:DESCRIPTION
                  "The Java Runtime Environment version of the JVM.")
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.3.4.1.1 javaVersion|V1.0")))
                :INITFORM NIL)
               (JAVAVENDOR STRING :CIM-NAME "JavaVendor" :QUALIFIERS
                ((:DESCRIPTION
                  "The Java Runtime Environment vendor of the JVM.")
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.3.4.1.2 javaVendor|V1.0")))
                :INITFORM NIL)
               (NODE STRING :CIM-NAME "Node" :QUALIFIERS
                ((:DESCRIPTION "The node (machine) this JVM is running on.")
                 (:MAPPING-STRINGS ("JSR77.JCP|JSR77.3.4.1.3 node|V1.0")))
                :INITFORM NIL)
