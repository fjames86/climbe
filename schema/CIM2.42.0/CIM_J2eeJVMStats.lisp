...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJVMStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJVMSTATS (CIM_J2EESTATISTIC)
              ((HEAPSIZE UINT64 :CIM-NAME "HeapSize" :QUALIFIERS
                ((:DESCRIPTION "The heap size of the JVM.") (NIL "Bytes")
                 :GAUGE
                 (:MAPPING-STRINGS
                  ("JSR77.JCP|JSR77.6.31.1.1 getHeapSize|V1.0"))
                 (:P-UNIT "byte"))
                :INITFORM NIL)
               (HEAPSIZEUPPERBOUND UINT64 :CIM-NAME "HeapSizeUpperBound"
                :QUALIFIERS
                ((:DESCRIPTION "The upper limit for the heap size of the JVM.")
                 ...
                 (:P-UNIT "byte"))
                :INITFORM NIL)
               (HEAPSIZELOWERBOUND UINT64 :CIM-NAME "HeapSizeLowerBound"
                :QUALIFIERS
                ((:DESCRIPTION "The lower limit for the heap size of the JVM.")
                 ...
                 (:P-UNIT "byte"))
                :INITFORM NIL)
               (HEAPSIZELOWWATERMARK UINT64 :CIM-NAME "HeapSizeLowWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:P-UNIT "byte"))
                :INITFORM NIL)
               (HEAPSIZEHIGHWATERMARK UINT64 :CIM-NAME "HeapSizeHighWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJVMStats")
              (:QUALIFIERS (:VERSION "2.8.2")
