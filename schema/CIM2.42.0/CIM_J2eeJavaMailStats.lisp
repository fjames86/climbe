...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeJavaMailStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEJAVAMAILSTATS (CIM_J2EESTATISTIC)
              ((SENTMAILCOUNT UINT64 :CIM-NAME "SentMailCount" :QUALIFIERS
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeJavaMailStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The J2eeJavaMailStats class defines the performance statistics that are provided by Java mail resources.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEJAVAMAILSTATS))
