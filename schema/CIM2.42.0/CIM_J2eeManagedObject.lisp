...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeManagedObject.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEMANAGEDOBJECT (CIM_ENABLEDLOGICALELEMENT)
              ((INSTANCEID STRING :CIM-NAME "InstanceID" :QUALIFIERS
                (:KEY (:OVERRIDE "InstanceID")
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_J2eeManagedObject.ElementName")))
                :INITFORM NIL)
               ...
               (STARTTIME DATETIME :CIM-NAME "StartTime" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("JSR77.JCP|JSR77.5.1.1.2 startTime|V1.0"))
...
\"Error\" indicates the ManagedElement is in an Error condition.")
               ...
               (OPERATIONALSTATUS (ARRAY UINT16) :CIM-NAME "OperationalStatus"
                ...
                ((:OVERRIDE "OperationalStatus")
                 ...
                 (:VALUE-MAP ("0" "2" "6" "8" "9" "10"))
                 (:VALUES
                  ("Unknown" "OK" "Error" "Starting" "Stopping" "Stopped"))
                 (:MAPPING-STRINGS ("JSR77.JCP|JSR77.5.1.1.1 state|V1.0"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_J2eeManagedObjectCapabilities.StateManageable"))
                 (:ARRAYTYPE "Indexed"))
                :INITFORM NIL)
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeManagedObject")
...
(DEFCIM-METHOD STARTRECURSIVE
    ((INSTANCE CIM_J2EEMANAGEDOBJECT))
    ((:CIM-NAME "StartRecursive")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:MAPPING-STRINGS ("JSR77.JCP|JSR77.5.1.2.2 startRecursive|V1.0")))))
(DEFCIM-METHOD START
    ((INSTANCE CIM_J2EEMANAGEDOBJECT))
    ((:CIM-NAME "Start")
     (:QUALIFIERS
      ...
      (:MAPPING-STRINGS ("JSR77.JCP|JSR77.5.1.2.1 start|V1.0")))))
(DEFCIM-METHOD STOP
    ((INSTANCE CIM_J2EEMANAGEDOBJECT))
    ((:CIM-NAME "Stop")
     (:QUALIFIERS
      ...
      (:MAPPING-STRINGS ("JSR77.JCP|JSR77.5.1.2.3 stop|V1.0")))))
