...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeMessageDrivenBeanStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEMESSAGEDRIVENBEANSTATS (CIM_J2EEEJBSTATS)
              ((MESSAGECOUNT UINT64 :CIM-NAME "MessageCount" :QUALIFIERS
                ((:DESCRIPTION "The number of messages received.") :COUNTER
                 (:MAPPING-STRINGS
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeMessageDrivenBeanStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The J2eeMessageDrivenBeanStats class defines the performance statistics that are provided by message driven beans.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEMESSAGEDRIVENBEANSTATS))
