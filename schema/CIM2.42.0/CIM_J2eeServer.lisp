...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeServer.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EESERVER (CIM_APPLICATIONSYSTEM)
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_ManagedSystemElement.OperationalStatus")))
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeServer")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServer")
               (:DESCRIPTION
                "The CIM_J2eeServer class represents the J2EE Server core of one instance of a J2EE platform product as described in the Java 2 Enterprise Edition Platform specification.")))
(DEFCIM-METHOD STARTAPPLICATION
    ((INSTANCE CIM_J2EESERVER))
