...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeServletStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EESERVLETSTATS (CIM_J2EESTATISTIC)
              ((SERVICETIME DATETIME :CIM-NAME "ServiceTime" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (SERVLETTIMEMAXTIME DATETIME :CIM-NAME "ServletTimeMaxTime"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (SERVICETIMEMINTIME DATETIME :CIM-NAME "ServiceTimeMinTime"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (SERVLETTIMETOTALTIME DATETIME :CIM-NAME "ServletTimeTotalTime"
                :QUALIFIERS
                ((:DESCRIPTION
