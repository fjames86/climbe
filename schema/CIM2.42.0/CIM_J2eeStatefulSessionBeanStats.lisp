...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeStatefulSessionBeanStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EESTATEFULSESSIONBEANSTATS (CIM_J2EESESSIONBEANSTATS)
              ((PASSIVECOUNT UINT64 :CIM-NAME "PassiveCount" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PASSIVELOWWATERMARK UINT64 :CIM-NAME "PassiveLowWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PASSIVEHIGHWATERMARK UINT64 :CIM-NAME "PassiveHighWaterMark"
                :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeStatefulSessionBeanStats")
              (:QUALIFIERS (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The J2eeStatefulSessionBeanStats class defines the performance statistics that are provided by a stateful session bean.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EESTATEFULSESSIONBEANSTATS))
