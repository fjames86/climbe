...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_J2eeURLStats.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_J2EEURLSTATS (CIM_J2EESTATISTIC)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_J2eeURLStats")
              (:QUALIFIERS :ABSTRACT (:VERSION "2.8.0")
               (:UML-PACKAGE-PATH "CIM::Application::J2eeAppServerStats")
               (:DESCRIPTION
                "The CIM_J2eeURLStats class defines the performance statistics that are provided by a URL resource. There are no standard required URL statistics defined by the JSR77 specification. This class may be extended to provide vendor specific URL performance statistics.")))
(DEFCIM-METHOD GETSTARTTIME
    ((INSTANCE CIM_J2EEURLSTATS))
