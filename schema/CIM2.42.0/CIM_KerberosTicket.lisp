...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_KerberosTicket.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_KERBEROSTICKET (CIM_KERBEROSCREDENTIAL)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
                "SystemCreationClassName" :QUALIFIERS
                ((:DEPRECATED ("CIM_KerberosCredential.InstanceID")) :REQUIRED
