...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Keyboard.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_KEYBOARD (CIM_USERDEVICE)
              ((NUMBEROFFUNCTIONKEYS UINT16 :CIM-NAME "NumberOfFunctionKeys"
                :QUALIFIERS
                ((:DESCRIPTION "Number of function keys on the Keyboard."))
                :INITFORM NIL)
               (LAYOUT STRING :CIM-NAME "Layout" :QUALIFIERS
                ((:DESCRIPTION
                  "A free-form string indicating the format and layout of the Keyboard.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Keyboard|004.1")))
                :INITFORM NIL)
               (PASSWORD UINT16 :CIM-NAME "Password" :QUALIFIERS
                ((:DESCRIPTION
