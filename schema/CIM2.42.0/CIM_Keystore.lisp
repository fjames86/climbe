...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Keystore.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_KEYSTORE (CIM_CREDENTIALSTORE)
              ((USAGE UINT16 :CIM-NAME "Usage" :QUALIFIERS
                ((:OVERRIDE "Usage")
                 (:DESCRIPTION "Usage of the keystore.
...
4 - Mixed value means CIM_Keystore instance represents a collection of both Trusted and Owned key based credentials.")
