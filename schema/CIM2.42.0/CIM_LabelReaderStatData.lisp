...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_LabelReaderStatData.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_LABELREADERSTATDATA (CIM_STATISTICALDATA)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_LabelReaderStatData")
...
(DEFCIM-METHOD RESETSELECTEDSTATS
    ((INSTANCE CIM_LABELREADERSTATDATA)
