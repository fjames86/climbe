...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_LaunchInContextCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_LAUNCHINCONTEXTCAPABILITIES
              (CIM_ENABLEDLOGICALELEMENTCAPABILITIES)
              ((MAXRESTRICTIONLISTSIZE UINT16 :CIM-NAME
                "MaxRestrictionListSize" :QUALIFIERS
                ((:DESCRIPTION
                  "This property asserts the maximum accepted size of the RestrictedToElement array parameter used in the CIM_LaunchInContextService methods: CreateLaunchPoint, RemoveLaunchPoint, and AssertLaunchPoint.
A zero indicates no defined limit."))
                :INITFORM "0")
               (MAXLAUNCHPOINTS UINT16 :CIM-NAME "MaxLaunchPoints" :QUALIFIERS
                ((:DESCRIPTION
                  "This property asserts the maximum number of CIM_LaunchInContextSAP instances that may be instantiated at one time within the modeled implementation.
A zero indicates no defined limit."))
                :INITFORM "0")
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_LaunchInContextCapabilities")
