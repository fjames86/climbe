...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Magazine.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_MAGAZINE (CIM_STORAGEMEDIALOCATION)
              ((LOCATIONTYPE UINT16 :CIM-NAME "LocationType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Slot" "Magazine" "MediaAccessDevice"
                   "InterLibrary Port" "Limited Access Port" "Door" "Shelf"
                   "Vault")))
                :INITFORM NIL)
               (MEDIACAPACITY UINT32 :CIM-NAME "MediaCapacity" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (LOCATIONCOORDINATES STRING :CIM-NAME "LocationCoordinates"
                :QUALIFIERS
                ((:DESCRIPTION
...
If not set to null for DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
               ...
               (PHYSICALLABELS (ARRAY STRING) :CIM-NAME "PhysicalLabels"
                ...
                ((:DESCRIPTION
                 ...
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_Magazine.LabelStates" "CIM_Magazine.LabelFormats")))
                :INITFORM NIL)
               (LABELSTATES (ARRAY UINT16) :CIM-NAME "LabelStates" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE ("CIM_Magazine.PhysicalLabels")))
                :INITFORM NIL)
               (LABELFORMATS (ARRAY UINT16) :CIM-NAME "LabelFormats"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_Magazine.PhysicalLabels")))
                :INITFORM NIL)
               (MEDIATYPESSUPPORTED (ARRAY UINT16) :CIM-NAME
                "MediaTypesSupported" :QUALIFIERS
                ((:DESCRIPTION
...
Values defined here correspond to those in the CIM_Physical Media.MediaType property. This allows quick comparisons using value equivalence calculations. It is understood that there is no external physical difference between (for example) DVD- Video and DVD-RAM. But, equivalent values in both the Physical Media and StorageMediaLocation enumerations allows for one for one comparisons with no additional processing logic (i.e., the following is not required ... if \"DVD-Video\" then value=\"DVD\").")
                ...
                :INITFORM NIL)
               (MEDIASIZESSUPPORTED (ARRAY REAL32) :CIM-NAME
                "MediaSizesSupported" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:P-UNIT "inch"))
                :INITFORM NIL)
               (TYPEDESCRIPTIONS (ARRAY STRING) :CIM-NAME "TypeDescriptions"
                :QUALIFIERS
                ((:DESCRIPTION
