...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_MediaAccessStatData.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_MEDIAACCESSSTATDATA (CIM_STATISTICALDATA)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_MediaAccessStatData")
...
(DEFCIM-METHOD RESETSELECTEDSTATS
    ((INSTANCE CIM_MEDIAACCESSSTATDATA)
