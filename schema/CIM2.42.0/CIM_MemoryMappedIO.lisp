...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_MemoryMappedIO.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_MEMORYMAPPEDIO (CIM_SYSTEMRESOURCE)
              ((CSCREATIONCLASSNAME STRING :CIM-NAME "CSCreationClassName"
               ...
               (STARTINGADDRESS UINT64 :CIM-NAME "StartingAddress" :QUALIFIERS
                (:KEY
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Mapped I/O|001.1")))
                :INITFORM NIL)
               (ENDINGADDRESS UINT64 :CIM-NAME "EndingAddress" :QUALIFIERS
                ((:DESCRIPTION "Ending address of memory mapped I/O.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Mapped I/O|001.2")))
                :INITFORM NIL)
               (MAPPEDRESOURCE UINT16 :CIM-NAME "MappedResource" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3"))
                 (:VALUES
                  ("Other" "Mapped Memory" "I/O Mapped to Memory Space"
