...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_NFS.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_NFS (CIM_REMOTEFILESYSTEM)
              ((HARDMOUNT BOOLEAN :CIM-NAME "HardMount" :QUALIFIERS
                ((:DESCRIPTION
...
If set to false: Once the FileSystem is mounted, an error is returned if the hosting System does not respond."))
                :INITFORM NIL)
               (FOREGROUNDMOUNT BOOLEAN :CIM-NAME "ForegroundMount" :QUALIFIERS
                ((:DESCRIPTION
...
If set to false: If the first mount attempt fails, retries are performed in the background."))
                :INITFORM NIL)
               (INTERRUPT BOOLEAN :CIM-NAME "Interrupt" :QUALIFIERS
                ((:DESCRIPTION
                  "If set to true: Interrupts are permitted for hard mounts. 
If set to false : Interrupts are ignored for hard mounts."))
                :INITFORM NIL)
               (MOUNTFAILURERETRIES UINT16 :CIM-NAME "MountFailureRetries"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Maximum number of mount failure retries allowed."))
                :INITFORM NIL)
               (RETRANSMISSIONATTEMPTS UINT16 :CIM-NAME
                "RetransmissionAttempts" :QUALIFIERS
                ((:DESCRIPTION
                  "Maximum number of NFS retransmissions allowed."))
                :INITFORM NIL)
               (RETRANSMISSIONTIMEOUT UINT32 :CIM-NAME "RetransmissionTimeout"
                :QUALIFIERS
                ((:DESCRIPTION "NFS timeout in tenths of a second.")
                 (NIL "Tenths of Seconds"))
                :INITFORM NIL)
               (READBUFFERSIZE UINT64 :CIM-NAME "ReadBufferSize" :QUALIFIERS
                ((:DESCRIPTION "Read buffer size in bytes.") (NIL "Bytes"))
                :INITFORM NIL)
               (WRITEBUFFERSIZE UINT64 :CIM-NAME "WriteBufferSize" :QUALIFIERS
                ((:DESCRIPTION "Write buffer size in bytes.") (NIL "Bytes"))
                :INITFORM NIL)
               (SERVERCOMMUNICATIONPORT UINT32 :CIM-NAME
                "ServerCommunicationPort" :QUALIFIERS
                ((:DESCRIPTION
                  "The remote ComputerSystem's (ie, the NFS File 'Server's) UDP port number."))
                :INITFORM NIL)
               (ATTRIBUTECACHING BOOLEAN :CIM-NAME "AttributeCaching"
                :QUALIFIERS
                ((:DESCRIPTION
                  "If set to true: Control attribute caching is enabled. 
If set to false: Control attribute caching is disabled."))
                :INITFORM NIL)
               (ATTRIBUTECACHINGFORREGULARFILESMIN UINT16 :CIM-NAME
                "AttributeCachingForRegularFilesMin" :QUALIFIERS
                ((:DESCRIPTION
                  "Minimum number of seconds that cached attributes are held after file modification.")
                 (NIL "Seconds"))
                :INITFORM NIL)
               (ATTRIBUTECACHINGFORREGULARFILESMAX UINT16 :CIM-NAME
                "AttributeCachingForRegularFilesMax" :QUALIFIERS
                ((:DESCRIPTION
                  "Maximum number of seconds that cached attributes are held after file modification.")
                 (NIL "Seconds"))
                :INITFORM NIL)
               (ATTRIBUTECACHINGFORDIRECTORIESMIN UINT16 :CIM-NAME
                "AttributeCachingForDirectoriesMin" :QUALIFIERS
                ((:DESCRIPTION
                  "Minimum number of seconds that cached attributes are held after directory update.")
                 (NIL "Seconds"))
                :INITFORM NIL)
               (ATTRIBUTECACHINGFORDIRECTORIESMAX UINT16 :CIM-NAME
                "AttributeCachingForDirectoriesMax" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                (:KEY (:OVERRIDE "Name")
                 ...
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (ROOT STRING :CIM-NAME "Root" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (BLOCKSIZE UINT64 :CIM-NAME "BlockSize" :QUALIFIERS
                ...
                :INITFORM NIL)
               (FILESYSTEMSIZE UINT64 :CIM-NAME "FileSystemSize" :QUALIFIERS
                ((:DESCRIPTION
                  "The FileSystemSize property stores the total size of the File System in bytes. If unknown, enter 0.")
                 (NIL "Bytes")
                 (:MAPPING-STRINGS ("MIF.DMTF|Host File System|001.13"))
                 (:P-UNIT "byte"))
                :INITFORM NIL)
               (AVAILABLESPACE UINT64 :CIM-NAME "AvailableSpace" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:P-UNIT "byte"))
                :INITFORM NIL)
               (READONLY BOOLEAN :CIM-NAME "ReadOnly" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ENCRYPTIONMETHOD STRING :CIM-NAME "EncryptionMethod"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Partition|002.8")))
                :INITFORM NIL)
               (COMPRESSIONMETHOD STRING :CIM-NAME "CompressionMethod"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Partition|002.7")))
                :INITFORM NIL)
               (CASESENSITIVE BOOLEAN :CIM-NAME "CaseSensitive" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates that case sensitive file names are supported."))
                :INITFORM NIL)
               (CASEPRESERVED BOOLEAN :CIM-NAME "CasePreserved" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates that the case of file names are preserved."))
                :INITFORM NIL)
               (MAXFILENAMELENGTH UINT32 :CIM-NAME "MaxFileNameLength"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (CLUSTERSIZE UINT32 :CIM-NAME "ClusterSize" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (FILESYSTEMTYPE STRING :CIM-NAME "FileSystemType" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (PERSISTENCETYPE UINT16 :CIM-NAME "PersistenceType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "Other" "Persistent" "Temporary" "External"))
               ...
               (OTHERPERSISTENCETYPE STRING :CIM-NAME "OtherPersistenceType"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_FileSystem.PersistenceType")))
                :INITFORM NIL)
               (NUMBEROFFILES UINT64 :CIM-NAME "NumberOfFiles" :QUALIFIERS
                ((:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (CODESET (ARRAY UINT16) :CIM-NAME "CodeSet" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "ASCII" "Unicode" "ISO2022" "ISO8859"
                   "Extended UNIX Code" "UTF-8" "UCS-2")))
                :INITFORM NIL)
