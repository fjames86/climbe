...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Notary.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_NOTARY (CIM_CREDENTIALMANAGEMENTSERVICE)
              ((COMPARITORS UINT16 :CIM-NAME "Comparitors" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("N/A" "Other" "Facial" "Retina" "Mark" "Finger" "Voice"
                   "DNA-RNA" "EEG")))
                :INITFORM NIL)
               (SEALPROTOCOL STRING :CIM-NAME "SealProtocol" :QUALIFIERS
                ((:DESCRIPTION
