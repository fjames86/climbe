...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_OOBAlertService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OOBALERTSERVICE (CIM_SERVICE)
              ((DESTINATIONTYPE UINT16 :CIM-NAME "DestinationType" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (OTHERDESTINATIONTYPEDESCRIPTION STRING :CIM-NAME
                "OtherDestinationTypeDescription" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (DESTINATIONADDRESS STRING :CIM-NAME "DestinationAddress"
                ...
                :INITFORM NIL)
               (MESSAGEFORMAT UINT16 :CIM-NAME "MessageFormat" :QUALIFIERS
                ((:DESCRIPTION
                  "The format of the Alert Message sent by the Service.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Unknown" "Other" "Numeric" "AlphaNumeric" "Free Form Text"
                   "Platform Event Trap"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_OOBAlertService.OtherMessageFormatDescription")))
                :INITFORM NIL)
               (OTHERMESSAGEFORMATDESCRIPTION STRING :CIM-NAME
                "OtherMessageFormatDescription" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_OOBAlertService.MessageFormat")))
                :INITFORM NIL)
               (ONLYSENDSFIXEDMESSAGE BOOLEAN :CIM-NAME "OnlySendsFixedMessage"
                :QUALIFIERS
                ((:DESCRIPTION
                  "If the AlertService only uses a fixed message to send an alert, then this flag should be set to TRUE."))
                :INITFORM NIL)
               (FIXEDPARTOFMESSAGE STRING :CIM-NAME "FixedPartOfMessage"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DESTINATIONISACKCAPABLE BOOLEAN :CIM-NAME
                "DestinationIsAckCapable" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (RETRYCOUNT UINT16 :CIM-NAME "RetryCount" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (RETRYINTERVAL UINT16 :CIM-NAME "RetryInterval" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PRESENCEHEARTBEATCAPABLE BOOLEAN :CIM-NAME
                "PresenceHeartbeatCapable" :QUALIFIERS
                ((:DESCRIPTION
                  "If the OOB Alerting service is capable of sending Presence heart beat messages.")
                 :READ)
                :INITFORM NIL)
               (ENABLEPRESENCEHEARTBEATS BOOLEAN :CIM-NAME
                "EnablePresenceHeartbeats" :QUALIFIERS
                ((:DESCRIPTION
