...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_OSPFArea.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OSPFAREA (CIM_ROUTINGPROTOCOLDOMAIN)
              ((AREAID UINT32 :CIM-NAME "AreaID" :QUALIFIERS
                ((:DESCRIPTION
                  "The area ID of this OSPF area, see C.2 in RFC 2328.")
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfAreaId")))
                :INITFORM NIL)
               (AREATYPE UINT16 :CIM-NAME "AreaType" :QUALIFIERS
                (:REQUIRED (:DESCRIPTION "The type of the OSPF area.")
                 (:VALUE-MAP ("2" "3" "4")) (:VALUES ("Plain" "Stub" "NSSA")))
                :INITFORM NIL)
               (EXTLSDBLIMIT UINT32 :CIM-NAME "ExtLsdbLimit" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfExtLsdbLimit")))
                :INITFORM NIL)
