...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_OSPFProtocolEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OSPFPROTOCOLENDPOINT (CIM_OSPFPROTOCOLENDPOINTBASE)
              ((PRIORITY UINT8 :CIM-NAME "Priority" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfRtrPriority")))
                :INITFORM NIL)
               (POLLINTERVAL UINT16 :CIM-NAME "PollInterval" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Seconds")
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfPollInterval")))
                :INITFORM NIL)
               (COST UINT16 :CIM-NAME "Cost" :QUALIFIERS
                ((:DESCRIPTION
                  "The cost of the routes through this OSPF endpoint, see C.3 in RFC 2328.")
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfMetricStatus")))
                :INITFORM NIL)
               (IFDEMAND BOOLEAN :CIM-NAME "IfDemand" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates whether the interface connects to an on-demand circuit, see RFC 1793.")
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfDemand")))
                :INITFORM NIL)
               (ENABLEDSTATE UINT16 :CIM-NAME "EnabledState" :QUALIFIERS
                ((:OVERRIDE "EnabledState")
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfAdminStat"))
                 (:VALUE-MAP
                ...
                :INITFORM NIL)
               (TRANSITDELAY UINT16 :CIM-NAME "TransitDelay" :QUALIFIERS
                ((:DESCRIPTION
                  "Estimated delay, in seconds that it takes to transmit a Link State Update Packet over this interface, see C.3 in RFC 2328.")
                 (NIL "Seconds")
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfTransitDelay")))
                :INITFORM NIL)
               (RETRANSMITINTERVAL UINT16 :CIM-NAME "RetransmitInterval"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The number of seconds between LSA (Link State Advertisement) retransmissions, see C.3 in RFC 2328.")
                 (NIL "Seconds")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|OSPF-MIB.ospfIfRetransInterval")))
                :INITFORM NIL)
               (AUTHTYPE UINT16 :CIM-NAME "AuthType" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
                  "Identifies the authentication procedure to be used on the attached network, see C.3 in RFC 2328.")
                 (:VALUE-MAP ("1" "2" "3" "4"))
                 (:VALUES
                  ("Other" "Null authentication" "Simple password"
                   "Cryptographic authentication"))
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfAuthType")))
                :INITFORM NIL)
               (OTHERAUTHTYPE STRING :CIM-NAME "OtherAuthType" :QUALIFIERS
                ((:DESCRIPTION
                  "Specifies the authentication procedure if the value, \"Other\" (1) is set for AuthType.")
                 (:MODEL-CORRESPONDENCE ("CIM_OSPFProtocolEndpoint.AuthType")))
                :INITFORM NIL)
               (AUTHKEY STRING :CIM-NAME "AuthKey" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|OSPF-MIB.ospfIfAuthKey")))
                :INITFORM NIL)
               (PROTOCOLIFTYPE UINT16 :CIM-NAME "ProtocolIFType" :QUALIFIERS
                ((:OVERRIDE "ProtocolIFType")
                 ...
                 (:VALUE-MAP ("1" "225..4095" "4109" "4301..32767" "32768.."))
                 (:VALUES
                  ("Other" "IANA Reserved" "OSPF" "DMTF Reserved"
                   "Vendor Reserved"))
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_OSPFProtocolEndpoint")
...
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_OSPFPROTOCOLENDPOINT)
