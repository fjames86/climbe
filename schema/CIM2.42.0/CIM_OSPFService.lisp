...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_OSPFService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OSPFSERVICE (CIM_ROUTECALCULATIONSERVICE)
              ((RUNNINGMOSPF BOOLEAN :CIM-NAME "RunningMOSPF" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (ISINTERAREAMULTICASTFORWARDER BOOLEAN :CIM-NAME
                "IsInterAreaMulticastForwarder" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|OSPF-MIB.ospfMulticastExtensions")))
                :INITFORM NIL)
               (ISINTERASMULTICASTFORWARDER BOOLEAN :CIM-NAME
                "IsInterAsMulticastForwarder" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|OSPF-MIB.ospfMulticastExtensions")))
                :INITFORM NIL)
               (EXITOVERFLOWINTERVAL UINT32 :CIM-NAME "ExitOverflowInterval"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Seconds")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|OSPF-MIB.ospfExitOverflowInterval")))
                :INITFORM NIL)
               (RFC1583COMPATIBILITY BOOLEAN :CIM-NAME "RFC1583Compatibility"
                :QUALIFIERS
                ((:DESCRIPTION
