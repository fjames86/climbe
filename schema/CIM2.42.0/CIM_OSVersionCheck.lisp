...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_OSVersionCheck.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OSVERSIONCHECK (CIM_CHECK)
              ((MINIMUMVERSION STRING :CIM-NAME "MinimumVersion" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MAXIMUMVERSION STRING :CIM-NAME "MaximumVersion" :QUALIFIERS
                ((:DESCRIPTION
