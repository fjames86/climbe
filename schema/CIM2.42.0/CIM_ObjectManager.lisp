...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ObjectManager.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OBJECTMANAGER (CIM_WBEMSERVICE)
              ((GATHERSTATISTICALDATA BOOLEAN :CIM-NAME "GatherStatisticalData"
                :QUALIFIERS
                ((:DEPRECATED ("No value")) :WRITE
                 (:DESCRIPTION
               ...
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:DEPRECATED ("CIM_WBEMServer.Name")) (:OVERRIDE "Name")
                 (:DESCRIPTION
...
Note: Name is semantically the same as InstanceID. In the next major version of the CIM Schema, Name will be renamed to InstanceID and become the only key of this class.")
               ...
               (ELEMENTNAME STRING :CIM-NAME "ElementName" :QUALIFIERS
                ((:DEPRECATED ("CIM_WBEMServer.ElementName"))
                 (:OVERRIDE "ElementName")
                 (:DESCRIPTION
                  "The ElementName property is used as a name of the CIM Server for human interfaces. For example, \"ACME CIM Server\"). This property is required to support the SLP discovery mechanism. In the next major release this property MAY include the required qualifier."))
                :INITFORM NIL)
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ((:DEPRECATED ("CIM_WBEMServer.Description"))
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ObjectManager")
              (:QUALIFIERS (:DEPRECATED ("CIM_WBEMServer")) (:VERSION "2.39.0")
