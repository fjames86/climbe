...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ObjectManagerAdapter.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_OBJECTMANAGERADAPTER (CIM_WBEMSERVICE)
              ((NAME STRING :CIM-NAME "Name" :QUALIFIERS
               ...
               (HANDLE STRING :CIM-NAME "Handle" :QUALIFIERS
                ...
                :INITFORM NIL)
               (ADAPTERTYPE UINT16 :CIM-NAME "AdapterType" :QUALIFIERS
                ((:DEPRECATED ("No value")) :REQUIRED
                 (:DESCRIPTION
...
Repository - A repository is an adapter that can store/retrieve persistent data, such as CIM Qualifier Types, CIM Classes and CIM Instances. An Object Manager could use multiple repositiories at one time, for example one could be used for CIM Schema information only, while another is used for instance information. Repositories MAY be remote or local to the CIM Object Manager. Examples of repository implementations could be databases, LDAP or files.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Other" "Client" "Provider" "Indication Handler"
                   "Repository"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_ObjectManagerAdapter.OtherAdapterTypeDescription")))
                :INITFORM NIL)
               (OTHERADAPTERTYPEDESCRIPTION STRING :CIM-NAME
                "OtherAdapterTypeDescription" :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION
                  "The type(s) of ObjectManagerAdapter when \"Other\" is included in ObjectManagerAdapterType property.")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_ObjectManagerAdapter.AdapterType")))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ObjectManagerAdapter")
              (:QUALIFIERS (:DEPRECATED ("CIM_ProtocolService" "No value"))
...
(DEFCIM-METHOD STARTSERVICE
    ((INSTANCE CIM_OBJECTMANAGERADAPTER))
