...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PassThroughModule.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PASSTHROUGHMODULE (CIM_LOGICALMODULE)
              ((ISPROGRAMMABLE BOOLEAN :CIM-NAME "IsProgrammable" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating if the port assignments on this switch are software programmable or not."))
                :INITFORM "false")
               (NUMBEROFPORTS UINT16 :CIM-NAME "NumberOfPorts" :QUALIFIERS
                ((:DESCRIPTION
                  "A PassThroughModule is a simple module with 1-1 correspondence between internal and external ports. This number represents the number of external ports. By virtue of there being a 1-1 correspondence of ports, it also represents the number of internal ports. 
The ports are numbered 1 through N."))
                :INITFORM NIL)
               (MODULENUMBER UINT16 :CIM-NAME "ModuleNumber" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (LOGICALMODULETYPE UINT16 :CIM-NAME "LogicalModuleType"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Type identifies the type of LogicalModule this instance represents. 
...
The ranges expressed by \"DMTF Reserved\" and \"Vendor Reserved\" are reserved for DMTF and Vendor extensibility, respectively.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5..32767" "32768..65535"))
                 (:VALUES
                  ("Unknown" "Other" "Device Tray" "Line Card" "Blade"
                   "DMTF Reserved" "Vendor Reserved"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_LogicalModule.OtherLogicalModuleTypeDescription")))
                :INITFORM "0")
               (OTHERLOGICALMODULETYPEDESCRIPTION STRING :CIM-NAME
                "OtherLogicalModuleTypeDescription" :QUALIFIERS
                ((:DESCRIPTION
                  "OtherLogicalModuleTypeDescription provides additional information about the type of LogicalModule represented by this instance when the value of LogicalModuleType is 1 (\"Other\").")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_LogicalModule.LogicalModuleType")))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (LINKTECHNOLOGIES (ARRAY UINT16) :CIM-NAME "LinkTechnologies"
                :QUALIFIERS
                ((:DESCRIPTION
                  "An enumeration of the link technologies that can be passed- through by this device. When set to 1 (\"Other\"), the property OtherLinkTechnologies contains string descriptions of the alternative link types.")
                 (:VALUE-MAP
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Ethernet" "IB" "FC" "FDDI" "ATM"
                   ...
                   "Wireless LAN" "DMTF Reserved" "Vendor Specified"))
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PassThroughModule.OtherLinkTechnologies")))
                :INITFORM NIL)
               (OTHERLINKTECHNOLOGIES (ARRAY STRING) :CIM-NAME
                "OtherLinkTechnologies" :QUALIFIERS
                ((:DESCRIPTION
                  "An array of string values describing the supported technologies when an entry in the LinkTechnologies array is set to 1, \"Other\".")
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PassThroughModule.LinkTechnologies")))
                :INITFORM NIL)
               (INTERNALPORTS (ARRAY UINT16) :CIM-NAME "InternalPorts"
                :QUALIFIERS
                ((:DESCRIPTION
                  "An indexed array containing the internal port numbers. Corresponding external ports are in the ExternalPorts array. Only internal ports which are mapped to an external port shall appear in the array.")
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PassThroughModule.ExternalPorts"
                   "CIM_NetworkPort.PortNumber")))
                :INITFORM NIL)
               (EXTERNALPORTS (ARRAY UINT16) :CIM-NAME "ExternalPorts"
                :QUALIFIERS
                ((:DESCRIPTION
                  "An indexed array containing the external ports. Corresponding internal ports are in the InternalPorts array. Only external ports which are mapped to an internal port shall appear in the array.")
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PassThroughModule.InternalPorts"
                   "CIM_NetworkPort.PortNumber")))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_PassThroughModule")
...
(DEFCIM-METHOD ASSIGNPORTS
    ((INSTANCE CIM_PASSTHROUGHMODULE)
     (MAPPED BOOLEAN "Mapped" :IN
      (:DESCRIPTION
       "Boolean indicating if the ports are to be unmapped or mapped. If \"True\", InternalPorts and ExternalPorts shall be updated to contain a mapping of InternalPort to ExternalPort. If \"False\", InternalPorts and ExternalPorts shall be updated to remove the mapping if one exists."))
     (INTERNALPORT UINT16 "InternalPort" :IN
      (:DESCRIPTION "The mapping for this internal port shall be updated."))
     (EXTERNALPORT UINT16 "ExternalPort" :IN
      (:DESCRIPTION "The mapping for this external port shall be updated.")))
    ((:CIM-NAME "AssignPorts")
     (:QUALIFIERS
      (:DESCRIPTION
       "If the switch is software programmable, then this method is called to assign an internal port to an external port. 
If 0 is returned, the requested status of the mapping of InternalPort and ExternalPort is in effect. That is, an attempt to unmap two ports that are not mapped to any other ports or an attempt to map two ports which are already mapped to each other shall return 0, because the resultant state of the mapping is equivalent to the client request. For a mapping operation, if either target port is already mapped to a different port, the implementation shall first unmap it. An attempt to unmap two ports that are not mapped to each other shall fail with an error of \"Not Mapped\".")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
        "Busy" "Not Mapped" "DMTF Reserved" "Vendor Reserved")))))
