...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PhysicalCredentialAuthentication.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PHYSICALCREDENTIALAUTHENTICATION
              (CIM_AUTHENTICATIONCONDITION)
              ((TYPEOFCREDENTIAL UINT16 :CIM-NAME "TypeOfCredential"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Integer enumeration identifying the credential that should be authenticated.")
                 (:VALUE-MAP ("1" "2" "3" "4"))
                 (:VALUES
                  ("Other" "Magnetic Stripe Card" "Smart Card"
                   "Password Generator Card"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PhysicalCredentialAuthentication.OtherCredential")))
                :INITFORM NIL)
               (OTHERCREDENTIAL STRING :CIM-NAME "OtherCredential" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PHYSICALIDENTIFIER STRING :CIM-NAME "PhysicalIdentifier"
                :QUALIFIERS
                ((:DESCRIPTION
...
This MOF defines the following keywords: 'UNKNOWN', 'CONFIGURATION', 'USAGE', 'SECURITY', 'SERVICE', 'MOTIVATIONAL', 'INSTALLATION', and 'EVENT'. These concepts are self-explanatory and are further discussed in the SLA/Policy White Paper. One additional keyword is defined: 'POLICY'. The role of this keyword is to identify policy-related instances that may not be otherwise identifiable, in some implementations. The keyword 'POLICY' is NOT mutually exclusive of the other keywords specified above."))
                :INITFORM NIL))
              (:CIM-NAME "CIM_PhysicalCredentialAuthentication")
