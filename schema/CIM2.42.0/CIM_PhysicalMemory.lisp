...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PhysicalMemory.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PHYSICALMEMORY (CIM_CHIP)
              ((FORMFACTOR UINT16 :CIM-NAME "FormFactor" :QUALIFIERS
                ((:OVERRIDE "FormFactor")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.6"))
                 (:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "SIP" "DIP" "ZIP" "SOJ" "Proprietary"
                   "SIMM" "DIMM" "TSOP" "PGA" "RIMM" "SODIMM" "SRIMM" "SMD"
                   "SSMP" "QFP" "TQFP" "SOIC" "LCC" "PLCC" "BGA" "FPBGA"
                   "LGA")))
                :INITFORM NIL)
                ...
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "DRAM" "Synchronous DRAM" "Cache DRAM"
                   ...
                   "DDR" "DDR-2" "BRAM" "FB-DIMM" "DDR3" "FBD2" "DDR4" "LPDDR"
                   "LPDDR2" "LPDDR3" "LPDDR4" "DMTF Reserved"
                   "Vendor Reserved"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.9")))
                :INITFORM NIL)
               (TOTALWIDTH UINT16 :CIM-NAME "TotalWidth" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Bits")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.7")))
                :INITFORM NIL)
               (DATAWIDTH UINT16 :CIM-NAME "DataWidth" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Bits")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.8")))
                :INITFORM NIL)
               (SPEED UINT32 :CIM-NAME "Speed" :QUALIFIERS
                ((:DESCRIPTION
                  "The speed of the PhysicalMemory, in nanoseconds.")
                 (NIL "NanoSeconds")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.24"))
               ...
               (CAPACITY UINT64 :CIM-NAME "Capacity" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Bytes")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.5")))
                :INITFORM NIL)
               (BANKLABEL STRING :CIM-NAME "BankLabel" :QUALIFIERS
                ((:DESCRIPTION
                  "A string identifying the physically labeled bank where the Memory is located - for example, 'Bank 0' or 'Bank A'.")
                 (:MAX-LEN "64")
                 (:MAPPING-STRINGS ("MIF.DMTF|Memory Device|005.4")))
                :INITFORM NIL)
               (POSITIONINROW UINT32 :CIM-NAME "PositionInRow" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (INTERLEAVEPOSITION UINT32 :CIM-NAME "InterleavePosition"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (CONFIGUREDMEMORYCLOCKSPEED UINT32 :CIM-NAME
                "ConfiguredMemoryClockSpeed" :QUALIFIERS
                ((:DESCRIPTION
                  "The configured clock speed (in MHz) of PhysicalMemory.")
                 (NIL "MegaHertz"))
                :INITFORM NIL)
               (ISSPEEDINMHZ BOOLEAN :CIM-NAME "IsSpeedInMhz" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PhysicalMemory.Speed"
                   "CIM_PhysicalMemory.MaxMemorySpeed")))
                :INITFORM "false")
               (MAXMEMORYSPEED UINT32 :CIM-NAME "MaxMemorySpeed" :QUALIFIERS
