...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PickerElement.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PICKERELEMENT (CIM_MEDIATRANSFERDEVICE)
              ((MAXPICKTIME UINT32 :CIM-NAME "MaxPickTime" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MAXPUTTIME UINT32 :CIM-NAME "MaxPutTime" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Seconds") (:P-UNIT "second"))
                :INITFORM NIL)
               (CELLLOCATION STRING :CIM-NAME "CellLocation" :QUALIFIERS
                ((:DESCRIPTION
