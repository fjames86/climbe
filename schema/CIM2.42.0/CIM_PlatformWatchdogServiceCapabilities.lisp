...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PlatformWatchdogServiceCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PLATFORMWATCHDOGSERVICECAPABILITIES
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL)
               (ACTIONONEXPIRATIONSUPPORTED (ARRAY UINT16) :CIM-NAME
                "ActionOnExpirationSupported" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("None - Status Only" "System Reset" "System Power Off"
               ...
               (WATCHDOGTIMERDATASUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL)
               (LASTEXPIRATIONDATASUPPORTED (ARRAY UINT16) :CIM-NAME
                "LastExpirationDataSupported" :QUALIFIERS
                ((:DESCRIPTION
                  "LastExpirationDataSupported indicates the data which is provided on the last expiration of the watchdog timer. The values in the enumeration are: A value set to 2 = \"Time\" shall indicate that the time of the last expiration is provided.")
                 (:VALUE-MAP ("2")) (:VALUES ("Time"))
                 (:MODEL-CORRESPONDENCE
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_PlatformWatchdogServiceCapabilities")
