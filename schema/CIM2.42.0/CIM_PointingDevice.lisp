...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PointingDevice.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_POINTINGDEVICE (CIM_USERDEVICE)
              ((POINTINGTYPE UINT16 :CIM-NAME "PointingType" :QUALIFIERS
                ((:DESCRIPTION "The type of the pointing device.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7" "8" "9"))
                 (:VALUES
                  ("Other" "Unknown" "Mouse" "Track Ball" "Track Point"
                   "Glide Point" "Touch Pad" "Touch Screen"
                   "Mouse - Optical Sensor"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Pointing Device|003.1")))
                :INITFORM NIL)
               (NUMBEROFBUTTONS UINT8 :CIM-NAME "NumberOfButtons" :QUALIFIERS
                ((:DESCRIPTION
                  "Number of buttons. If the PointingDevice has no buttons, enter 0.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Pointing Device|003.4")))
                :INITFORM NIL)
               (HANDEDNESS UINT16 :CIM-NAME "Handedness" :QUALIFIERS
                ((:DESCRIPTION
