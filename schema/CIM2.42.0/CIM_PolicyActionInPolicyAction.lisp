...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PolicyActionInPolicyAction.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_POLICYACTIONINPOLICYACTION (CIM_POLICYACTIONSTRUCTURE)
...
Note that the non-zero sequence numbers need not start with '1', and they need not be consecutive. All that matters is their relative magnitude."))
               ...
               (GROUPCOMPONENT NIL :CIM-NAME "GroupComponent" :QUALIFIERS
                (:AGGREGATE (:OVERRIDE "GroupComponent")
                 ...
                 :KEY)
                :INITFORM "CIM_CompoundPolicyAction")
              ...
              (:CIM-NAME "CIM_PolicyActionInPolicyAction")
