...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PolicyGroup.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_POLICYGROUP (CIM_POLICYSET)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
               ...
               (CREATIONCLASSNAME STRING :CIM-NAME "CreationClassName"
                ...
                (:KEY
                 ...
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (POLICYGROUPNAME STRING :CIM-NAME "PolicyGroupName" :QUALIFIERS
                (:KEY
                 (:DESCRIPTION "A user-friendly name of this PolicyGroup.")
                 (:MAX-LEN "256"))
                :INITFORM NIL)
