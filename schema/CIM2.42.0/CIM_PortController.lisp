...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PortController.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PORTCONTROLLER (CIM_CONTROLLER)
              ((CONTROLLERTYPE UINT16 :CIM-NAME "ControllerType" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (OTHERCONTROLLERTYPE STRING :CIM-NAME "OtherControllerType"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_PortController.ControllerType")))
                :INITFORM NIL)
               (CONTROLLERVERSION UINT16 :CIM-NAME "ControllerVersion"
                :QUALIFIERS
