...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PowerManagementService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_POWERMANAGEMENTSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_PowerManagementService")
              (:QUALIFIERS (:VERSION "2.19.1")
...
(DEFCIM-METHOD SETPOWERSTATE
    ((INSTANCE CIM_POWERMANAGEMENTSERVICE)
     (POWERSTATE UINT16 "PowerState" :IN
      (:DESCRIPTION "The power state for ManagedElement.")
      (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7" "8"))
      (:VALUES
       ("On" "Sleep - Light" "Sleep -Deep" "Vendor Specific"
        "Power Cycle (Off - Soft)" "Off - Hard" "Hibernate (Off - Soft)"
        "Off - Soft"))
    ...
    ((:CIM-NAME "SetPowerState")
     (:QUALIFIERS
      (:DEPRECATED ("CIM_PowerManagementService.RequestPowerStateChange"))
      (:DESCRIPTION
...
(DEFCIM-METHOD REQUESTPOWERSTATECHANGE
    ((INSTANCE CIM_POWERMANAGEMENTSERVICE)
     (POWERSTATE UINT16 "PowerState" :IN
      (:DESCRIPTION "The power state for ManagedElement.")
      (:VALUE-MAP
      ...
      (:VALUES
       ("Power On" "Sleep - Light" "Sleep - Deep" "Power Cycle (Off Soft)"
        "Power Off - Hard" "Hibernate" "Power Off - Soft"
        "Power Cycle (Off Hard)" "Master Bus Reset"
        "Diagnostic Interrupt (NMI)" "Power Off - Soft Graceful"
        "Power Off - Hard Graceful" "Master Bus Reset Graceful"
...
If this property does not contain 0 or null and the implementation does not support this parameter, a return code of 'Use Of Timeout Parameter Not Supported' must be returned."))
    ...
    ((:CIM-NAME "RequestPowerStateChange")
     (:QUALIFIERS
      (:DESCRIPTION
