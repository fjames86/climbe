...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PowerSource.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_POWERSOURCE (CIM_LOGICALDEVICE)
              ((RATEDMAXOUTPUTPOWER UINT32 :CIM-NAME "RatedMaxOutputPower"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_PowerSource.OutputPowerUnits")))
                :INITFORM NIL)
               (OUTPUTPOWERUNITS STRING :CIM-NAME "OutputPowerUnits"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates the programatic units for the MaxOutputPower property.")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PowerSource.RatedMaxOutputPower"))
                 :IS-P-UNIT)
                :INITFORM NIL)
               (ISACOUTPUT BOOLEAN :CIM-NAME "IsACOutput" :QUALIFIERS
                ((:DESCRIPTION
