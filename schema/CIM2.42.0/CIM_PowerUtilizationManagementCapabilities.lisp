...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PowerUtilizationManagementCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_POWERUTILIZATIONMANAGEMENTCAPABILITIES
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (POWERUTILIZATIONMODESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                ((:DESCRIPTION
                  "PowerUtilizationModesSupported indicates the power utilization modes supported by associated instances of CIM_PowerUtilizationManagementService. See CIM_PowerUtilizationManagementService.PowerSavingMode for a description of each enumeration value.")
               ...
               (SUPPORTEDMETHODS (ARRAY UINT16) :CIM-NAME "SupportedMethods"
                ...
                ((:DESCRIPTION "Enumeration of supported method identifiers")
                 ...
                 (:VALUES
                  ("ApplyPowerAllocationSettings" "DMTF Reserved"
                   "Vendor Reserved")))
                :INITFORM NIL)
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_PowerUtilizationManagementCapabilities")
