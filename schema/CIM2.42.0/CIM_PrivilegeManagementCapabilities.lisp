...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_PrivilegeManagementCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PRIVILEGEMANAGEMENTCAPABILITIES (CIM_CAPABILITIES)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (SUPPORTEDMETHODS (ARRAY UINT16) :CIM-NAME "SupportedMethods"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Each enumeration corresponds to support for the like-named method of the PrivilegeManagementService.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4..40" ".." "0x8000.."))
                 (:VALUES
                  ("ChangeAccess" "ShowAccess" "AssignAccess" "RevokeAccess"
                   "DMTF Role Reserved" "DMTF Reserved" "Vendor Specific")))
                :INITFORM NIL))
              (:CIM-NAME "CIM_PrivilegeManagementCapabilities")
