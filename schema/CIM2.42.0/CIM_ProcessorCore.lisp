...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ProcessorCore.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PROCESSORCORE (CIM_ENABLEDLOGICALELEMENT)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
                :INITFORM NIL)
               (COREENABLEDSTATE UINT16 :CIM-NAME "CoreEnabledState"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The CoreEnabledState property is the configuration state of the processor core. For example, the core might be disabled by the user (value=2), or disabled due to a POST error (value=3).")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Unknown" "DMTF Reserved" "Core Enabled" "Core Disabled"
                   "Core Disabled by User" "Core Disabled By POST Error)")))
                :INITFORM NIL)
               (LOADPERCENTAGE UINT16 :CIM-NAME "LoadPercentage" :QUALIFIERS
                ((:DESCRIPTION
                  "Loading of this processor core, averaged over the last minute, in Percent.")
