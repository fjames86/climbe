...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ProtocolService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_PROTOCOLSERVICE (CIM_SERVICE)
              ((PROTOCOL UINT16 :CIM-NAME "Protocol" :QUALIFIERS
                ((:DESCRIPTION
                  "The protocol this service provides. Values defined for this property are limited to the known use cases where it is desirable to represent the ability to enable or disable the functionality on the system.")
                 (:VALUE-MAP
                  ("0" "1" "2" "3" "4" "5" "6" "7" "8..32767" "32768..65535"))
                 (:VALUES
                  ("Unknown" "Other" "SSH" "Telnet" "CLP" "CIM-XML"
                   "WS-Management" "CIM-RS" "DMTF Reserved" "Vendor Reserved"))
                 (:MODEL-CORRESPONDENCE ("CIM_ProtocolService.OtherProtocol")))
                :INITFORM NIL)
               (OTHERPROTOCOL STRING :CIM-NAME "OtherProtocol" :QUALIFIERS
                ((:DESCRIPTION
                  "If the Protocol property is set to 1 \"Other\" then free form string providing more information about the protocol. If not set to 1, this string has no meaning.")
                 (:MODEL-CORRESPONDENCE ("CIM_ProtocolService.Protocol")))
                :INITFORM NIL)
