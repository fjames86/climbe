...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_QueuingService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_QUEUINGSERVICE (CIM_CONDITIONINGSERVICE)
              ((CURRENTQUEUEDEPTH UINT32 :CIM-NAME "CurrentQueueDepth"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 :GAUGE
                 (:MODEL-CORRESPONDENCE ("CIM_QueuingService.DepthUnits")))
                :INITFORM NIL)
               (DEPTHUNITS UINT16 :CIM-NAME "DepthUnits" :QUALIFIERS
                ((:DESCRIPTION
