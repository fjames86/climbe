...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Rack.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_RACK (CIM_PHYSICALFRAME)
              ((HEIGHT REAL32 :CIM-NAME "Height" :QUALIFIERS
                ...
                :INITFORM NIL)
               (TYPEOFRACK UINT16 :CIM-NAME "TypeOfRack" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Standard 19 Inch" "Telco" "Equipment Shelf"
                   "Non-Standard"))
                 (:MODEL-CORRESPONDENCE ("CIM_Rack.CountryDesignation")))
                :INITFORM NIL)
               (COUNTRYDESIGNATION STRING :CIM-NAME "CountryDesignation"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_Rack.TypeOfRack")))
                :INITFORM NIL)
               (CABLEMANAGEMENTSTRATEGY STRING :CIM-NAME
                "CableManagementStrategy" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (LOCKPRESENT BOOLEAN :CIM-NAME "LockPresent" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (VISIBLEALARM BOOLEAN :CIM-NAME "VisibleAlarm" :QUALIFIERS
                ...
                :INITFORM NIL)
               (SECURITYBREACH UINT16 :CIM-NAME "SecurityBreach" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Other" "Unknown" "No Breach" "Breach Attempted"
                   "Breach Successful"))
                 (:MAPPING-STRINGS
                ...
                :INITFORM NIL)
               (BREACHDESCRIPTION STRING :CIM-NAME "BreachDescription"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_PhysicalFrame.SecurityBreach")))
                :INITFORM NIL)
               (ISLOCKED BOOLEAN :CIM-NAME "IsLocked" :QUALIFIERS
                ((:DESCRIPTION
...
If not set to null for DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
               ...
               (CAPTION STRING :CIM-NAME "Caption" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAX-LEN "64"))
                :INITFORM NIL)
               (SERVICEPHILOSOPHY (ARRAY UINT16) :CIM-NAME "ServicePhilosophy"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Service From Top" "Service From Front"
                   "Service From Back" "Service From Side" "Sliding Trays"
                   "Removable Sides" "Moveable"))
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_PhysicalFrame.ServiceDescriptions")))
                :INITFORM NIL)
               (SERVICEDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                "ServiceDescriptions" :QUALIFIERS
                ((:DESCRIPTION
