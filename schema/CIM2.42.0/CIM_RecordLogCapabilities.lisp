...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_RecordLogCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_RECORDLOGCAPABILITIES (CIM_ENABLEDLOGICALELEMENTCAPABILITIES)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL)
               (SUPPORTEDRECORDTYPES (ARRAY UINT16) :CIM-NAME
                "SupportedRecordTypes" :QUALIFIERS
                ((:DESCRIPTION
...
3 (\"Standard Messages\") indicates that this log is capable of storing log entries using Standard Messages.")
                 (:VALUE-MAP ("0" "2" "3" ".."))
                 (:VALUES
                  ("Unknown" "Record Data" "Standard Messages"
                   "DMTF Reserved")))
                :INITFORM NIL)
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_RecordLogCapabilities")
