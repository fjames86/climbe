...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_RegisteredProfile.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_REGISTEREDPROFILE (CIM_REGISTEREDSPECIFICATION)
...
If not null, an implementation shall put the profile defined feature name of each implemented feature in a separate entry of this array."))
               ...
               (ADVERTISETYPEDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_RegisteredProfile")
