...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_RemoveFileAction.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_REMOVEFILEACTION (CIM_FILEACTION)
              ((FILE STRING :CIM-NAME "File" :QUALIFIERS
                ((:DESCRIPTION "The file to be removed.") (:MAX-LEN "1024"))
                :INITFORM NIL)
