...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ResourcePoolConfigurationService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_RESOURCEPOOLCONFIGURATIONSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ResourcePoolConfigurationService")
...
(DEFCIM-METHOD CREATERESOURCEPOOL
    ((INSTANCE CIM_RESOURCEPOOLCONFIGURATIONSERVICE)
     ...
     (RESOURCETYPE STRING "ResourceType" :IN
      (:DESCRIPTION
       "The type of resources the created poolwill manage. If HostResources contains elements, this property must mach their type."))
     (POOL "CIM_ResourcePool" "Pool" :IN :OUT
      (:DESCRIPTION
       "On success, a reference to the resulting ResourcePool is returned. When a Job is returned, this may be NULL, in which case, the client must use the Job to find the resulting ResourcePool once the Job completes."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed)."))
     (HOSTRESOURCES "CIM_LogicalDevice" "HostResources" :IN
      (:DESCRIPTION
       "Array of zero or more devices that are used to create the Pool or modify the source extents. All elements in the array must be of the same type.")))
    ((:CIM-NAME "CreateResourcePool")
     (:QUALIFIERS
      (:DESCRIPTION
...
(DEFCIM-METHOD CREATECHILDRESOURCEPOOL
    ((INSTANCE CIM_RESOURCEPOOLCONFIGURATIONSERVICE)
     ...
     (POOL "CIM_ResourcePool" "Pool" :IN :OUT
      (:DESCRIPTION "A reference to the resulting pool."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed)."))
     (SETTINGS (ARRAY STRING) "Settings" :IN
      (:DESCRIPTION
     ...
     (PARENTPOOL "CIM_ResourcePool" "ParentPool" :IN
    ...
    ((:CIM-NAME "CreateChildResourcePool")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" "7" "8" ".." "4096" "4097" "4098..32767"
        "32768..65535"))
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unknown" "Timeout"
        "Failed" "Invalid Parameter" "In Use"
        "Incorrect ResourceType for the Pool" "Insufficient Resources"
        "DMTF Reserved" "Method Parameters Checked - Job Started"
        "Size Not Supported" "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD DELETERESOURCEPOOL
    ((INSTANCE CIM_RESOURCEPOOLCONFIGURATIONSERVICE)
     (POOL "CIM_ResourcePool" "Pool" :IN
      (:DESCRIPTION "Reference to the pool to delete."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed).")))
    ((:CIM-NAME "DeleteResourcePool")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" "7" ".." "4096" "4097..32767"
        "32768..65535"))
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unknown" "Timeout"
        "Failed" "Invalid Parameter" "In Use"
        ...
        "Vendor Specific")))))
(DEFCIM-METHOD ADDRESOURCESTORESOURCEPOOL
    ((INSTANCE CIM_RESOURCEPOOLCONFIGURATIONSERVICE)
     (POOL "CIM_ResourcePool" "Pool" :IN
      (:DESCRIPTION "The pool to add the resources to."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed)."))
     (HOSTRESOURCES "CIM_LogicalDevice" "HostResources" :IN
      (:DESCRIPTION
       "Array of CIM_LogicalDevice instances to add to the Pool.")))
    ((:CIM-NAME "AddResourcesToResourcePool")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unknown" "Timeout"
        ...
        "Method Parameters Checked - Job Started" "Size Not Supported"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD REMOVERESOURCESFROMRESOURCEPOOL
    ((INSTANCE CIM_RESOURCEPOOLCONFIGURATIONSERVICE)
     (POOL "CIM_ResourcePool" "Pool" :IN
      (:DESCRIPTION "The pool to remove the resources from."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed)."))
     (HOSTRESOURCES "CIM_LogicalDevice" "HostResources" :IN
      (:DESCRIPTION
       "Array of CIM_LogicalDevice instances to remove from the Pool.")))
    ((:CIM-NAME "RemoveResourcesFromResourcePool")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unknown" "Timeout"
        ...
        "Method Parameters Checked - Job Started" "Size Not Supported"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD CHANGEPARENTRESOURCEPOOL
    ((INSTANCE CIM_RESOURCEPOOLCONFIGURATIONSERVICE)
     (CHILDPOOL "CIM_ResourcePool" "ChildPool" :IN
      (:DESCRIPTION "Reference to the child pool."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed).")
      (:MODEL-CORRESPONDENCE
    ...
    ((:CIM-NAME "ChangeParentResourcePool")
     (:QUALIFIERS
      (:DESCRIPTION
