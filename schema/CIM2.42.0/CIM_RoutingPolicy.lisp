...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_RoutingPolicy.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ROUTINGPOLICY (CIM_LOGICALELEMENT)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
               ...
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                (:KEY (:OVERRIDE "Name")
                 ...
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (ACTION UINT16 :CIM-NAME "Action" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7" "8" "9"))
                 (:VALUES
                  ("Accept As Is" "Accept With Protocol Attribute Changes"
                   ...
                   "Deny")))
                :INITFORM NIL)
               (ATTRIBUTEACTION UINT16 :CIM-NAME "AttributeAction" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_RoutingPolicy.BGPAction")))
                :INITFORM NIL)
               (BGPACTION UINT16 :CIM-NAME "BGPAction" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Origin" "AS_Path" "NEXT_HOP" "Multi_Exit_Disc" "Local_Pref"
                   "Atomic_Aggregate" "Aggregator" "Community" "Originator_ID"
                   "Cluster_List"))
                 (:MODEL-CORRESPONDENCE ("CIM_RoutingPolicy.BGPValue")))
                :INITFORM NIL)
               (BGPVALUE STRING :CIM-NAME "BGPValue" :QUALIFIERS
                ((:DESCRIPTION "The value for the corresponding BGPAction.")
                 (:MODEL-CORRESPONDENCE ("CIM_RoutingPolicy.BGPAction")))
                :INITFORM NIL)
               (REMARKACTION UINT16 :CIM-NAME "RemarkAction" :QUALIFIERS
                ((:DESCRIPTION
                  "This defines a remarking action for this traffic.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7"))
                 (:VALUES
                  ("Change DSCP" "Change ToS" "Change 802.1Q Value"
                   "Change CIR" "Change CBR" "Change ABR" "Change VBR"))
                 (:MODEL-CORRESPONDENCE ("CIM_RoutingPolicy.RemarkValue")))
                :INITFORM NIL)
               (REMARKVALUE STRING :CIM-NAME "RemarkValue" :QUALIFIERS
                ((:DESCRIPTION "The value for the corresponding RemarkAction.")
                 (:MODEL-CORRESPONDENCE ("CIM_RoutingPolicy.RemarkAction")))
                :INITFORM NIL)
               (CONDITIONINGACTION UINT16 :CIM-NAME "ConditioningAction"
                :QUALIFIERS
                ((:DESCRIPTION
                  "This defines another action to be taken for this traffic.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "7"))
                 (:VALUES
                  ("Other" "Input Flow Policing" "Output Flow Policing"
                   "Input Aggregate Policing" "Output Aggregate Policing"
                   "Police By Marking Down" "Police By Dropping Down"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_RoutingPolicy.ConditioningValue"
                   "CIM_RoutingPolicy.OtherConditioningAction")))
                :INITFORM NIL)
               (OTHERCONDITIONINGACTION STRING :CIM-NAME
                "OtherConditioningAction" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (CONDITIONINGVALUE STRING :CIM-NAME "ConditioningValue"
                :QUALIFIERS
                ((:DESCRIPTION
