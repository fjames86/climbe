...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SAEndpointConnectionStatistics.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SAENDPOINTCONNECTIONSTATISTICS (CIM_STATISTICALDATA)
              ((BYTECOUNT UINT64 :CIM-NAME "ByteCount" :QUALIFIERS
                ((:DESCRIPTION
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_SAEndpointConnectionStatistics")
...
(DEFCIM-METHOD RESETSELECTEDSTATS
    ((INSTANCE CIM_SAENDPOINTCONNECTIONSTATISTICS)
