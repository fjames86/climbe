...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SAProposal.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SAPROPOSAL (CIM_SCOPEDSETTINGDATA)
...
For DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
              ...
              (:QUALIFIERS :ABSTRACT (:VERSION "2.8.0")
               ...
               (:MAPPING-STRINGS ("IPSP Policy Model.IETF|SAProposal"))))