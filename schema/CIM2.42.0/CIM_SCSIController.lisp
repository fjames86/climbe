...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SCSIController.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SCSICONTROLLER (CIM_CONTROLLER)
              ((PROTECTIONMANAGEMENT UINT16 :CIM-NAME "ProtectionManagement"
                :QUALIFIERS
                ((:DEPRECATED ("No value"))
...
Deprecated description: An integer enumeration that indicates whether or not the SCSIController provides redundancy or protection against device failures.")
                 ...
                 (:VALUES
                  ("Other" "Unknown" "Unprotected" "Protected"
                   "Protected through SCC (SCSI-3 Controller Command)"
                   "Protected through SCC-2 (SCSI-3 Controller Command)"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Storage Controller|001.3")))
                :INITFORM NIL)
               (MAXDATAWIDTH UINT32 :CIM-NAME "MaxDataWidth" :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION "Note: The use of this method is deprecated. 
Deprecated description: Maximum data width (in bits) supported by the SCSIController.")
                 (NIL "Bits") (:MAPPING-STRINGS ("MIF.DMTF|Bus Port|004.7"))
                 (:P-UNIT "bit"))
                :INITFORM NIL)
               (MAXTRANSFERRATE UINT64 :CIM-NAME "MaxTransferRate" :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION "Note: The use of this method is deprecated. 
Deprecated description: Maximum transfer rate (in Bits per Second) supported by the SCSIController.")
                 (NIL "Bits per Second")
                 (:MAPPING-STRINGS ("MIF.DMTF|Bus Port|004.8"))
                 (:P-UNIT "bit / second"))
                :INITFORM NIL)
               (CONTROLLERTIMEOUTS UINT32 :CIM-NAME "ControllerTimeouts"
                :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION "Note: The use of this method is deprecated. 
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (SIGNALCAPABILITIES (ARRAY UINT16) :CIM-NAME
                "SignalCapabilities" :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION "Note: The use of this method is deprecated. 
Deprecated description: Signal capabilities that can be supported by the SCSIController. For example, the Controller can support \"Single Ended\" and \"Differential\". In this case, the values 3 and 4 would be written to the Signal Capabilities array.")
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_SCSIInterface.SCSISignal")))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_SCSIController")
              (:QUALIFIERS (:DEPRECATED ("CIM_SCSIProtocolController"))
               (:VERSION "2.10.0")
