...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SCSIPathConfigurationService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SCSIPATHCONFIGURATIONSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_SCSIPathConfigurationService")
...
(DEFCIM-METHOD SETTPGACCESS
    ((INSTANCE CIM_SCSIPATHCONFIGURATIONSERVICE)
     (LOGICALUNIT "CIM_LogicalDevice" "LogicalUnit" :IN
      (:DESCRIPTION
       "A reference to an instances of a subclass of CIM_LogicalDevice representing the SCSI logical unit where the command will be sent."))
     (ACCESSSTATES (ARRAY UINT16) "AccessStates" :IN
      (:DESCRIPTION
       "An array of desired access states. Each access state in this array is the desired access state for the SCSITargetPortGroup in the corresponding entry in the TargetPortGroups parameter. 
...
Note that SCSITargetPortGroup.AccessState includes the value 'Transitioning' that is excluded here - a caller cannot request transitioning, though it can be reported by a target device.")
      ...
      (:VALUES
       ("Active/Optimized" "Active/Non-optimized" "StandBy" "Unavailable"
        "Active"))
      (:ARRAYTYPE "Indexed")
      (:MODEL-CORRESPONDENCE ("CIM_SCSITargetPortGroup.AccessState")))
     (TARGETPORTGROUPS "CIM_SCSITargetPortGroup" "TargetPortGroups" :IN
      (:DESCRIPTION
       "Array of references to instances of SCSITargetPortGroup. All the referenced TargetPortGroup instances must be part of the same target device.")
      (:ARRAYTYPE "Indexed")
      (:MODEL-CORRESPONDENCE ("CIM_SCSITargetPortGroup"))))
    ((:CIM-NAME "SetTPGAccess")
     (:QUALIFIERS
      (:DESCRIPTION
       "This method requests that the target change the access states of the requested SCSITargetPortGroups. This will have the effect of doing a failover or failback operation.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" ".." "4096" "4097" "4098" "4099" ".."
        "32768..65535"))
      (:VALUES
       ("Success" "Not Supported" "Unknown" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Unsupported AccessState"
        "Invalid SCSITargetPortGroup" "Unsupported AccessState combination"
        "Unsupported SCSITargetPortGroup combination" "Method Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD SETLOADBALANCEALGORITHM
    ((INSTANCE CIM_SCSIPATHCONFIGURATIONSERVICE)
     (LOADBALANCEALGORITHM UINT16 "LoadBalanceAlgorithm" :IN
      (:DESCRIPTION "The desired load balance algorithm.")
      (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6"))
      (:VALUES
       ("Unknown" "Other" "No Load Balancing" "Round Robin" "Least Blocks"
        "Least IO" "Product Specific")))
     (OTHERLOADBALANCEALGORITHMDESCRIPTION STRING
      "OtherLoadBalanceAlgorithmDescription" :IN
      (:DESCRIPTION
       "When LoadBalanceAlgorithm is 'Other', this parameter specifies a description of the load balancing algorithm. When LoadBalanceAlgorithm is 'Product Specific', this property provides a string specifying the vendor/product/version of the ManagedElement."))
     (LOGICALDEVICE "CIM_LogicalDevice" "LogicalDevice" :IN
      (:DESCRIPTION
       "A reference to the LogicalDevice subclass instance with an LogicalIdentity to the load balance RedundancySet. If SCSIMultipathConfigurationCapabilities. CanLoadBalanceLUsIndependently is true, just the referenced logical unit is modified. Otherwise, all logical units sharing the target are modified.")))
    ((:CIM-NAME "SetLoadBalanceAlgorithm")
     (:QUALIFIERS
      (:DESCRIPTION
       "This method requests that the target change the load balance algorithm for the referenced LogicalDevice instance.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" ".." "4096" "4097" ".." "32768..65535"))
      (:VALUES
       ("Success" "Not Supported" "Unknown" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Unsupported LogicalDevice"
        "Invalid LoadBalanceType" "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD ASSIGNLOGICALUNITTOPORTGROUP
    ((INSTANCE CIM_SCSIPATHCONFIGURATIONSERVICE)
     (LOGICALUNIT "CIM_LogicalDevice" "LogicalUnit" :IN
      (:DESCRIPTION
       "A reference to an instance of a subclass of LogicalDevice representing a SCSI logical unit."))
     (TARGETPORTGROUP "CIM_SCSITargetPortGroup" "TargetPortGroup" :IN
      (:DESCRIPTION
       "A reference to a target port group. The Target Port Group should be in an active state.")))
    ((:CIM-NAME "AssignLogicalUnitToPortGroup")
     (:QUALIFIERS
      (:DESCRIPTION
...
(DEFCIM-METHOD SETOVERRIDEPATH
    ((INSTANCE CIM_SCSIPATHCONFIGURATIONSERVICE)
     (PATH "CIM_SCSIInitiatorTargetLogicalUnitPath" "Path" :IN
      (:DESCRIPTION "A reference to a SCSIInitiatorTargetLogicalUnitPath.")))
    ((:CIM-NAME "SetOverridePath")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Success" "Not Supported" "Unknown" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Vendor Specific")))))
(DEFCIM-METHOD CANCELOVERRIDEPATH
    ((INSTANCE CIM_SCSIPATHCONFIGURATIONSERVICE)
     (LOGICALUNIT "CIM_LogicalDevice" "LogicalUnit" :IN
      (:DESCRIPTION "A reference to a SCSIInitiatorTargetLogicalUnitPath.")))
    ((:CIM-NAME "CancelOverridePath")
     (:QUALIFIERS
      (:DESCRIPTION
       "This method clears an override path as set in SetOverridePath and load balancing is enabled. All paths to the logical unit specified as a parameter will have AdministrativeOverride property set to 'No override in effect'.")
      (:VALUE-MAP ("0" "1" "2" "3" "4" "5" ".." "32768..65535"))
      (:VALUES
       ("Success" "Not Supported" "Unknown" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Vendor Specific")))))
