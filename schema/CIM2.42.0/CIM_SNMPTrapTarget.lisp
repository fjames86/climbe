...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SNMPTrapTarget.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SNMPTRAPTARGET (CIM_REMOTEPORT)
              ((ACCESSINFO STRING :CIM-NAME "AccessInfo" :QUALIFIERS
                ...
                :INITFORM NIL)
               (PORTPROTOCOL UINT16 :CIM-NAME "PortProtocol" :QUALIFIERS
                ...
                :INITFORM "3")
               (PORTINFO STRING :CIM-NAME "PortInfo" :QUALIFIERS
                ((:OVERRIDE "PortInfo")
                 (:DESCRIPTION
                  "The UDP port number to which the traps/informs are sent. The default is port 162.")
                 (:MODEL-CORRESPONDENCE ("CIM_RemotePort.PortProtocol")))
                :INITFORM "162")
               (NOTIFICATIONMESSAGE UINT16 :CIM-NAME "NotificationMessage"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Allows the selection of the notification message - Traps or Informs. By default, Traps are selected.")
                 (:VALUE-MAP ("1" "2")) (:VALUES ("Traps" "Informs")))
                :INITFORM "1")
               (SNMPVERSION UINT16 :CIM-NAME "SNMPVersion" :QUALIFIERS
                ((:DESCRIPTION
                  "The SNMP version used to send the traps or informs. Note that v1 does not support informs.")
                 (:VALUE-MAP ("1" "2" "3")) (:VALUES ("v1" "v2C" "v3")))
                :INITFORM NIL)
               (COMMUNITYSTRING STRING :CIM-NAME "CommunityString" :QUALIFIERS
                ((:DESCRIPTION
                  "A community string/password to send with the trap operation."))
                :INITFORM NIL)
               (OTHERPROTOCOLDESCRIPTION STRING :CIM-NAME
                "OtherProtocolDescription" :QUALIFIERS
                ((:DESCRIPTION
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_SNMPTrapTarget")
              (:QUALIFIERS (:VERSION "2.7.0")
               (:UML-PACKAGE-PATH "CIM::Network::SNMP")
               (:DESCRIPTION
                "SNMPTrapTarget contains information describing a remote system, to which Informs and Traps are sent. An SNMPService is related via a ServiceSAPDependency association to one or more instances of this class.")))
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_SNMPTRAPTARGET)
