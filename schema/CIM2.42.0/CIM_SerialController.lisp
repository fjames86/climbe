...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SerialController.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SERIALCONTROLLER (CIM_CONTROLLER)
              ((MAXBAUDRATE UINT32 :CIM-NAME "MaxBaudRate" :QUALIFIERS
                ((:DESCRIPTION
                  "Maximum baud rate in Bits per Second that is supported by the SerialController.")
                 (NIL "Bits per Second")
                 (:MAPPING-STRINGS ("MIF.DMTF|Serial Ports|004.6"))
                 (:P-UNIT "bit / second"))
                :INITFORM NIL)
               (SECURITY UINT16 :CIM-NAME "Security" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Other" "Unknown" "None" "External Interface Locked Out"
                   "External Interface Enabled" "Boot Bypass"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Serial Ports|004.9")))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (CAPABILITIES (ARRAY UINT16) :CIM-NAME "Capabilities"
                ...
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6" "160" "161"))
                 (:VALUES
                  ("Other" "Unknown" "XT/AT Compatible" "16450 Compatible"
                   "16550 Compatible" "16550A Compatible" "8251 Compatible"
                   "8251FIFO Compatible"))
                 (:ARRAYTYPE "Indexed")
                 (:MAPPING-STRINGS ("MIF.DMTF|Serial Ports|004.7"))
                 (:MODEL-CORRESPONDENCE
               ...
               (CAPABILITYDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE ("CIM_SerialController.Capabilities")))
                :INITFORM NIL)
