...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ServiceAccessURI.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SERVICEACCESSURI (CIM_SERVICEACCESSPOINT)
              ((LABELEDURI STRING :CIM-NAME "LabeledURI" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
