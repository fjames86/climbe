...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SettingCheck.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SETTINGCHECK (CIM_CHECK)
              ((SECTIONKEY STRING :CIM-NAME "SectionKey" :QUALIFIERS
                ((:DESCRIPTION
                  "Key or label for the section of the file containing the settings to be checked.")
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (ENTRYNAME STRING :CIM-NAME "EntryName" :QUALIFIERS
                ((:DESCRIPTION "Name of the setting entry to be checked.")
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (ENTRYVALUE STRING :CIM-NAME "EntryValue" :QUALIFIERS
                ((:DESCRIPTION "Value to be compared for the named entry."))
                :INITFORM NIL)
               (CHECKTYPE UINT16 :CIM-NAME "CheckType" :QUALIFIERS
                ((:DESCRIPTION
                  "CheckType specifies how the setting value should be compared.")
                 (:VALUE-MAP ("0" "1")) (:VALUES ("Matches" "Contains")))
                :INITFORM NIL)
