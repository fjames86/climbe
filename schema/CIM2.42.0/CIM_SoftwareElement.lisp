...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SoftwareElement.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SOFTWAREELEMENT (CIM_LOGICALELEMENT)
              ((NAME STRING :CIM-NAME "Name" :QUALIFIERS
               ...
               (VERSION STRING :CIM-NAME "Version" :QUALIFIERS
                (:KEY
                 ...
                 (:MAX-LEN "64")
                 (:MAPPING-STRINGS ("MIF.DMTF|SubComponent Software |001.4")))
                :INITFORM NIL)
...
- A SoftwareElement in the running state describes the details necessary to manage the started element.")
               ...
               (MANUFACTURER STRING :CIM-NAME "Manufacturer" :QUALIFIERS
                ((:DESCRIPTION "Manufacturer of this SoftwareElement.")
                 (:MAX-LEN "256")
                 (:MAPPING-STRINGS ("MIF.DMTF|SubComponent Software|001.3")))
                :INITFORM NIL)
