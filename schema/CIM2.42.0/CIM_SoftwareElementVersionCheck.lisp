...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SoftwareElementVersionCheck.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SOFTWAREELEMENTVERSIONCHECK (CIM_CHECK)
              ((SOFTWAREELEMENTNAME STRING :CIM-NAME "SoftwareElementName"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The name of the SoftwareElement being checked.")
                 (:MAX-LEN "256")
                 (:MODEL-CORRESPONDENCE ("CIM_SoftwareElement.Name")))
                :INITFORM NIL)
               (LOWERSOFTWAREELEMENTVERSION STRING :CIM-NAME
                "LowerSoftwareElementVersion" :QUALIFIERS
                ((:DESCRIPTION
                  "The minimum version of the SoftwareElement being checked.")
                 (:MAX-LEN "64")
                 (:MODEL-CORRESPONDENCE ("CIM_SoftwareElement.Version")))
                :INITFORM NIL)
               (UPPERSOFTWAREELEMENTVERSION STRING :CIM-NAME
                "UpperSoftwareElementVersion" :QUALIFIERS
                ((:DESCRIPTION
                  "The maximum version of the SoftwareElement being checked.")
                 (:MAX-LEN "64")
                 (:MODEL-CORRESPONDENCE ("CIM_SoftwareElement.Version")))
                :INITFORM NIL)
               (SOFTWAREELEMENTSTATEDESIRED UINT16 :CIM-NAME
                "SoftwareElementStateDesired" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (TARGETOPERATINGSYSTEMDESIRED UINT16 :CIM-NAME
                "TargetOperatingSystemDesired" :QUALIFIERS
                ((:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL))
              (:CIM-NAME "CIM_SoftwareElementVersionCheck")
...
(DEFCIM-METHOD INVOKE
    ((INSTANCE CIM_SOFTWAREELEMENTVERSIONCHECK))
    ((:CIM-NAME "Invoke")
     (:QUALIFIERS
      (:DESCRIPTION
