...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SoftwareInstallationService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SOFTWAREINSTALLATIONSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_SoftwareInstallationService")
...
(DEFCIM-METHOD CHECKSOFTWAREIDENTITY
    ((INSTANCE CIM_SOFTWAREINSTALLATIONSERVICE)
     (SOURCE "CIM_SoftwareIdentity" "Source" :IN
      (:DESCRIPTION "Reference to the SoftwareIdentity to be checked."))
     ...
     (COLLECTION "CIM_Collection" "Collection" :IN
      (:DESCRIPTION
       "Reference to the Collection to which the Software Identity will be added."))
     (INSTALLCHARACTERISTICS (ARRAY UINT16) "InstallCharacteristics" :IN :OUT
      (:DESCRIPTION
...
MAY be added to specified collection : The SoftwareIndentity MAY be added to specified Collection.")
      (:VALUE-MAP ("2" "3" "4" "5" "6" "7" "8" "9" ".." "0x7FFF..0xFFFF"))
      (:VALUES
       ("Target automatic reset" "System automatic reset"
        "Separate target reset Required" "Separate system reset Required"
        "Manual Reboot Required" "No Reboot Required"
        "User Intervention recommended" "MAY be added to specified Collection"
        "DMTF Reserved" "Vendor Specific"))))
    ((:CIM-NAME "CheckSoftwareIdentity")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" ".." "4096" "4097" "4098" "4099" "4100"
      ...
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unspecified Error"
        "Timeout" "Failed" "Invalid Parameter" "Target In Use" "DMTF Reserved"
        ...
        "Not enough disk space" "Software and target operating system mismatch"
        ...
        "Vendor Specific")))))
(DEFCIM-METHOD INSTALLFROMSOFTWAREIDENTITY
    ((INSTANCE CIM_SOFTWAREINSTALLATIONSERVICE)
     ...
     (INSTALLOPTIONS (ARRAY UINT16) "InstallOptions" :IN
...
AdministrativeMode: Perform the install or update of the software in the administrative mode. ScheduleInstallAt: Indicates the time at which theinstall or update of the software will occur.")
     ...
     (INSTALLOPTIONSVALUES (ARRAY STRING) "InstallOptionsValues" :IN
      (:DESCRIPTION
...
If the index in InstallOptions has the value \"Defer target/system reset\", \"Force installation\",\"Install\", \"Update\", \"Repair\" or \"Reboot\" then a value at the corresponding index of InstallOptionValues shall be NULL.")
    ...
    ((:CIM-NAME "InstallFromSoftwareIdentity")
     (:QUALIFIERS
      (:DESCRIPTION
...
If 0 is returned, the function completed successfully and no ConcreteJob instance was required. If 4096/0x1000 is returned, a ConcreteJob will be started to perform the install. The Job's reference will be returned in the output parameter Job.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" ".." "4096" "4097" "4098" "4099" "4100"
        "4101" "4102" "4103" "4104" "4105" "4106" "4107" "4108" "4109..32767"
        "32768..65535"))
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unspecified Error"
        "Timeout" "Failed" "Invalid Parameter" "Target In Use" "DMTF Reserved"
        "Method Parameters Checked - Job Started" "Unsupported TargetType"
        "Unattended/silent installation not supported"
        "Downgrade/reinstall not supported" "Not enough memory"
        "Not enough swap-space" "Unsupported version transition"
        "Not enough disk space" "Software and target operating system mismatch"
...
(DEFCIM-METHOD INSTALLFROMURI
    ((INSTANCE CIM_SOFTWAREINSTALLATIONSERVICE)
     (URI STRING "URI" :IN
      (:DESCRIPTION "A URI for the software based on RFC 2079."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION "Reference to the job (may be null if job completed)."))
     (TARGET "CIM_ManagedElement" "Target" :IN
...
If 0 is returned, the function completed successfully and no ConcreteJob instance was required. If 4096/0x1000 is returned, a ConcreteJob will be started to to perform the install. The Job's reference will be returned in the output parameter Job.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" ".." "4096" "4097" "4098" "4099" "4100"
        "4101" "4102" "4103" "4104" "4105" "4106" "4107" "4108..32767"
        "32768..65535"))
      (:VALUES
       ("Job Completed with No Error" "Not Supported" "Unspecified Error"
        "Timeout" "Failed" "Invalid Parameter" "Target In Use" "DMTF Reserved"
        ...
        "Not enough swap-space" "Unsupported version transition"
        "Not enough disk space" "Software and target operating system mismatch"
        "Missing dependencies" "Not applicable to target" "URI not accessible"
        "Method Reserved" "Vendor Specific")))))
