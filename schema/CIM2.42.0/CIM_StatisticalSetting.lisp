...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_StatisticalSetting.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_STATISTICALSETTING (CIM_SETTINGDATA)
              ((STARTSTATISTICTIME DATETIME :CIM-NAME "StartStatisticTime"
                ...
                (:WRITE
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_StatisticalData.StartStatisticTime")))
                :INITFORM NIL)
               (ENDSTATISTICTIME DATETIME :CIM-NAME "EndStatisticTime"
                :QUALIFIERS
                (:WRITE
                 (:DESCRIPTION
...
For DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_StatisticalSetting")
