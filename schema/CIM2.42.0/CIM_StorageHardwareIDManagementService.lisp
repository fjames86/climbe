...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_StorageHardwareIDManagementService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_STORAGEHARDWAREIDMANAGEMENTSERVICE
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_StorageHardwareIDManagementService")
...
(DEFCIM-METHOD CREATESTORAGEHARDWAREID
    ((INSTANCE CIM_STORAGEHARDWAREIDMANAGEMENTSERVICE)
     ...
     (IDTYPE UINT16 "IDType" :IN
      ...
      (:VALUE-MAP ("1" "2" "3" "4" "5" "7"))
      (:VALUES
       ("Other" "PortWWN" "NodeWWN" "Hostname" "iSCSI Name" "SAS Address"))
      (:MODEL-CORRESPONDENCE ("CIM_StorageHardwareID.IDType")))
     (OTHERIDTYPE STRING "OtherIDType" :IN
      (:DESCRIPTION "The type of the storage ID, when IDType is \"Other\"."))
     (SETTING "CIM_StorageClientSettingData" "Setting" :IN
      (:DESCRIPTION
     ...
     (HARDWAREID "CIM_StorageHardwareID" "HardwareID" :IN :OUT
      (:DESCRIPTION "REF to the new StorageHardwareID instance.")))
    ((:CIM-NAME "CreateStorageHardwareID")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..0xFFF" "0x1000" "0x1001" "0x1003..0x7FFF"
        "0x8000.."))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "ID already created"
        "Hardware implementation does not support specified IDType"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD DELETESTORAGEHARDWAREID
    ((INSTANCE CIM_STORAGEHARDWAREIDMANAGEMENTSERVICE)
     (HARDWAREID "CIM_StorageHardwareID" "HardwareID" :IN
      (:DESCRIPTION "The storage hardware ID to be deleted.")))
    ((:CIM-NAME "DeleteStorageHardwareID")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..0xFFF" "0x1000" "0x1001..0x7FFF"
        "0x8000.."))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Specified instance not found"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD CREATEGATEWAYPATHID
    ((INSTANCE CIM_STORAGEHARDWAREIDMANAGEMENTSERVICE)
     (ELEMENTNAME STRING "ElementName" :IN
      (:DESCRIPTION "The ElementName of the new StorageHardwareID instance."))
     (STORAGEID STRING "StorageID" :IN
     ...
     (GATEWAYIDTYPE UINT16 "GatewayIDType" :IN
      ...
      (:VALUE-MAP ("1" "2" "3" "4" "5"))
      (:VALUES ("Other" "PortWWN" "NodeWWN" "Hostname" "iSCSI Name")))
     (OTHERGATEWAYIDTYPE STRING "OtherGatewayIDType" :IN
      (:DESCRIPTION
       "The type of the storage ID, when GatewayIDType is \"Other\"."))
     (NEWGATEWAYPATHID "CIM_GatewayPathID" "NewGatewayPathID" :IN :OUT
      (:DESCRIPTION "REF to the new GatewayPathID instance.")))
    ((:CIM-NAME "CreateGatewayPathID")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..0xFFF" "0x1000" "0x1001" "0x1003" "0x1004"
        "0x1005..0x7FFF" "0x8000.."))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "ID already created"
        "Hardware implementation does not support specified IDType"
        ...
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD CREATEHARDWAREIDCOLLECTION
    ((INSTANCE CIM_STORAGEHARDWAREIDMANAGEMENTSERVICE)
     (ELEMENTNAME STRING "ElementName" :IN
      (:DESCRIPTION
       "The ElementName to be assigned to the created collection."))
     (COLLECTION "CIM_SystemSpecificCollection" "Collection" :IN :OUT
      (:DESCRIPTION
       "The new instance of SystemSpecificCollection that is created."))
     (HARDWAREIDS (ARRAY STRING) "HardwareIDs" :IN
      (:DESCRIPTION
    ...
    ((:CIM-NAME "CreateHardwareIDCollection")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6..0xFFF" "0x1000" "0x1001" "0x1002"
        "0x1003..0x7FFF" "0x8000.."))
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        "Invalid Parameter" "DMTF Reserved" "Invalid HardwareID instance"
        "Implementation does not support hardware ID collections"
        "Input hardware IDs cannot be used in same collection"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD ADDHARDWAREIDSTOCOLLECTION
    ((INSTANCE CIM_STORAGEHARDWAREIDMANAGEMENTSERVICE)
     (COLLECTION "CIM_SystemSpecificCollection" "Collection" :IN
      (:DESCRIPTION "The Collection which groups the StorageHardwareIDs."))
     (HARDWAREIDS (ARRAY STRING) "HardwareIDs" :IN
      (:DESCRIPTION
    ...
    ((:CIM-NAME "AddHardwareIDsToCollection")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Success" "Not Supported" "Unspecified Error" "Timeout" "Failed"
        ...
        "Input devices cannot be used in this collection" "Method Reserved"
        "Vendor Specific")))))
