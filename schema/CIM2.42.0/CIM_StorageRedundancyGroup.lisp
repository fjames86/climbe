...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_StorageRedundancyGroup.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_STORAGEREDUNDANCYGROUP (CIM_REDUNDANCYGROUP)
              ((TYPEOFALGORITHM UINT16 :CIM-NAME "TypeOfAlgorithm" :QUALIFIERS
                ((:DEPRECATED ("CIM_StorageRedundancySet.TypeOfAlgorithm"))
                 ...
                 (:VALUES
                  ("None" "Other" "Unknown" "Copy" "XOR" "P+Q" "S" "P+S"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Redundancy Group|001.2")))
                :INITFORM NIL)
               (STORAGEREDUNDANCY UINT16 :CIM-NAME "StorageRedundancy"
                :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION
                 ...
                 (:VALUES
                  ("No Additional Status" "Reconfig In Progress" "Data Lost"
                   "Not Currently Configured" "Protected Rebuild"
                   "Redundancy Disabled" "Unprotected Rebuild" "Recalculating"
                   "Verifying")))
                :INITFORM NIL)
               (ISSTRIPED BOOLEAN :CIM-NAME "IsStriped" :QUALIFIERS
               ...
               (REDUNDANCYSTATUS UINT16 :CIM-NAME "RedundancyStatus"
                ...
                ((:DEPRECATED ("CIM_RedundancySet.RedundancyStatus"))
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "Other" "Fully Redundant" "Degraded Redundancy"
                   "Redundancy Lost")))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_StorageRedundancyGroup")
              (:QUALIFIERS (:DEPRECATED ("CIM_StorageRedundancySet"))
