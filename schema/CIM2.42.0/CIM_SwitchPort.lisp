...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SwitchPort.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SWITCHPORT (CIM_PROTOCOLENDPOINT)
              ((PORTNUMBER UINT16 :CIM-NAME "PortNumber" :QUALIFIERS
                ((:DESCRIPTION "Numeric identifier for a switch port.")
                 (:MAPPING-STRINGS ("MIB.IETF|BRIDGE-MIB.dot1dPort")))
                :INITFORM NIL)
