...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SwitchService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SWITCHSERVICE (CIM_FORWARDINGSERVICE)
              ((BRIDGEADDRESS STRING :CIM-NAME "BridgeAddress" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAX-LEN "32")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|BRIDGE-MIB.dot1dBaseBridgeAddress"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_SwitchService.BridgeAddressType")))
                :INITFORM NIL)
               (NUMPORTS UINT16 :CIM-NAME "NumPorts" :QUALIFIERS
                ((:DESCRIPTION
                  "The number of switch ports controlled by this switching service.")
                 (:MAPPING-STRINGS ("MIB.IETF|BRIDGE-MIB.dot1dBaseNumPorts")))
                :INITFORM NIL)
               (BRIDGETYPE UINT8 :CIM-NAME "BridgeType" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates what type of switching service can be performed.")
                 (:VALUE-MAP ("1" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "Transparent-only" "SourceRoute-only" "SRT"))
                 (:MAPPING-STRINGS ("MIB.IETF|BRIDGE-MIB.dot1dBaseType")))
                :INITFORM NIL)
               (BRIDGEADDRESSTYPE UINT16 :CIM-NAME "BridgeAddressType"
                :QUALIFIERS
                ((:DESCRIPTION
                  "BridgeAddressType defines the type of addressing scheme used for this Bridge and its BridgeAddress property.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Other" "IPv4" "IPv6" "MAC" "MAC + Spanning Tree Priority"))
                 (:MODEL-CORRESPONDENCE ("CIM_SwitchService.BridgeAddress")))
                :INITFORM NIL)
