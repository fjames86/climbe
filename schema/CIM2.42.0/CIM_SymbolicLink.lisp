...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SymbolicLink.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SYMBOLICLINK (CIM_LOGICALFILE)
              ((TARGETFILE STRING :CIM-NAME "TargetFile" :QUALIFIERS
                (:REQUIRED
