...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_SystemSetting.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_SYSTEMSETTING (CIM_SETTING)
              ((SYSTEMCREATIONCLASSNAME STRING :CIM-NAME
               ...
               (SETTINGID STRING :CIM-NAME "SettingID" :QUALIFIERS
                (:KEY (:OVERRIDE "SettingID") (:MAX-LEN "256")
                 (:DESCRIPTION
