...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Tachometer.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_TACHOMETER (CIM_NUMERICSENSOR)
              ((SENSORTYPE UINT16 :CIM-NAME "SensorType" :QUALIFIERS
               ...
               (RESOLUTION UINT32 :CIM-NAME "Resolution" :QUALIFIERS
                ((:DEPRECATED ("No value")) (:OVERRIDE "Resolution")
                 (NIL "Tenths of Revolutions per Minute")
                 (:P-UNIT "revolution / minute * 10^-1")
                 (:DESCRIPTION
