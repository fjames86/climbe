...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_TapeDrive.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_TAPEDRIVE (CIM_MEDIAACCESSDEVICE)
              ((EOTWARNINGZONESIZE UINT32 :CIM-NAME "EOTWarningZoneSize"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MAXPARTITIONCOUNT UINT32 :CIM-NAME "MaxPartitionCount"
                :QUALIFIERS
                ((:DESCRIPTION "Maximum partition count for the TapeDrive."))
                :INITFORM NIL)
               (PADDING UINT32 :CIM-NAME "Padding" :QUALIFIERS
                ((:DESCRIPTION
                  "Padding indicates the number of bytes inserted between blocks on a tape Media.")
                 (NIL "Bytes") (:P-UNIT "byte"))
                :INITFORM NIL)
               (MAXREWINDTIME UINT64 :CIM-NAME "MaxRewindTime" :QUALIFIERS
                ((:DESCRIPTION
