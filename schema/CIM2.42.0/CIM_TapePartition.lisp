...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_TapePartition.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_TAPEPARTITION (CIM_MEDIAPARTITION)
              ((NAMEFORMAT UINT16 :CIM-NAME "NameFormat" :QUALIFIERS
                ((:OVERRIDE "NameFormat")
                 (:DESCRIPTION "TapePartition names are application specific.")
                 (:VALUE-MAP ("0" "1")) (:VALUES ("Other" "Unknown"))
               ...
               (NAMENAMESPACE UINT16 :CIM-NAME "NameNamespace" :QUALIFIERS
                ...
                :INITFORM "1")
               (UNUSEDBLOCKS UINT64 :CIM-NAME "UnusedBlocks" :QUALIFIERS
                ((:DESCRIPTION
