...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_TelnetProtocolEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_TELNETPROTOCOLENDPOINT (CIM_PROTOCOLENDPOINT)
              ((TERMINALMODE UINT16 :CIM-NAME "TerminalMode" :QUALIFIERS
               ...
               (OTHERTERMINALMODE STRING :CIM-NAME "OtherTerminalMode"
                ...
                (:WRITE
                 (:DESCRIPTION
                  "Where the TerminalMode property contains a value of 1, \"Other\" then this is a free form string providing more information about the current terminal mode and this value shall be one of the values in OtherEnabledTerminalModes. If not set to 1, this string has no meaning.")
                 (:MODEL-CORRESPONDENCE
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (ENABLEDTERMINALMODES (ARRAY UINT16) :CIM-NAME
                ...
                ((:DESCRIPTION
                  "An array of integers indicating the terminal modes that are enabled for use in this server connection. Additional terminal modes may be supported by the service but not enabled for use.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4..32767" "32768..65535"))
                 (:VALUES
                  ("Unknown" "Other" "VT100" "ANSI" "DMTF Reserved"
                   "Vendor Reserved"))
               ...
               (OTHERENABLEDTERMINALMODE (ARRAY STRING) :CIM-NAME
                ...
                ((:DESCRIPTION
                  "If the EnabledTerminalModes property is set to 1, \"Other\" then free form string providing more information about supported terminal mode. If not set to 1, this string has no meaning.")
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_TelnetProtocolEndpoint.EnabledTerminalModes")))
                :INITFORM NIL)
               (ENABLEDCHARACTERDISPLAYMODES (ARRAY UINT16) :CIM-NAME
                ...
                (:WRITE
                 (:DESCRIPTION
                  "An array of integers indicating the character display modes enabled for the service. Additional character display modes may be supported but currently not enabled for use.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4..32767" "32768..65535"))
                 (:VALUES
                  ("Unknown" "Other" "Console" "Stream" "DMTF Reserved"
                   "Vendor Reserved"))
               ...
               (OTHERENABLEDCHARACTERDISPLAYMODE (ARRAY STRING) :CIM-NAME
                ...
                ((:DESCRIPTION
                  "If the EnabledCharacterDisplayModes property is set to 1, \"Other\" then free form string providing more information about the enabled mode. If not set to 1, this string has no meaning.")
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_TelnetProtocolEndpoint.EnabledCharacterDisplayModes")))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_TelnetProtocolEndpoint")
...
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_TELNETPROTOCOLENDPOINT)
