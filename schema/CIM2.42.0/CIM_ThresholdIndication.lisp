...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_ThresholdIndication.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_THRESHOLDINDICATION (CIM_ALERTINDICATION)
              ((THRESHOLDIDENTIFIER STRING :CIM-NAME "ThresholdIdentifier"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (THRESHOLDVALUE STRING :CIM-NAME "ThresholdValue" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("Recommendation.ITU|X733.Threshold information")))
                :INITFORM NIL)
               (OBSERVEDVALUE STRING :CIM-NAME "ObservedValue" :QUALIFIERS
                ((:DESCRIPTION
...
When retrying the delivery of an indication, this property shall have the same value as in the original delivery.")
               ...
               (CORRELATEDINDICATIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_ThresholdIndication")
              (:QUALIFIERS :INDICATION (:VERSION "2.6.0")
