...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_TokenBucketMeterService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_TOKENBUCKETMETERSERVICE (CIM_METERSERVICE)
              ((AVERAGERATE UINT32 :CIM-NAME "AverageRate" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PEAKRATE UINT32 :CIM-NAME "PeakRate" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "KiloBits per Second"))
                :INITFORM NIL)
               (BURSTSIZE UINT32 :CIM-NAME "BurstSize" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "KiloBytes"))
                :INITFORM NIL)
               (EXCESSBURSTSIZE UINT32 :CIM-NAME "ExcessBurstSize" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "KiloBytes"))
                :INITFORM NIL)
               (METERTYPE UINT16 :CIM-NAME "MeterType" :QUALIFIERS
                ((:DESCRIPTION
...
Note: The MeterType property and the MeterService subclasses provide similar information. This property is defined for query purposes and for future expansion. It is assumed that not all MeterServices will require a subclass to define them. Therefore, MeterService will be instantiated directly and the Type property is needed.")
                 (:VALUE-MAP ("1" "2" "3" "4"))
                 (:VALUES
                  ("Other" "Average Rate Meter"
                   "Exponentially Weighted Moving Average Meter"
                   "Token Bucket Meter"))
                 (:MODEL-CORRESPONDENCE ("CIM_MeterService.OtherMeterType")))
                :INITFORM NIL)
               (OTHERMETERTYPE STRING :CIM-NAME "OtherMeterType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_MeterService.MeterType")))
                :INITFORM NIL)
               (CONFORMANCELEVELS UINT16 :CIM-NAME "ConformanceLevels"
                :QUALIFIERS
                ((:DESCRIPTION
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_TokenBucketMeterService")
...
(DEFCIM-METHOD STARTSERVICE
    ((INSTANCE CIM_TOKENBUCKETMETERSERVICE))
