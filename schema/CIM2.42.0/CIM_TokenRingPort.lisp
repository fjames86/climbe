...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_TokenRingPort.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_TOKENRINGPORT (CIM_NETWORKPORT)
              ((MAXDATASIZE UINT32 :CIM-NAME "MaxDataSize" :QUALIFIERS
                ...
                :INITFORM NIL)
               (RINGSTATUS UINT32 :CIM-NAME "RingStatus" :QUALIFIERS
                ((:DESCRIPTION
...
0 = No Problems Detected, 32 = Ring Recovery, 64 = Single Station, 256 = Remove Received, 512 = Reserved, 1024 = Auto-Removal Error, 2048 = Lobe Wire Fault, 4096 = Transmit Beacon, 8192 = Soft Error, 16384 = Hard Error, 32768 = Signal Loss, 131072 = No Status, Open Not Completed.")
                ...
                :INITFORM NIL)
               (RINGSTATE UINT16 :CIM-NAME "RingState" :QUALIFIERS
                ((:DESCRIPTION
                  "The current Device state with respect to entering or leaving the ring.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5"))
                 (:VALUES
                  ("Opened" "Closed" "Opening" "Closing" "Open Failure"
                   "Ring Failure"))
                 (:MAPPING-STRINGS
                  ("MIB.IETF|IEEE 802.5 Token Ring MIB.dot5RingState")))
                :INITFORM NIL)
               (RINGOPENSTATUS UINT16 :CIM-NAME "RingOpenStatus" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("No Open Attempted" "Bad Parameter" "Lobe Failed"
                ...
                :INITFORM NIL)
               (RINGSPEED UINT16 :CIM-NAME "RingSpeed" :QUALIFIERS
                ((:DESCRIPTION "The bandwidth of the ring.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "Other" "One Megabit" "Four Megabit"
                   "Sixteen Megabit"))
                 (:MAPPING-STRINGS
...
Deprecated description: The type of module, when PortType is set to 1 (\"Other\".)")
               ...
               (PORTTYPE UINT16 :CIM-NAME "PortType" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3..15999" "16000..65535"))
                 (:VALUES
                  ("Unknown" "Other" "Not Applicable" "DMTF Reserved"
                   "Vendor Reserved"))
                 (:MODEL-CORRESPONDENCE
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (CAPABILITYDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE ("CIM_TokenRingPort.Capabilities")))
                :INITFORM NIL)
               (ENABLEDCAPABILITIES (ARRAY UINT16) :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_TokenRingPort.Capabilities"
               ...
               (OTHERENABLEDCAPABILITIES (ARRAY STRING) :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:ARRAYTYPE "Indexed")
                 (:MODEL-CORRESPONDENCE
                  ("CIM_TokenRingPort.EnabledCapabilities")))
                :INITFORM NIL)
