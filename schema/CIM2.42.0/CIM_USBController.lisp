...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_USBController.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_USBCONTROLLER (CIM_CONTROLLER)
              ((USBVERSION UINT16 :CIM-NAME "USBVersion" :QUALIFIERS
                ...
                :INITFORM NIL)
               (INTERFACETYPE UINT16 :CIM-NAME "InterfaceType" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (CONTROLLERVERSION UINT16 :CIM-NAME "ControllerVersion"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_USBController.InterfaceType")))
                :INITFORM NIL)
