...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_USBHub.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_USBHUB (CIM_USBDEVICE)
              ((GANGSWITCHED BOOLEAN :CIM-NAME "GangSwitched" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (NUMBEROFPORTS UINT8 :CIM-NAME "NumberOfPorts" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (USBVERSION UINT16 :CIM-NAME "USBVersion" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (CLASSCODE UINT8 :CIM-NAME "ClassCode" :QUALIFIERS
                ...
                :INITFORM NIL)
               (SUBCLASSCODE UINT8 :CIM-NAME "SubclassCode" :QUALIFIERS
                ...
                :INITFORM NIL)
               (PROTOCOLCODE UINT8 :CIM-NAME "ProtocolCode" :QUALIFIERS
                ...
                :INITFORM NIL)
               (USBVERSIONINBCD UINT16 :CIM-NAME "USBVersionInBCD" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MAXPACKETSIZE UINT8 :CIM-NAME "MaxPacketSize" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (VENDORID UINT16 :CIM-NAME "VendorID" :QUALIFIERS
                ...
                :INITFORM NIL)
               (PRODUCTID UINT16 :CIM-NAME "ProductID" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DEVICERELEASENUMBER UINT16 :CIM-NAME "DeviceReleaseNumber"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (MANUFACTURER STRING :CIM-NAME "Manufacturer" :QUALIFIERS
                ...
                :INITFORM NIL)
               (PRODUCT STRING :CIM-NAME "Product" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (SERIALNUMBER STRING :CIM-NAME "SerialNumber" :QUALIFIERS
                ...
                :INITFORM NIL)
               (NUMBEROFCONFIGS UINT8 :CIM-NAME "NumberOfConfigs" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (CURRENTCONFIGVALUE UINT8 :CIM-NAME "CurrentConfigValue"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (COMMANDTIMEOUT DATETIME :CIM-NAME "CommandTimeout" :QUALIFIERS
                ((:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (CURRENTALTERNATESETTINGS (ARRAY UINT8) :CIM-NAME
                "CurrentAlternateSettings" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_USBDevice.CurrentConfigValue")))
                :INITFORM NIL)
...
(DEFCIM-METHOD GETDESCRIPTOR
    ((INSTANCE CIM_USBHUB)
     (REQUESTTYPE UINT8 "RequestType" :IN
      (:DESCRIPTION
     ...
     (REQUESTVALUE UINT16 "RequestValue" :IN
      (:DESCRIPTION
     ...
     (REQUESTINDEX UINT16 "RequestIndex" :IN
      (:DESCRIPTION
     ...
     (REQUESTLENGTH UINT16 "RequestLength" :IN :OUT
      (:DESCRIPTION
     ...
     (BUFFER (ARRAY UINT8) "Buffer" :IN :OUT
      (:DESCRIPTION
