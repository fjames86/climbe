...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_USBPort.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_USBPORT (CIM_LOGICALPORT)
              ((SPEED UINT64 :CIM-NAME "Speed" :QUALIFIERS
                ((:OVERRIDE "Speed")
                 ...
                 (:VALUE-MAP ("0" "1" "1500000" "12000000"))
               ...
               (AVAILABILITY UINT16 :CIM-NAME "Availability" :QUALIFIERS
                ...
                :INITFORM NIL)
               (POWER UINT16 :CIM-NAME "Power" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (SUSPENDED BOOLEAN :CIM-NAME "Suspended" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates whether the Port is currently Suspended."))
                :INITFORM NIL)
               (OVERCURRENT BOOLEAN :CIM-NAME "Overcurrent" :QUALIFIERS
                ((:DESCRIPTION
