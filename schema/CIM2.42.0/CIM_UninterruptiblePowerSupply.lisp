...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UninterruptiblePowerSupply.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNINTERRUPTIBLEPOWERSUPPLY (CIM_POWERSUPPLY)
              ((RANGE1INPUTVOLTAGELOW UINT32 :CIM-NAME "Range1InputVoltageLow"
                :QUALIFIERS
                ((:OVERRIDE "Range1InputVoltageLow")
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.7")))
                :INITFORM NIL)
               (RANGE1INPUTVOLTAGEHIGH UINT32 :CIM-NAME
                "Range1InputVoltageHigh" :QUALIFIERS
                ((:OVERRIDE "Range1InputVoltageHigh")
                 ...
                 (NIL "MilliVolts") (:P-UNIT "volt * 10^-3")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.8")))
                :INITFORM NIL)
               (RANGE2INPUTVOLTAGELOW UINT32 :CIM-NAME "Range2InputVoltageLow"
                :QUALIFIERS
                ((:OVERRIDE "Range2InputVoltageLow")
                 ...
                 (NIL "MilliVolts") (:P-UNIT "volt * 10^-3")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.11")))
                :INITFORM NIL)
               (RANGE2INPUTVOLTAGEHIGH UINT32 :CIM-NAME
                "Range2InputVoltageHigh" :QUALIFIERS
                ((:OVERRIDE "Range2InputVoltageHigh")
                 ...
                 (NIL "MilliVolts") (:P-UNIT "volt * 10^-3")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.12")))
                :INITFORM NIL)
               (REMAININGCAPACITYSTATUS UINT16 :CIM-NAME
                "RemainingCapacityStatus" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|UPS Battery|001.1")))
                :INITFORM NIL)
               (TIMEONBACKUP UINT32 :CIM-NAME "TimeOnBackup" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Seconds")
                 (:MAPPING-STRINGS ("MIF.DMTF|UPS Battery|001.2"))
                 (:P-UNIT "second"))
                :INITFORM NIL)
               (ESTIMATEDRUNTIME UINT32 :CIM-NAME "EstimatedRunTime"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Minutes")
                 (:MAPPING-STRINGS ("MIF.DMTF|UPS Battery|001.3"))
                 (:P-UNIT "minute"))
                :INITFORM NIL)
               (ESTIMATEDCHARGEREMAINING UINT16 :CIM-NAME
                "EstimatedChargeRemaining" :QUALIFIERS
                ((:DESCRIPTION
                  "An estimate of the percentage of full charge remaining for a UPS (that uses battery technology).")
                 (NIL "Percent") :GAUGE
                 (:MAPPING-STRINGS ("MIF.DMTF|UPS Battery|001.4"))
                 (:P-UNIT "percent"))
                :INITFORM NIL)
               (ISSWITCHINGSUPPLY BOOLEAN :CIM-NAME "IsSwitchingSupply"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating that the PowerSupply is a switching (instead of linear) supply."))
                :INITFORM NIL)
               (RANGE1INPUTFREQUENCYLOW UINT32 :CIM-NAME
                "Range1InputFrequencyLow" :QUALIFIERS
                ((:DESCRIPTION
                  "The frequency (in hertz) at the low end of the Input Frequency Range 1 of this Power Supply. A value of 0 implies DC.")
                 (NIL "Hertz")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.17"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (RANGE1INPUTFREQUENCYHIGH UINT32 :CIM-NAME
                "Range1InputFrequencyHigh" :QUALIFIERS
                ((:DESCRIPTION
                  "The frequency (in hertz) at the high end of the Input Frequency Range 1 of this Power Supply. A value of 0 implies DC.")
                 (NIL "Hertz")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.18"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (RANGE2INPUTFREQUENCYLOW UINT32 :CIM-NAME
                "Range2InputFrequencyLow" :QUALIFIERS
                ((:DESCRIPTION
                  "The frequency (in hertz) at the low end of the Input Frequency Range 2 of this Power Supply. A value of 0 implies DC.")
                 (NIL "Hertz")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.19"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (RANGE2INPUTFREQUENCYHIGH UINT32 :CIM-NAME
                "Range2InputFrequencyHigh" :QUALIFIERS
                ((:DESCRIPTION
                  "The frequency (in hertz) at the high end of the Input Frequency Range 2 of this Power Supply. A value of 0 implies DC.")
                 (NIL "Hertz")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.20"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (ACTIVEINPUTVOLTAGE UINT16 :CIM-NAME "ActiveInputVoltage"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("Other" "Unknown" "Range 1" "Range 2" "Both" "Neither"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.15")))
                :INITFORM NIL)
               (TYPEOFRANGESWITCHING UINT16 :CIM-NAME "TypeOfRangeSwitching"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("1" "2" "3" "4" "5" "6"))
                 (:VALUES
                  ("Other" "Unknown" "Manual" "Autoswitch" "Wide Range"
                   "Not Applicable"))
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.16")))
                :INITFORM NIL)
               (TOTALOUTPUTPOWER UINT32 :CIM-NAME "TotalOutputPower"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Represents the total output power of the PowerSupply in milliWatts. 0 denotes 'unknown'.")
                 (NIL "MilliWatts")
                 (:MAPPING-STRINGS ("MIF.DMTF|Power Supply|004.21"))
                 (:P-UNIT "watt * 10^-3"))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_UninterruptiblePowerSupply")
...
(DEFCIM-METHOD SETPOWERSTATE
    ((INSTANCE CIM_UNINTERRUPTIBLEPOWERSUPPLY)
