...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UnitOfWorkDefinition.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNITOFWORKDEFINITION (CIM_LOGICALELEMENT)
              ((NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:OVERRIDE "Name")
                 ...
                 (:MAX-LEN "1024"))
                :INITFORM NIL)
               (CONTEXT STRING :CIM-NAME "Context" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (ID STRING :CIM-NAME "Id" :QUALIFIERS
                (:KEY
                 ...
                 (:MAX-LEN "16"))
                :INITFORM NIL)
               (TRACELEVELTYPEID STRING :CIM-NAME "TraceLevelTypeId"
                :QUALIFIERS
                ((:DESCRIPTION
...
If the string is empty no traces are expected to be produced. If the string is not empty, an associated instance of TraceLevelType may be attached to the UnitOfWorkDefinition instance. Still, it is useful to incorporate TraceLevelTypeId into UnitOfWorkDefinition, to relate to an instance of TraceLevelType. The management application can more easily detect different trace level types.")
                 (:MAX-LEN "16")
                 (:MODEL-CORRESPONDENCE ("CIM_TraceLevelType.InstanceID")))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_UnitOfWorkDefinition")
