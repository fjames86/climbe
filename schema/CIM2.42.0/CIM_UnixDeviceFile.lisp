...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UnixDeviceFile.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNIXDEVICEFILE (CIM_DEVICEFILE)
              ((DEVICEFILETYPE UINT16 :CIM-NAME "DeviceFileType" :QUALIFIERS
               ...
               (OTHERTYPEDESCRIPTION STRING :CIM-NAME "OtherTypeDescription"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_UnixDeviceFile.DeviceFileType")))
                :INITFORM NIL)
               (DEVICEID STRING :CIM-NAME "DeviceId" :QUALIFIERS
                ...
                :INITFORM NIL)
               (DEVICEDESCRIPTION STRING :CIM-NAME "DeviceDescription"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DEVICEMAJOR STRING :CIM-NAME "DeviceMajor" :QUALIFIERS
                (:REQUIRED (:DESCRIPTION "The Device's Major Id.")) :INITFORM
                NIL)
               (DEVICEMINOR STRING :CIM-NAME "DeviceMinor" :QUALIFIERS
                (:REQUIRED (:DESCRIPTION "The Device's Minor Id.")) :INITFORM
                NIL)
               (CSCREATIONCLASSNAME STRING :CIM-NAME "CSCreationClassName"
                ...
                (:KEY
                 ...
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_FileSystem.CSCreationClassName"))
                :INITFORM NIL)
               (CSNAME STRING :CIM-NAME "CSName" :QUALIFIERS
                (:KEY (:DESCRIPTION "The scoping ComputerSystem's Name.")
                 (:MAX-LEN "256") (:PROPOGATED "CIM_FileSystem.CSName"))
                :INITFORM NIL)
               (FSCREATIONCLASSNAME STRING :CIM-NAME "FSCreationClassName"
                ...
                (:KEY
                 ...
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_FileSystem.CreationClassName"))
                :INITFORM NIL)
               (FSNAME STRING :CIM-NAME "FSName" :QUALIFIERS
                (:KEY (:DESCRIPTION "The scoping FileSystem's Name.")
                 (:MAX-LEN "256") (:PROPOGATED "CIM_FileSystem.Name"))
                :INITFORM NIL)
               ...
               (FILESIZE UINT64 :CIM-NAME "FileSize" :QUALIFIERS
                ((:DESCRIPTION "Size of the File in bytes.") (NIL "Bytes")
                 :GAUGE (:P-UNIT "byte"))
                :INITFORM NIL)
               (CREATIONDATE DATETIME :CIM-NAME "CreationDate" :QUALIFIERS
                ((:DESCRIPTION "File's creation date.")) :INITFORM NIL)
               (LASTMODIFIED DATETIME :CIM-NAME "LastModified" :QUALIFIERS
               ...
               (LASTACCESSED DATETIME :CIM-NAME "LastAccessed" :QUALIFIERS
                ...
                :INITFORM NIL)
               (READABLE BOOLEAN :CIM-NAME "Readable" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating that the File can be read."))
                :INITFORM NIL)
               (WRITEABLE BOOLEAN :CIM-NAME "Writeable" :QUALIFIERS
                ((:DESCRIPTION
                  "Boolean indicating that the File can be written."))
                :INITFORM NIL)
               (EXECUTABLE BOOLEAN :CIM-NAME "Executable" :QUALIFIERS
                ((:DESCRIPTION "Indicates the file is executable.")) :INITFORM
                NIL)
               ...
               (ENCRYPTIONMETHOD STRING :CIM-NAME "EncryptionMethod"
                ...
                :INITFORM NIL)
               (INUSECOUNT UINT64 :CIM-NAME "InUseCount" :QUALIFIERS
                ((:DESCRIPTION
