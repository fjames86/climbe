...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UnixDirectory.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNIXDIRECTORY (CIM_DIRECTORY)
              ((FILESIZEBITS UINT64 :CIM-NAME "FileSizeBits" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "Bits") (:MIN-VALUE "32")
                 (:MAPPING-STRINGS ("POSIX.TOG|pathconf|_PC_FILESIZEBITS"))
                 (:P-UNIT "bit"))
                :INITFORM NIL)
