...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UnixLocalFileSystem.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNIXLOCALFILESYSTEM (CIM_LOCALFILESYSTEM)
              ((FREEINODES UINT64 :CIM-NAME "FreeInodes" :QUALIFIERS
                ((:DESCRIPTION
                  "The number of free inodes present in the file system. This value is only valid if TotalSlots is non-zero.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Host File System|001.12"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_UnixLocalFileSystem.TotalInodes")))
                :INITFORM NIL)
               (TOTALINODES UINT64 :CIM-NAME "TotalInodes" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Host File System|001.11")))
                :INITFORM NIL)
               (FSRESERVEDCAPACITY UINT64 :CIM-NAME "FSReservedCapacity"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The reserve data capacity of the file system in bytes.")
                 (NIL "Bytes")
                 (:MAPPING-STRINGS ("MIF.DMTF|Host File System|001.15"))
                 (:P-UNIT "byte"))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_UnixLocalFileSystem")
...
(DEFCIM-METHOD REQUESTSTATECHANGE
    ((INSTANCE CIM_UNIXLOCALFILESYSTEM)
