...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UnixProcess.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNIXPROCESS (CIM_PROCESS)
              ((PARENTPROCESSID STRING :CIM-NAME "ParentProcessID" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
                  "The parent process ID of this executing process.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.2")))
                :INITFORM NIL)
               (REALUSERID UINT64 :CIM-NAME "RealUserID" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
                  "The Real User ID of this currently executing process.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.4")))
                :INITFORM NIL)
               (PROCESSGROUPID UINT64 :CIM-NAME "ProcessGroupID" :QUALIFIERS
                (:REQUIRED
                 (:DESCRIPTION
                  "The Group ID of this currently executing process.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.2")))
                :INITFORM NIL)
               (PROCESSSESSIONID UINT64 :CIM-NAME "ProcessSessionID"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (PROCESSTTY STRING :CIM-NAME "ProcessTTY" :QUALIFIERS
                ((:DESCRIPTION
                  "The TTY currently associated with this process.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.5")))
                :INITFORM NIL)
               (MODULEPATH STRING :CIM-NAME "ModulePath" :QUALIFIERS
                ((:DESCRIPTION "The executing process's command path.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.7")))
                :INITFORM NIL)
               (PROCESSNICEVALUE UINT32 :CIM-NAME "ProcessNiceValue"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The process's 'nice' value. A process 'nice' value of 0 reflects high priority, while increasing values reflect lower priorities.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.11")))
                :INITFORM NIL)
               (PROCESSWAITINGFOREVENT STRING :CIM-NAME
                "ProcessWaitingForEvent" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_Process.ExecutionState")))
                :INITFORM NIL)
               (CSCREATIONCLASSNAME STRING :CIM-NAME "CSCreationClassName"
                ...
                (:KEY
                 ...
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_OperatingSystem.CSCreationClassName"))
                :INITFORM NIL)
               (CSNAME STRING :CIM-NAME "CSName" :QUALIFIERS
                (:KEY (:DESCRIPTION "The scoping ComputerSystem's Name.")
                 (:MAX-LEN "256") (:PROPOGATED "CIM_OperatingSystem.CSName"))
                :INITFORM NIL)
               (OSCREATIONCLASSNAME STRING :CIM-NAME "OSCreationClassName"
                ...
                (:KEY
                 ...
                 (:MAX-LEN "256")
                 (:PROPOGATED "CIM_OperatingSystem.CreationClassName"))
                :INITFORM NIL)
               (OSNAME STRING :CIM-NAME "OSName" :QUALIFIERS
                (:KEY (:DESCRIPTION "The scoping OperatingSystem's Name.")
                 (:MAX-LEN "256") (:PROPOGATED "CIM_OperatingSystem.Name"))
                :INITFORM NIL)
               ...
               (HANDLE STRING :CIM-NAME "Handle" :QUALIFIERS
                (:KEY
                 ...
                 (:MAX-LEN "256")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.1")))
                :INITFORM NIL)
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:OVERRIDE "Name") (:DESCRIPTION "The name of the process.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.6"))
                 (:MAX-LEN "1024"))
                :INITFORM NIL)
               (PRIORITY UINT32 :CIM-NAME "Priority" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.10")))
                :INITFORM NIL)
               (EXECUTIONSTATE UINT16 :CIM-NAME "ExecutionState" :QUALIFIERS
                ((:DESCRIPTION
...
11 (Hung) indicates that a process is not responding and should therefore not be given further execution time.")
                 ...
                 (:VALUES
                  ("Unknown" "Other" "Ready" "Running" "Blocked"
                   "Suspended Blocked" "Suspended Ready" "Terminated" "Stopped"
                   "Growing" "Ready But Relinquished Processor" "Hung"))
                 (:MAPPING-STRINGS
                  ("MIF.DMTF|Process Information|001.9"
                   "MIF.UNIX|Process Information|13.9")))
                :INITFORM NIL)
               (OTHEREXECUTIONDESCRIPTION STRING :CIM-NAME
                "OtherExecutionDescription" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (CREATIONDATE DATETIME :CIM-NAME "CreationDate" :QUALIFIERS
                ((:DESCRIPTION "Time that the Process began executing."))
                :INITFORM NIL)
               (TERMINATIONDATE DATETIME :CIM-NAME "TerminationDate"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Time that the Process was stopped or terminated."))
                :INITFORM NIL)
               (KERNELMODETIME UINT64 :CIM-NAME "KernelModeTime" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "MilliSeconds")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.13"))
                 (:P-UNIT "second * 10^-3"))
                :INITFORM NIL)
               (USERMODETIME UINT64 :CIM-NAME "UserModeTime" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (NIL "MilliSeconds")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.14"))
                 (:P-UNIT "second * 10^-3"))
                :INITFORM NIL)
               (WORKINGSETSIZE UINT64 :CIM-NAME "WorkingSetSize" :QUALIFIERS
                ((:DESCRIPTION
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (PARAMETERS (ARRAY STRING) :CIM-NAME "Parameters" :QUALIFIERS
                ((:DESCRIPTION
                  "The operating system parameters provided to the executing process. These are the argv[] values.")
                 (:MAPPING-STRINGS ("MIF.DMTF|Process Information|001.8")))
                :INITFORM NIL)
