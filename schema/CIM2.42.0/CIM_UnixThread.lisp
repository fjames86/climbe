...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_UnixThread.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_UNIXTHREAD (CIM_THREAD)
              ((SCHEDPOLICY UINT16 :CIM-NAME "SchedPolicy" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE ("CIM_UnixThread.OtherSchedPolicy")))
                :INITFORM NIL)
               (OTHERSCHEDPOLICY STRING :CIM-NAME "OtherSchedPolicy"
                :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates the thread's scheduling policy when SchedPolicy is set to \"Other\".")
                 (:MODEL-CORRESPONDENCE ("CIM_UnixThread.SchedPolicy")))
                :INITFORM NIL)
               (GUARDSIZE STRING :CIM-NAME "GuardSize" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates the size of the guard area for a created thread's stack."))
                :INITFORM NIL)
               (DETACHSTATE UINT16 :CIM-NAME "DetachState" :QUALIFIERS
                ((:DESCRIPTION "Indicates the creation state of the thread.")
                 (:VALUE-MAP ("0" "2" "3"))
                 (:VALUES
                  ("Unknown" "PTHREAD_CREATE_DETACHED"
                   "PTHREAD_CREATE_JOINABLE")))
                :INITFORM NIL)
               (INHERITSCHED UINT16 :CIM-NAME "InheritSched" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates how the scheduling attributes are to be set.")
                 (:VALUE-MAP ("0" "2" "3"))
                 (:VALUES
                  ("Unknown" "PTHREAD_INHERIT_SCHED"
                   "PTHREAD_EXPLICIT_SCHED")))
                :INITFORM NIL)
               (CONTENTIONSCOPE UINT16 :CIM-NAME "ContentionScope" :QUALIFIERS
                ((:DESCRIPTION "Indicates the contention scope of the thread.")
                 (:VALUE-MAP ("0" "2" "3"))
                 (:VALUES
                  ("Unknown" "PTHREAD_SCOPE_SYSTEM" "PTHREAD_SCOPE_PROCESS")))
                :INITFORM NIL)
               (STACKSIZE STRING :CIM-NAME "StackSize" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates the size of storage to be used for the thread's stack."))
                :INITFORM NIL)
               (CONCURRENCYLEVEL UINT64 :CIM-NAME "ConcurrencyLevel"
                :QUALIFIERS
                ((:DESCRIPTION "Indicates the thread's concurrency level."))
                :INITFORM NIL)
               (CANCELSTATE UINT16 :CIM-NAME "CancelState" :QUALIFIERS
                ((:DESCRIPTION "Indicates the thread's cancelability state.")
                 (:VALUE-MAP ("0" "2" "3"))
                 (:VALUES
                  ("Unknown" "PTHREAD_CANCEL_ENABLE"
                   "PTHREAD_CANCEL_DISABLE")))
                :INITFORM NIL)
               (CANCELTYPE UINT16 :CIM-NAME "CancelType" :QUALIFIERS
                ((:DESCRIPTION "Indicates the thread's cancelability type.")
                 (:VALUE-MAP ("0" "2" "3"))
                 (:VALUES
                  ("Unknown" "PTHREAD_CANCEL_DEFERRED"
               ...
               (PROCESSCREATIONCLASSNAME STRING :CIM-NAME
                ...
                :INITFORM NIL)
               (PROCESSHANDLE STRING :CIM-NAME "ProcessHandle" :QUALIFIERS
