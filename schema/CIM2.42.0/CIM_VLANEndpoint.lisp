...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VLANEndpoint.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VLANENDPOINT (CIM_PROTOCOLENDPOINT)
              ((DESIREDENDPOINTMODE UINT16 :CIM-NAME "DesiredEndpointMode"
                :QUALIFIERS
                (:WRITE
                 (:DESCRIPTION
...
- Dot1Q Tunnel: Configures the interface as a tunnel (nontrunking) endpoint/port to be connected in an asymmetric link with an 802.1Q trunk port. 802.1Q tunneling is used to maintain customer VLAN integrity across a service provider network.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6" "7..32767" ".."))
                 (:VALUES
                ...
                (:WRITE
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VLANEndpoint.DesiredEndpointMode"
                   "CIM_VLANEndpoint.OperationalEndpointMode")))
                :INITFORM NIL)
               (OPERATIONALENDPOINTMODE UINT16 :CIM-NAME
                "OperationalEndpointMode" :QUALIFIERS
                ((:DESCRIPTION
...
- Dot1Q Tunnel: Configures the interface as a tunnel (nontrunking) endpoint/port to be connected in an asymmetric link with an 802.1Q trunk port. 802.1Q tunneling is used to maintain customer VLAN integrity across a service provider network.")
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VLANEndpoint.DesiredEndpointMode"
                   "CIM_VLANEndpoint.OtherEndpointMode")))
                :INITFORM NIL)
               (DESIREDVLANTRUNKENCAPSULATION UINT16 :CIM-NAME
                "DesiredVLANTrunkEncapsulation" :QUALIFIERS
                (:WRITE
                 (:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6..32767" "32768.."))
                 (:VALUES
                  ("DMTF Reserved" "Other" "Not Applicable" "802.1q"
                   "Cisco ISL" "Negotiate" "DMTF Reserved" "Vendor Reserved"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VLANEndpoint.OperationalVLANTrunkEncapsulation"
                   "CIM_VLANEndpoint.OtherTrunkEncapsulation")))
                :INITFORM NIL)
               (OTHERTRUNKENCAPSULATION STRING :CIM-NAME
                "OtherTrunkEncapsulation" :QUALIFIERS
                (:WRITE
                 (:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VLANEndpoint.DesiredVLANTrunkEncapsulation"
                   "CIM_VLANEndpoint.OperationalVLANTrunkEncapsulation")))
                :INITFORM NIL)
               (OPERATIONALVLANTRUNKENCAPSULATION UINT16 :CIM-NAME
                "OperationalVLANTrunkEncapsulation" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6..32767" "32768.."))
                 (:VALUES
                  ("Unknown" "Other" "Not Applicable" "802.1q" "Cisco ISL"
                   "Negotiating" "DMTF Reserved" "Vendor Reserved"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VLANEndpoint.OtherTrunkEncapsulation"
                   "CIM_VLANEndpoint.DesiredVLANTrunkEncapsulation")))
                :INITFORM NIL)
               (GVRPSTATUS UINT16 :CIM-NAME "GVRPStatus" :QUALIFIERS
                ((:DESCRIPTION
