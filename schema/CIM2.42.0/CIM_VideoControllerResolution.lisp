...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VideoControllerResolution.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VIDEOCONTROLLERRESOLUTION (CIM_SETTING)
              ((SETTINGID STRING :CIM-NAME "SettingID" :QUALIFIERS
               ...
               (SCANMODE UINT16 :CIM-NAME "ScanMode" :QUALIFIERS
                ((:DEPRECATED ("CIM_VideoHeadResolution.ScanMode"))
                 (:DESCRIPTION
                  "Integer that indicates whether the Controller operates in interlaced (value=5) or non-interlaced (value=4) mode.")
                 (:VALUE-MAP ("1" "2" "3" "4" "5"))
                 (:VALUES
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL))
              (:CIM-NAME "CIM_VideoControllerResolution")
              (:QUALIFIERS (:DEPRECATED ("CIM_VideoHeadResolution"))
               (:VERSION "2.10.0")
...
(DEFCIM-METHOD VERIFYOKTOAPPLYTOMSE
    ((INSTANCE CIM_VIDEOCONTROLLERRESOLUTION)
