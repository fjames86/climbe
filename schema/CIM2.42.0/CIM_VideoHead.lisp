...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VideoHead.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VIDEOHEAD (CIM_LOGICALDEVICE)
              ((CURRENTBITSPERPIXEL UINT32 :CIM-NAME "CurrentBitsPerPixel"
               ...
               (MAXREFRESHRATE UINT32 :CIM-NAME "MaxRefreshRate" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VideoHeadResolution.MaxRefreshRate"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (MINREFRESHRATE UINT32 :CIM-NAME "MinRefreshRate" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VideoHeadResolution.MinRefreshRate"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (CURRENTREFRESHRATE UINT32 :CIM-NAME "CurrentRefreshRate"
                ...
                ((:DESCRIPTION "Current refresh rate in Hertz.") (NIL "Hertz")
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VideoHeadResolution.RefreshRate"))
                 (:P-UNIT "hertz"))
                :INITFORM NIL)
               (CURRENTSCANMODE UINT16 :CIM-NAME "CurrentScanMode" :QUALIFIERS
                ...
                :INITFORM NIL)
               (OTHERCURRENTSCANMODE STRING :CIM-NAME "OtherCurrentScanMode"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (CURRENTNUMBEROFCOLORS UINT64 :CIM-NAME "CurrentNumberOfColors"
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_VideoHeadResolution.NumberOfColors")))
                :INITFORM NIL)
