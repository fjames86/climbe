...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VirtualSystemManagementCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VIRTUALSYSTEMMANAGEMENTCAPABILITIES
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
                ...
                :INITFORM NIL)
               (VIRTUALSYSTEMTYPESSUPPORTED (ARRAY STRING) :CIM-NAME
                "VirtualSystemTypesSupported" :QUALIFIERS
                ((:DESCRIPTION
...
The value of each non-NULL array element shall conform to the format defined for the CIM_VirtualSystemSettingData.VirtualSystemType property.")
               ...
               (SYNCHRONOUSMETHODSSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:VALUE-MAP
                  ("2" "3" "4" "5" "6" "7" "8" "9" "10" ".." "32767..65535"))
                 (:VALUES
                  ("DefineSystemSupported" "DestroySystemSupported"
                   "DestroySystemConfigurationSupported"
                   "ModifyResourceSettingsSupported"
                   "ModifySystemSettingsSupported" "RemoveResourcesSupported"
                ...
                ((:DESCRIPTION
                 ...
                 (:VALUES
                  ("DefineSystemSupported" "DestroySystemSupported"
                   ...
                   "DMTF Reserved" "Vendor Reserved")))
                :INITFORM NIL)
               (INDICATIONSSUPPORTED (ARRAY UINT16) :CIM-NAME
                "IndicationsSupported" :QUALIFIERS
                ((:DESCRIPTION
...
ConcreteJobStateChangeIndicationsSupported indicates whether or not the implementation supports notification on state changes of CIM_ConcreteJob instances.")
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_VirtualSystemManagementCapabilities")
