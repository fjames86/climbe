...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VirtualSystemManagementService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VIRTUALSYSTEMMANAGEMENTSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_VirtualSystemManagementService")
...
(DEFCIM-METHOD ADDRESOURCESETTINGS
    ((INSTANCE CIM_VIRTUALSYSTEMMANAGEMENTSERVICE)
     (AFFECTEDCONFIGURATION "CIM_VirtualSystemSettingData"
     ...
     (RESOURCESETTINGS (ARRAY STRING) "ResourceSettings"
      (:DESCRIPTION
      ...
      (:EMBEDDED-INSTANCE "CIM_ResourceAllocationSettingData")
      (:ARRAYTYPE "Indexed"))
     (RESULTINGRESOURCESETTINGS "CIM_ResourceAllocationSettingData"
      "ResultingResourceSettings" :IN :OUT
      (:DESCRIPTION
...
.When applied to a \"state\" virtual system configuration, as a side effect resources are added to the active virtual system.")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        ...
        "Vendor Specific")))))
(DEFCIM-METHOD DEFINESYSTEM
    ((INSTANCE CIM_VIRTUALSYSTEMMANAGEMENTSERVICE)
     (SYSTEMSETTINGS STRING "SystemSettings"
      (:DESCRIPTION
      ...
      (:EMBEDDED-INSTANCE "CIM_VirtualSystemSettingData"))
     (REFERENCECONFIGURATION "CIM_VirtualSystemSettingData"
     ...
     (RESULTINGSYSTEM "CIM_ComputerSystem" "ResultingSystem" :IN :OUT
      (:DESCRIPTION
...
Input that is not completely specified may be filled out with default values.")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        ...
        "Method Parameters Checked - Job Started" "Method Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD DESTROYSYSTEM
    ((INSTANCE CIM_VIRTUALSYSTEMMANAGEMENTSERVICE)
     (AFFECTEDSYSTEM "CIM_ComputerSystem" "AffectedSystem"
      (:DESCRIPTION
       "Reference to an instance of class CIM_ComputerSystem representing the virtual computer system that it to be destroyed."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "If the operation is long running, then optionally a job may be returned.")))
    ((:CIM-NAME "DestroySystem")
     (:QUALIFIERS
...
The referenced virtual system is destroyed, including any elements scoped by it. Virtual resources are returned to their resource pools, which may imply the destruction of those resources (implementation dependent). If the virtual system is active when the operation is invoked, it is first deactivated and then destroyed. If snapshots were created from the virtual system, these are destroyed as well.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" ".." "4096" "4097..32767" "32768..65535"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        "Invalid Parameter" "Invalid State" "DMTF Reserved"
        "Method Parameters Checked - Job Started" "Method Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD MODIFYRESOURCESETTINGS
    ((INSTANCE CIM_VIRTUALSYSTEMMANAGEMENTSERVICE)
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
     ...
     (RESULTINGRESOURCESETTINGS "CIM_ResourceAllocationSettingData"
      ...
      (:ARRAYTYPE "Indexed")))
    ((:CIM-NAME "ModifyResourceSettings")
     (:QUALIFIERS
...
When applied to parts of a \"current\" virtual system configuration, as a side effect resources of the active virtual system may be modified.")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        "Invalid Parameter" "Invalid State" "Incompatible Parameters"
        "DMTF Reserved" "Method Parameters Checked - Job Started"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD MODIFYSYSTEMSETTINGS
    ((INSTANCE CIM_VIRTUALSYSTEMMANAGEMENTSERVICE)
     (SYSTEMSETTINGS STRING "SystemSettings"
      (:DESCRIPTION
       "String containing an instance of class CIM_VirtualSystemSettingData that is used to modify the settings of the virtual system. The instance must have a valid InstanceID in order to identify the virtual system setting to be modified.")
      (:EMBEDDED-INSTANCE "CIM_VirtualSystemSettingData"))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "If the operation is long running, then optionally a job may be returned.")))
    ((:CIM-NAME "ModifySystemSettings")
     (:QUALIFIERS
...
When applied to the system settings of a \"current\" virtual system configuration, as a side effect the virtual system instance may be modified.")
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        ...
        "DMTF Reserved" "Method Parameters Checked - Job Started"
        "Method Reserved" "Vendor Specific")))))
(DEFCIM-METHOD REMOVERESOURCESETTINGS
    ((INSTANCE CIM_VIRTUALSYSTEMMANAGEMENTSERVICE)
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "If the operation is long running, then optionally a job my be returned."))
     (RESOURCESETTINGS "CIM_ResourceAllocationSettingData" "ResourceSettings"
      (:DESCRIPTION
       "Array of references to instances of class CIM_ResourceAllocationSettingData where each instance represents the settings of a virtual resource within a virtual system configuration that are to be removed.")))
    ((:CIM-NAME "RemoveResourceSettings")
     (:QUALIFIERS
      (:DESCRIPTION
