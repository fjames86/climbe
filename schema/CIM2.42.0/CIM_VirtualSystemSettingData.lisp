...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VirtualSystemSettingData.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VIRTUALSYSTEMSETTINGDATA (CIM_SETTINGDATA)
...
For DMTF-defined instances, the \"preferred\" algorithm must be used with the <OrgID> set to CIM."))
               ...
               (NOTES (ARRAY STRING) :CIM-NAME "Notes" :QUALIFIERS
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_VirtualSystemSettingData")
