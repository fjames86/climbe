...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VirtualSystemSnapshotService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VIRTUALSYSTEMSNAPSHOTSERVICE (CIM_SERVICE)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_VirtualSystemSnapshotService")
...
(DEFCIM-METHOD CREATESNAPSHOT
    ((INSTANCE CIM_VIRTUALSYSTEMSNAPSHOTSERVICE)
     (SNAPSHOTSETTINGS STRING "SnapshotSettings"
      (:DESCRIPTION "Parameter settings.")
      (:EMBEDDED-INSTANCE "CIM_SettingData"))
     (SNAPSHOTTYPE UINT16 "SnapshotType"
      (:DESCRIPTION "Requested snapshot type:
...
Disk Snapshot: Snapshot of virtual system disks.")
      ...
      (:VALUES
       ("Full Snapshot" "Disk Snapshot" "DMTF Reserved" "Vendor Specific"))
      (:MODEL-CORRESPONDENCE
     ...
     (AFFECTEDSYSTEM "CIM_ComputerSystem" "AffectedSystem"
      (:DESCRIPTION "Reference to the affected virtual system."))
     (RESULTINGSNAPSHOT "CIM_VirtualSystemSettingData" "ResultingSnapshot" :IN
      :OUT (:DESCRIPTION "Resulting virtual system snapshot"))
    ...
    ((:CIM-NAME "CreateSnapshot")
     (:QUALIFIERS (:DESCRIPTION "Creates a snapshot of a virtual system.")
      (:VALUE-MAP
       ("0" "1" "2" "3" "4" "5" "6" ".." "4096" "4097..32767" "32768..65535"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        "Invalid Parameter" "Invalid State" "Invalid Type" "DMTF Reserved"
        "Method Parameters Checked - Job Started" "Method Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD DESTROYSNAPSHOT
    ((INSTANCE CIM_VIRTUALSYSTEMSNAPSHOTSERVICE)
     (AFFECTEDSNAPSHOT "CIM_VirtualSystemSettingData" "AffectedSnapshot"
      (:DESCRIPTION "Reference to the affected virtual system snapshot."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "If the operation is long running, then optionally a job may be returned.")))
    ((:CIM-NAME "DestroySnapshot")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Timeout"
        ...
        "Method Parameters Checked - Job Started" "Method Reserved"
        "Vendor Specific")))))
(DEFCIM-METHOD APPLYSNAPSHOT
    ((INSTANCE CIM_VIRTUALSYSTEMSNAPSHOTSERVICE)
     (SNAPSHOT "CIM_VirtualSystemSettingData" "Snapshot"
      (:DESCRIPTION "Reference to the virtual system snapshot."))
     (JOB "CIM_ConcreteJob" "Job" :IN :OUT
      (:DESCRIPTION
       "If the operation is long running, then optionally a job may be returned.")))
    ((:CIM-NAME "ApplySnapshot")
     (:QUALIFIERS
      (:DESCRIPTION
