...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VolatileStorage.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VOLATILESTORAGE (CIM_MEMORY)
              ((CACHEABLE BOOLEAN :CIM-NAME "Cacheable" :QUALIFIERS
                ((:DEPRECATED ("CIM_AssociatedCacheMemory"))
                 (:DESCRIPTION
                  "Indicates whether this Memory can be cached or not.")
                 (:MAPPING-STRINGS
                  ("MIF.DMTF|System Resource Memory Info|002.5")))
                :INITFORM NIL)
                ...
                ((:DEPRECATED ("CIM_AssociatedCacheMemory.WritePolicy"))
                 ...
                 (:VALUES
                  ("Other" "Unknown" "Write-Back" "Write-Through"
                   "Not Applicable"))
                 (:MAPPING-STRINGS
                  ("MIF.DMTF|System Resource Memory Info|002.6")))
                :INITFORM NIL)
