...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_VolumeSet.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_VOLUMESET (CIM_STORAGEVOLUME)
              ((NUMBEROFBLOCKS UINT64 :CIM-NAME "NumberOfBlocks" :QUALIFIERS
                ((:DEPRECATED ("CIM_CompositeExtent.NumberOfBlocks"))
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Volume Set|001.3"))
                 (:DESCRIPTION
                ...
                :INITFORM NIL)
               (PSEXTENTSTRIPELENGTH UINT64 :CIM-NAME "PSExtentStripeLength"
                :QUALIFIERS
                ((:DEPRECATED ("CIM_CompositeExtent.ExtentStripeLength"))
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Volume Set|001.4")))
                :INITFORM NIL)
               (PSEXTENTINTERLEAVEDEPTH UINT64 :CIM-NAME
                "PSExtentInterleaveDepth" :QUALIFIERS
                ((:DEPRECATED ("CIM_CompositeExtent.ExtentInterleaveDepth"))
                 ...
                 (:MAPPING-STRINGS ("MIF.DMTF|Volume Set|001.5")))
                :INITFORM NIL)
               (VOLUMESTATUS UINT16 :CIM-NAME "VolumeStatus" :QUALIFIERS
                ((:DEPRECATED ("No value"))
                 (:DESCRIPTION
                 ...
                 (:VALUES
                  ("Other" "Unknown" "None/Not Applicable" "Broken" "Data Lost"
                   ...
                   "Rebuild" "Recalculate" "Spare in Use"
                   "Verify In Progress")))
                :INITFORM NIL)
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:OVERRIDE "Name")
                 (:DESCRIPTION "A unique identifier for the Volume.")
                 (:MAPPING-STRINGS ("ANSI|T10|SCSI SPC-3|8.6"))
                 (:MODEL-CORRESPONDENCE ("CIM_StorageVolume.NameFormat"))
                 (:MAX-LEN "1024"))
                :INITFORM NIL)
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_VolumeSet")
              (:QUALIFIERS (:DEPRECATED ("CIM_CompositeExtent"))
