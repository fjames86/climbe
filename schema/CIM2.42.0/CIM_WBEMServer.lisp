...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_WBEMServer.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WBEMSERVER (CIM_SERVICE)
              ((DESCRIPTION STRING :CIM-NAME "Description" :QUALIFIERS
               ...
               (ELEMENTNAME STRING :CIM-NAME "ElementName" :QUALIFIERS
                (:REQUIRED (:OVERRIDE "ElementName")
                 (:DESCRIPTION
                  "The ElementName property is used as a name of the WBEM Server for human interfaces. For example, \"ACME WBEM Server\")."))
                :INITFORM NIL)
               (NAME STRING :CIM-NAME "Name" :QUALIFIERS
                (:KEY (:OVERRIDE "Name")
                 (:DESCRIPTION
                  "The Name property is used to uniquely identify a WBEM Server. The WBEM Server shall ensure that this value is globally unique.")
                 (:MAX-LEN "256"))
                :INITFORM NIL)
...
(DEFCIM-METHOD CREATEWBEMSERVERNAMESPACE
    ((INSTANCE CIM_WBEMSERVER)
     (NAMESPACETEMPLATE STRING "NamespaceTemplate" :REQUIRED
      (:DESCRIPTION
       "NamespaceTemplate is a template for the desired Namespace to be created.")
      (:EMBEDDED-INSTANCE "CIM_WBEMServerNamespace"))
     (NAMESPACE "CIM_WBEMServerNamespace" "Namespace" :IN :OUT
      (:DESCRIPTION
       "Reference to the instance of CIM_WBEMServerNamespace created when the method returns a value of 0."))
     (ERRORS (ARRAY STRING) "Errors" :IN :OUT
      (:DESCRIPTION
       "Error information for this method. This coudl include any information the implementation wants to return during the process of this method, even if completed successfully.")
      (:EMBEDDED-INSTANCE "CIM_Error")))
    ((:CIM-NAME "CreateWBEMServerNamespace")
     (:QUALIFIERS
      (:DESCRIPTION
       "CreateNamespace creates an Namespace. Upon successful completion of the method, there shall be a newly created instance of CIM_WBEMServerNamespace associated through the CIM_HostedDependency association with this instance of CIM_WBEMServer.")
      (:VALUE-MAP ("0" "1" ".."))
