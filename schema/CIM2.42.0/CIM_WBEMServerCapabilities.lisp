...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_WBEMServerCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WBEMSERVERCAPABILITIES
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (OPERATIONSSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                ((:DESCRIPTION
                  "OperationsSupported describes the type of operations that are supported for the assoicated WBEMServer .")
                 (:VALUE-MAP ("2" "3" "4" "5" ".."))
                 (:VALUES
                  ("RequestStateChange" "CreateWBEMServerNamespace"
                   "DeleteNamespace" "ModifyNamespace" "DMTF Reserved")))
                :INITFORM NIL)
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_WBEMServerCapabilities")
