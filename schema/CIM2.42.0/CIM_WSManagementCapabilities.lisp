...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_WSManagementCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WSMANAGEMENTCAPABILITIES
              (CIM_WBEMPROTOCOLSERVICECAPABILITIES)
              ((XPATHFEATURES UINT16 :CIM-NAME "XPathFeatures" :QUALIFIERS
                ((:DESCRIPTION
                  "Enumeration of XPath features supported by an Object Manager or Provider associated via ElementCapabilities. For more information refer to the WS-Management Specification, DSP0226 1.0, Annex D \"XPath Support\".")
                 (:VALUE-MAP ("2" "3" ".."))
                 (:VALUES
                  ("Level 1 with basic node selector support and no filtering"
                   "Level 2 with basic filtering support" "DMTF Reserved")))
                :INITFORM NIL)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_WSManagementCapabilities")
