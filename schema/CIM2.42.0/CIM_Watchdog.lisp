...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_Watchdog.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WATCHDOG (CIM_LOGICALDEVICE)
              ((MONITOREDENTITY UINT16 :CIM-NAME "MonitoredEntity" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MONITOREDENTITYDESCRIPTION STRING :CIM-NAME
                "MonitoredEntityDescription" :QUALIFIERS
                ((:DESCRIPTION
                  "A string that describes more textual information about the monitored entity.")
                 (:MAX-LEN "256"))
                :INITFORM NIL)
               (TIMEOUTINTERVAL UINT32 :CIM-NAME "TimeoutInterval" :QUALIFIERS
                ((:DESCRIPTION
                  "The timeout interval that is used by the watchdog, in MicroSeconds.")
                 (NIL "MicroSeconds") (:P-UNIT "second * 10^-6"))
                :INITFORM NIL)
               (TIMERRESOLUTION UINT32 :CIM-NAME "TimerResolution" :QUALIFIERS
                ((:DESCRIPTION
               ...
               (TIMEOFLASTEXPIRATION DATETIME :CIM-NAME "TimeOfLastExpiration"
                :QUALIFIERS
                ((:DESCRIPTION "The time of the last timer expiry.")) :INITFORM
                NIL)
               (MONITOREDENTITYONLASTEXPIRATION UINT16 :CIM-NAME
                "MonitoredEntityOnLastExpiration" :QUALIFIERS
                ((:DESCRIPTION
...
(DEFCIM-METHOD KEEPALIVE
    ((INSTANCE CIM_WATCHDOG))
    ((:CIM-NAME "KeepAlive")
     (:QUALIFIERS
      (:DESCRIPTION
