...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_WiFiPort.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WIFIPORT (CIM_NETWORKPORT)
              ((SPEED UINT64 :CIM-NAME "Speed" :QUALIFIERS
                ((:OVERRIDE "Speed")
                 (:DESCRIPTION
                  "The data rate at which the current PPDU (PLCP (Physical Layer Convergence Protocol) Protocol Data Unit) was received. This value is encoded in the first 4 bits of the PLCP header in each PLCP frame.")
                 (NIL "Bits per Second")
                 (:MAPPING-STRINGS
               ...
               (MAXSPEED UINT64 :CIM-NAME "MaxSpeed" :QUALIFIERS
                ((:OVERRIDE "MaxSpeed")
                 (:DESCRIPTION
                  "Shall contain the maximum bandwidth relative to the current operating mode specified in PortType. For example, shall contain 11000000 if PortType contains 71 (\"802.11b\").")
                 (NIL "Bits per Second") (:P-UNIT "bit / second"))
                :INITFORM NIL)
               (PORTTYPE UINT16 :CIM-NAME "PortType" :QUALIFIERS
                ((:OVERRIDE "PortType")
                 (:DESCRIPTION
                  "PortType shall contain the specific 802.11 operating mode that is currently enabled on the Port. All modes are specified in")
                 (:VALUE-MAP ("0" "1" "70" "71" "72" "73" ".." "16000.."))
                 (:VALUES
               ...
               (PERMANENTADDRESS STRING :CIM-NAME "PermanentAddress"
                ...
                ((:OVERRIDE "PermanentAddress")
                 (:DESCRIPTION
                  "IEEE 802 EUI-48 MAC address, formatted as twelve hexadecimal digits (for example, \"010203040506\"), with each pair representing one of the six octets of the MAC address in \"canonical\" bit order. (Therefore, the Group address bit is found in the low order bit of the first character of the string.)")
                 (:MAX-LEN "64")
                 (:MAPPING-STRINGS
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
               ...
               (NETWORKADDRESSES (ARRAY STRING) :CIM-NAME "NetworkAddresses"
                ...
                ((:OVERRIDE "NetworkAddresses")
                 (:DESCRIPTION
                  "IEEE 802 EUI-48 MAC addresses, each formatted as twelve hexadecimal digits (for example, \"010203040506\"), with each pair representing one of the six octets of the MAC address in \"canonical\" bit order. (Therefore, the Group address bit is found in the low order bit of the first character of the string.)")
                 (:MAX-LEN "64")
                 (:MAPPING-STRINGS
