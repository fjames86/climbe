...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_WiFiPortCapabilities.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WIFIPORTCAPABILITIES (CIM_NETWORKPORTCAPABILITIES)
...
For DMTF defined instances, the 'preferred' algorithm MUST be used with the <OrgID> set to 'CIM'."))
               ...
               (SUPPORTEDPORTTYPES (ARRAY UINT16) :CIM-NAME
                ...
                ((:DESCRIPTION
                  "The 802.11 modes that the Port supports. See description of PortType property in CIM_WiFiPort for more information.")
                ...
                :INITFORM NIL)
               (OTHERSUPPORTEDPORTTYPES (ARRAY STRING) :CIM-NAME
                "OtherSupportedPortTypes" :QUALIFIERS
                ((:DESCRIPTION
                  "Additional 802.11 modes supported by the associated WiFiPort, but not listed in the valuemap for SupportedPortTypes.")
                 (:MODEL-CORRESPONDENCE
               ...
               (REQUESTEDSTATESSUPPORTED (ARRAY UINT16) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_WiFiPortCapabilities")
