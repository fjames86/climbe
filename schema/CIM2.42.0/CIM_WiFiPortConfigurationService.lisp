...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_WiFiPortConfigurationService.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_WIFIPORTCONFIGURATIONSERVICE
...
OperationalStatus replaces the Status property on ManagedSystemElement to provide a consistent approach to enumerations, to address implementation needs for an array property, and to provide a migration path from today's environment to the future. This change was not made earlier because it required the deprecated qualifier. Due to the widespread use of the existing Status property in management applications, it is strongly recommended that providers or instrumentation provide both the Status and OperationalStatus properties. Further, the first value of OperationalStatus should contain the primary status for the element. When instrumented, Status (because it is single-valued) should also provide the primary status of the element.")
               ...
               (STATUSDESCRIPTIONS (ARRAY STRING) :CIM-NAME
                ...
                :INITFORM NIL))
              (:CIM-NAME "CIM_WiFiPortConfigurationService")
...
(DEFCIM-METHOD ADDWIFISETTINGS
    ((INSTANCE CIM_WIFIPORTCONFIGURATIONSERVICE)
     (WIFIENDPOINTSETTINGSINPUT STRING "WiFiEndpointSettingsInput" :REQUIRED
      :IN
      (:DESCRIPTION
       "Provides the input property values for the CIM_WiFiEndpointSettings instance that shall be created by this method. Upon successful completion of this method, a new instance of CIM_WiFiEndpointSettings shall be associated to the CIM_WiFiEndpoint referenced by the WiFiEndpoint parameter, through a new instance of CIM_ElementSettingData.")
      (:EMBEDDED-INSTANCE "CIM_WiFiEndpointSettings"))
     (IEEE8021XSETTINGSINPUT STRING "IEEE8021xSettingsInput" :IN
      (:DESCRIPTION
       "Provides the property values for a new instance of CIM_IEEE8021xSettings. If both IEEE8021xSettingsInput and IEEE8021xSettingsInputReference are not null, this method shall return 2 (\"Unknown/Unspecified Error\").If this parameter is not null and IEEE8021xSettingsInputReference is null, this method shall create a new CIM_IEEE8021xSettings instance with the values in this parameter, and shall associate it (through a new instance of CIM_ConcreteComponent) with the newly created instance of CIM_WiFiEndpointSettings.")
      (:EMBEDDED-INSTANCE "CIM_IEEE8021xSettings"))
     (WIFIENDPOINT "CIM_WiFiEndpoint" "WiFiEndpoint" :REQUIRED :IN
      (:DESCRIPTION
       "References the instance of CIM_WiFiEndpoint with which the new settings shall be associated."))
     (CLIENTCREDENTIAL "CIM_Credential" "ClientCredential" :IN
      (:DESCRIPTION
       "References a credential that shall be used to authenticate the CIM_WiFiEndpoint to a IEEE 802.1x authentication server. This method shall return 2 (\"Unknown/Unspecified Error\") if IEEE8021xSettingsInput is null and IEEE8021xCredential is not null."))
     (CACREDENTIAL "CIM_Credential" "CACredential" :IN
      (:DESCRIPTION
       "References a credential that shall be used as a trusted root certificate by the CIM_WiFiEndpoint when it authenticates the leaf certificate provided by the authentication server. This method shall return 2 (\"Unknown/Unspecified Error\") if IEEE8021xSettingsInput is null and IEEE8021xCredential is not null."))
     (WIFIENDPOINTSETTINGS "CIM_WiFiEndpointSettings" "WiFiEndpointSettings"
      :OUT
      (:DESCRIPTION
       "Upon successful completion, shall contain a reference to the CIM_WiFiEndpointSettings instance created by this method."))
     (IEEE8021XSETTINGS "CIM_IEEE8021xSettings" "IEEE8021xSettings" :OUT
      (:DESCRIPTION
       "Upon successful completion, shall contain a reference to the CIM_IEEE8021xSettings instance created by this method if and only if IEEE8021xSettingsInput was not null.")))
    ((:CIM-NAME "AddWiFiSettings")
     (:QUALIFIERS
      (:DESCRIPTION
       "Shall atomically create settings that enable a WiFiEndpoint to connect to a given Wi-Fi network. These settings include the name (SSID) of the network as well as the security parameters used by the WiFiEndpoint to authenticate to the network and encrypt frames it transmits into the network and decrypt the frames it receives from the network. Upon successful completion, a new instance of CIM_WiFiEndpointSettings shall be associated to the CIM_WiFiEndpoint referenced by the WiFiEndpoint parameter, through a new instance of CIM_ElementSettingData. If the IEEE8021xSettingsInput parameter is not null, a new instance of CIM_IEEE8021xSettings containing its property values shall be associated to the new instance of CIM_WiFiEndpointSettings through a new instance of CIM_ConcreteComponent upon successful completion. Alternatively, if the IEEE8021xSettingsInputReference parameter is not null, the CIM_IEEE8021xSettings that it references shall be associated to the new instance of CIM_WiFiEndpointSettings through a new instance of CIM_ConcreteComponent upon successful completion. This method shall not apply the new settings to WiFiEndpoint. Rather, it shall make them available for subsequent manual or autonomous application.")
      (:VALUE-MAP ("0" "1" "2" "3" "4" "5..4095" "4096..32767" "32768..65535"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Invalid Parameter"
        "Invalid Reference" "DMTF Reserved" "Method Reserved"
        "Vendor Specified")))))
(DEFCIM-METHOD UPDATEWIFISETTINGS
    ((INSTANCE CIM_WIFIPORTCONFIGURATIONSERVICE)
     (WIFIENDPOINTSETTINGSINPUT STRING "WiFiEndpointSettingsInput" :IN
      (:DESCRIPTION
       "If not null, shall provide the new property values for the instance of CIM_WiFiEndpointSettings referenced by the WiFiEndpointSettings parameter.")
      (:EMBEDDED-INSTANCE "CIM_WiFiEndpointSettings"))
     (IEEE8021XSETTINGSINPUT STRING "IEEE8021xSettingsInput" :IN
      (:DESCRIPTION
       "If not null, shall provide the new property values for the instance of CIM_IEEE8021xSettings referenced by the IEEE8021xSettings parameter. If the IEEE8021xSettings is null and the IEEE8021xSettingsInput parameter is not null, this method shall return 2 (\"Unknown/Unspecified Error\").")
      (:EMBEDDED-INSTANCE "CIM_IEEE8021xSettings"))
     (WIFIENDPOINTSETTINGS "CIM_WiFiEndpointSettings" "WiFiEndpointSettings"
      :REQUIRED :IN :OUT
      (:DESCRIPTION
       "Shall reference the CIM_WiFiEndpointSettings instance that shall be updated by this method."))
     (CLIENTCREDENTIAL "CIM_Credential" "ClientCredential" :IN
      (:DESCRIPTION
       "References a credential that shall be used to authenticate the CIM_WiFiEndpoint to a IEEE 802.1x authentication server."))
     (CACREDENTIAL "CIM_Credential" "CACredential" :IN
      (:DESCRIPTION
       "References a credential that shall be used as a trusted root certificate by the CIM_WiFiEndpoint when it authenticates the leaf certificate provided by the authentication server."))
     (IEEE8021XSETTINGS "CIM_IEEE8021xSettings" "IEEE8021xSettings" :IN :OUT
      (:DESCRIPTION
       "If not null, shall reference the CIM_IEEE8021xSettings instance that shall be updated by this method.")))
    ((:CIM-NAME "UpdateWiFiSettings")
     (:QUALIFIERS
      (:DESCRIPTION
       "Shall atomically update settings that enable a WiFiEndpoint to connect to a given Wi-Fi network. These settings include the name (SSID) of the network as well as the security parameters used by the WiFiEndpoint to authenticate to the network and encrypt frames it transmits into the network and decrypt the frames it receives from the network. This method addresses the following update scenarios, each of which is given a tag line that precedes its description. Each tag line is in the form A to B, in which A indicates the type of authentication method in the settings before UpdateWiFiSettings is executed, and B indicates the type of authentication method in the settings after UpdateWiFiSettings is executed. Each of A and B is replaced in the tag lines by either \"IEEE 802.1x\", which indicates that the authentication method in the settings is based on IEEE 802.1x, or \"Non-IEEE-802.1x\", which indicates that the authentication method in the settings is not based on IEEE 802.1x.
...
This method shall not apply the updated settings to any instance of CIM_WiFiEndpoint.")
      (:VALUE-MAP ("0" "1" "2" "3" "4" "5..4095" "4096..32767" "32768..65535"))
      (:VALUES
       ("Completed with No Error" "Not Supported" "Failed" "Invalid Parameter"
        "Invalid Reference" "DMTF Reserved" "Method Reserved"
        "Vendor Specified")))))
(DEFCIM-METHOD ADDLANENDPOINT
    ((INSTANCE CIM_WIFIPORTCONFIGURATIONSERVICE)
     (ADDRESS STRING "Address" :REQUIRED :IN
      (:DESCRIPTION "The MAC address requested."))
     (LANID STRING "LANID" :IN (:DESCRIPTION "The requested LAN ID."))
     (PORT "CIM_NetworkPort" "Port" :REQUIRED :IN
      (:DESCRIPTION
       "The NetworkPort to which the network interface will be added."))
     (ENDPOINT "CIM_LANEndpoint" "Endpoint" :IN :OUT
      (:DESCRIPTION "The created LANEndpoint."))
     (ALIASADDRESSES (ARRAY STRING) "AliasAddresses" :IN
      (:DESCRIPTION "The requested alias addresses."))
     (GROUPADDRESSES (ARRAY STRING) "GroupAddresses" :IN
      (:DESCRIPTION "The requested group addresses.")))
    ((:CIM-NAME "AddLANEndpoint")
     (:QUALIFIERS
      (:DESCRIPTION
      ...
      (:VALUES
       ("Completed with No Error" "Not Supported" "Unknown/Unspecified Error"
        "Failed" "Invalid Parameter" "DMTF Reserved" "Vendor Reserved")))))
