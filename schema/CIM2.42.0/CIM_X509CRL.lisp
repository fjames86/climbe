...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_X509CRL.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_X509CRL (CIM_X509INFRASTRUCTURE)
              ((ISSUED DATETIME :CIM-NAME "Issued" :QUALIFIERS
                ((:OVERRIDE "Issued")
                 (:DESCRIPTION
                  "This property corresponds to the thisUpdate field in the Internet X509 PKI standard. The property represents the issue date of the CRL. Use a value of all '00000101000000.000000+000', (midnight, January 1, 1 BCE at coordinated universal time +0 minutes), if this information is not applicable. On CreateInstance, if this property is unspecified, or set to NULL, then current time is assumed."))
                :INITFORM NIL)
               (EXPIRES DATETIME :CIM-NAME "Expires" :QUALIFIERS
                ((:OVERRIDE "Expires")
                 (:DESCRIPTION
                  "This property is not applicable for CIM_X509CRL class and shall either have value of 
'99991231115959.999999-720' as defined by DSP0004 to mean \"infinite future or NULL."))
                :INITFORM NIL)
               (NEXTUPDATE DATETIME :CIM-NAME "NextUpdate" :QUALIFIERS
                ((:DESCRIPTION
                  "The property represents the date by which the next CRL will be issued. The next CRL could be issued before the indicated date, but it will not be issued any later than the indicated date. If this information is not applicable, use a value of 
'99991231115959.999999-720' as defined by DSP0004 to mean \"infinite future."))
                :INITFORM NIL)
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties. Note that if there is an associated instance of CIM_EnabledLogicalElementCapabilities, restrictions on this properties may exist as defined in ElementNameMask and MaxElementNameLen properties defined in that class."))
                :INITFORM NIL)
               (ENCODEDCRL (ARRAY STRING) :CIM-NAME "EncodedCRL" :QUALIFIERS
                ((:DESCRIPTION
                  "The full content of the CRL in binary form.Only the first element of the array property shall be populated.")
                 :OCTET-STRING)
                :INITFORM NIL)
               (SERIALNUMBERS (ARRAY STRING) :CIM-NAME "SerialNumbers"
                :QUALIFIERS
                ((:DESCRIPTION
