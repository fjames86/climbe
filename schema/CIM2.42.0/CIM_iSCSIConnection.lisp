...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_iSCSIConnection.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ISCSICONNECTION (CIM_NETWORKPIPE)
              ((CONNECTIONID UINT32 :CIM-NAME "ConnectionID" :QUALIFIERS
                ((:DESCRIPTION "The iSCSI Connection ID for this connection.")
                 (:MIN-VALUE "1") (:MAX-VALUE "65535")
                 (:MAPPING-STRINGS ("MIB.IETF|iSCSI-MIB.iscsiCxnCid")))
                :INITFORM NIL)
               (MAXRECEIVEDATASEGMENTLENGTH UINT32 :CIM-NAME
                ...
                :INITFORM NIL)
               (MAXTRANSMITDATASEGMENTLENGTH UINT32 :CIM-NAME
                "MaxTransmitDataSegmentLength" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (HEADERDIGESTMETHOD UINT16 :CIM-NAME "HeaderDigestMethod"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiCxnHeaderIntegrity"))
                 (:MODEL-CORRESPONDENCE
                ...
                :INITFORM NIL)
               (OTHERHEADERDIGESTMETHOD STRING :CIM-NAME
                "OtherHeaderDigestMethod" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DATADIGESTMETHOD UINT16 :CIM-NAME "DataDigestMethod"
                :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:VALUES ("Other" "No Digest" "CRC32C"))
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiCxnDataIntegrity"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_iSCSIConnectionSettings.PrimaryHeaderDigestMethod"
                   "CIM_iSCSIConnectionSettings.SecondaryHeaderDigestMethod"
                   "CIM_iSCSIConnection.OtherDataDigestMethod")))
                :INITFORM NIL)
               (OTHERDATADIGESTMETHOD STRING :CIM-NAME "OtherDataDigestMethod"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (AUTHENTICATIONMETHODUSED UINT16 :CIM-NAME
                ...
                :INITFORM NIL)
               (MUTUALAUTHENTICATION BOOLEAN :CIM-NAME "MutualAuthentication"
                :QUALIFIERS
                ((:DESCRIPTION
