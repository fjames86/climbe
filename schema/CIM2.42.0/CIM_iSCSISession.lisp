...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/CIM_iSCSISession.xml"

(in-package #:climbe)


(DEFCIM-CLASS CIM_ISCSISESSION (CIM_NETWORKPIPE)
              ((DIRECTIONALITY UINT16 :CIM-NAME "Directionality" :QUALIFIERS
                ((:OVERRIDE "Directionality")
                 (:DESCRIPTION "iSCSI sessions MUST be bidirectional.")
                 (:VALUE-MAP ("2")) (:VALUES ("Bi-Directional"))
                 (:MAPPING-STRINGS
                  ("Recommendation.ITU|M3100.Pipe.directionality")))
                :INITFORM "2")
               (SESSIONTYPE UINT16 :CIM-NAME "SessionType" :QUALIFIERS
                ((:DESCRIPTION "iSCSI Session type.") (:VALUE-MAP ("2" "3"))
                 (:VALUES ("Discovery" "Normal"))
                 (:MAPPING-STRINGS ("MIB.IETF|iSCSI-MIB.iscsiSsnType")))
                :INITFORM NIL)
               (TSIH UINT32 :CIM-NAME "TSIH" :QUALIFIERS
                ((:DESCRIPTION
                  "The Target Session Identifying Handle (TSIH) for this session.")
                 (:MAPPING-STRINGS ("MIB.IETF|iSCSI-MIB.iscsiSsnTSIH")))
                :INITFORM NIL)
               (ENDPOINTNAME STRING :CIM-NAME "EndPointName" :QUALIFIERS
                ((:DESCRIPTION
                  "The iSCSI Port Name (iSCSIProtocolEndPoint.Name), of the device at the other end of this iSCSISession.")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiSsnInitiatorName"
                   "MIB.IETF|iSCSI-MIB.iscsiSsnTargetName")))
                :INITFORM NIL)
               (CURRENTCONNECTIONS UINT32 :CIM-NAME "CurrentConnections"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The number of transport protocol connections that currently belong to this session.")
                 (:MIN-VALUE "1") (:MAX-VALUE "65535")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiSsnConnectionNumber"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_iSCSISessionSettings.MaxConnectionsPerSession")))
                :INITFORM NIL)
               (INITIALR2T BOOLEAN :CIM-NAME "InitialR2T" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS ("MIB.IETF|iSCSI-MIB.iscsiSsnInitialR2T"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_iSCSISessionSettings.InitialR2TPreference")))
                :INITFORM NIL)
               (IMMEDIATEDATA BOOLEAN :CIM-NAME "ImmediateData" :QUALIFIERS
                ((:DESCRIPTION
                  "Indicates whether the initiator and target have agreed to support immediate data on this session.")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiSsnImmediateData"))
                 (:MODEL-CORRESPONDENCE
               ...
               (MAXOUTSTANDINGR2T UINT32 :CIM-NAME "MaxOutstandingR2T"
                ...
                ((:DESCRIPTION
                 ...
                 (NIL "Bytes") (:MIN-VALUE "1") (:MAX-VALUE "65535")
                 (:MAPPING-STRINGS
               ...
               (MAXUNSOLICITEDFIRSTDATABURSTLENGTH UINT32 :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiSsnFirstBurstLength"))
                 (:MODEL-CORRESPONDENCE
               ...
               (MAXDATABURSTLENGTH UINT32 :CIM-NAME "MaxDataBurstLength"
                ...
                ((:DESCRIPTION
                 ...
                 (NIL "Bytes") (:MIN-VALUE "512") (:MAX-VALUE "16777215")
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiSsnMaxBurstLength"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_iSCSISessionSettings.MaxDataBurstLength")))
                :INITFORM NIL)
               (DATASEQUENCEINORDER BOOLEAN :CIM-NAME "DataSequenceInOrder"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DATAPDUINORDER BOOLEAN :CIM-NAME "DataPDUInOrder" :QUALIFIERS
                ((:DESCRIPTION
                 ...
                 (:MAPPING-STRINGS
                  ("MIB.IETF|iSCSI-MIB.iscsiSsnDataPDUInOrder"))
                 (:MODEL-CORRESPONDENCE
                  ("CIM_iSCSISessionSettings.DataPDUInOrderPreference")))
                :INITFORM NIL)
               (ERRORRECOVERYLEVEL UINT32 :CIM-NAME "ErrorRecoveryLevel"
                :QUALIFIERS
                ((:DESCRIPTION
               ...
               (MAXCONNECTIONSPERSESSION UINT32 :CIM-NAME
                ...
                ((:DESCRIPTION
                 ...
                 (:MODEL-CORRESPONDENCE
                  ("CIM_iSCSISessionSettings.MaxConnectionsPerSession")))
                :INITFORM NIL)
               (DEFAULTTIMETOWAIT UINT32 :CIM-NAME "DefaultTimeToWait"
                :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DEFAULTTIMETORETAIN UINT32 :CIM-NAME "DefaultTimeToRetain"
                :QUALIFIERS
                ((:DESCRIPTION
...
In the context of M.3100, the ability to be composed of lower-level pipes is modeled as a Trail. A Trail is made up of one or more Connections. (Note that both Trails and Connections are subclasses of Pipe). Because of the flexibility of the NetworkPipeComposition association, there is no need to subclass NetworkPipe, as was done in M.3100, but merely to instantiate the NetworkPipeComposition association to describe the bundling of the lower-level pipes (i.e., the connections), or the sequencing of them.")
                 (:VALUE-MAP ("0" "2" "3" "4"))
                 (:VALUES
                  ("Unknown" "No Lower-Level Composition"
