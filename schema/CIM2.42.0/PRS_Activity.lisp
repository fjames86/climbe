...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Activity.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_ACTIVITY (PRS_EXCHANGEELEMENT)
              ((PARAMETERLIST STRING :CIM-NAME "ParameterList" :QUALIFIERS
                ((:DEPRECATED
                  ("PRS_Activity.NewKeys" "PRS_Activity.Deleted"
                ...
                :INITFORM NIL)
               (NEWKEYS STRING :CIM-NAME "NewKeys" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (DELETED STRING :CIM-NAME "Deleted" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (MODIFIED STRING :CIM-NAME "Modified" :QUALIFIERS
                ((:DESCRIPTION
