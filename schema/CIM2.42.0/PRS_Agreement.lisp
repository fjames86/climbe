...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Agreement.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_AGREEMENT (PRS_EXCHANGEELEMENT)
              ((CONTRACTID STRING :CIM-NAME "ContractID" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (AGREEMENTTYPE STRING :CIM-NAME "AgreementType" :QUALIFIERS
