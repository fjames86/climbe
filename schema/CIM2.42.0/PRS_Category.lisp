...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Category.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_CATEGORY (PRS_EXCHANGEELEMENT)
              ((CATEGORYCONTENTS STRING :CIM-NAME "CategoryContents"
                :QUALIFIERS
                ((:DESCRIPTION
                  "The specific value for the category. For example, 'HP Laserjet' would be a value for a category containing printer names."))
                :INITFORM NIL)
               (CATEGORYTYPE STRING :CIM-NAME "CategoryType" :QUALIFIERS
                ((:DESCRIPTION
