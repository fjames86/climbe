...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Feature.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_FEATURE (PRS_EXCHANGEELEMENT)
              ((PROMPT STRING :CIM-NAME "Prompt" :QUALIFIERS
                ((:DESCRIPTION "Prompt presented through user interface."))
                :INITFORM NIL)
               (VALIDVALUES STRING :CIM-NAME "ValidValues" :QUALIFIERS
                ((:DESCRIPTION "Valid values for this PRS_Feature.")) :INITFORM
                NIL)
               (DATATYPE UINT8 :CIM-NAME "DataType" :QUALIFIERS
                ((:DESCRIPTION
                  "Data type used for PRS_Statement FeatureValue property.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "254" "255"))
                 (:VALUES
                  ("String" "Integer" "Float" "Date/Time" "Boolean" "Binary"
                   "Other" "Unknown")))
                :INITFORM NIL)
