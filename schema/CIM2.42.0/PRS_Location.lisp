...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Location.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_LOCATION (PRS_EXCHANGEELEMENT)
              ((LOCATIONTYPE UINT8 :CIM-NAME "LocationType" :QUALIFIERS
                ((:DESCRIPTION "The type of location.")
                 ...
                 (:VALUES
                  ("Primary_Voice" "Alternate_Voice" "Fax" "Email" "URL"
                   "Other" "Unknown")))
                :INITFORM NIL)
               (LOCATIONID STRING :CIM-NAME "LocationID" :QUALIFIERS
                ((:DESCRIPTION "The specific location.")) :INITFORM NIL)
