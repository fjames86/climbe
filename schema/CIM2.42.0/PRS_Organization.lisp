...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Organization.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_ORGANIZATION (PRS_CONTACTITEM)
              ((NAME STRING :CIM-NAME "Name" :QUALIFIERS
                ((:DESCRIPTION "The name of the organization.")) :INITFORM NIL)
               (BUSINESS STRING :CIM-NAME "Business" :QUALIFIERS
                ((:DESCRIPTION
