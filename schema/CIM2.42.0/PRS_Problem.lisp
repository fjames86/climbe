...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Problem.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_PROBLEM (PRS_SOLUTIONELEMENT)
              ((LIKELIHOOD UINT16 :CIM-NAME "Likelihood" :QUALIFIERS
                ((:DESCRIPTION
                ...
                :INITFORM NIL)
               (IMPACT UINT16 :CIM-NAME "Impact" :QUALIFIERS
                ((:DESCRIPTION
