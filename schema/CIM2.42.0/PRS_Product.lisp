...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Product.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_PRODUCT (PRS_EXPRESSIONELEMENT)
              ((VENDOR STRING :CIM-NAME "Vendor" :QUALIFIERS
                ((:DESCRIPTION "The vendor of the product.")) :INITFORM NIL)
               ...
               (VERSION STRING :CIM-NAME "Version" :QUALIFIERS
                ((:DESCRIPTION "The version of the product.")) :INITFORM NIL)
