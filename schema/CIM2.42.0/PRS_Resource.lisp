...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_Resource.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_RESOURCE (PRS_EXCHANGEELEMENT)
              ((RESOURCETYPE STRING :CIM-NAME "ResourceType" :QUALIFIERS
                ((:DESCRIPTION "A string describing the type of resource."))
                :INITFORM NIL)
               (QUANTITY UINT16 :CIM-NAME "Quantity" :QUALIFIERS
                ((:DESCRIPTION "Number of units of resource used.")) :INITFORM
                NIL)
               (UNITS STRING :CIM-NAME "Units" :QUALIFIERS
                ((:DESCRIPTION "Unit of measure for this resource.")) :INITFORM
                NIL)
