...
;; Compiled from #P"/home/frank/quicklisp/local-projects/climbe/schema/CIM2.42.0/PRS_ServiceIncident.xml"

(in-package #:climbe)


(DEFCIM-CLASS PRS_SERVICEINCIDENT (PRS_EXCHANGEELEMENT)
              ((REQUESTERID STRING :CIM-NAME "RequesterID" :QUALIFIERS
                ((:DESCRIPTION
                  "The unique identifier for this incident assigned by the Requester."))
                :INITFORM NIL)
               (PROVIDERID STRING :CIM-NAME "ProviderID" :QUALIFIERS
                ((:DESCRIPTION
                  "The unique identifier for this incident assigned by the Provider."))
                :INITFORM NIL)
               (CURRENTSTATE UINT8 :CIM-NAME "CurrentState" :QUALIFIERS
                ((:DESCRIPTION
                  "The state of the incident within the Service Incident Exchange Standard transaction model.")
                 (:VALUE-MAP ("0" "1" "2" "3" "4" "5" "6" "7" "254" "255"))
                 (:VALUES
               ...
               (TRANSACTIONNAME STRING :CIM-NAME "TransactionName" :QUALIFIERS
                ...
                :INITFORM NIL)
               (LASTTRANSACTION UINT8 :CIM-NAME "LastTransaction" :QUALIFIERS
                ((:DESCRIPTION
